...
#  ("mount_and_blade_title_screen_2", "mount_and_blade_title_screen_2.ogg",mtf_module_track| mtf_sit_main_title|mtf_start_immediately, 0),
  ("mount_and_blade_title_screen_3", "mount_and_blade_title_screen_3.ogg",mtf_module_track| mtf_sit_main_title|mtf_start_immediately, 0),
...
#  ("killed_by_vaegir", "killed_by_vaegir.ogg", mtf_persist_until_finished|mtf_culture_2|mtf_sit_killed, 0),
  ...
  ("tavern_3", "tavern_3.ogg",mtf_module_track| mtf_sit_tavern|mtf_sit_feast, 0),
  ("tavern_4", "tavern_4.ogg",mtf_module_track| mtf_sit_tavern|mtf_sit_feast, 0),  
  ...
  ("travel_sarranid",  "middle_eastern_travel.ogg",mtf_module_track| mtf_culture_6|mtf_sit_travel, mtf_sit_town|mtf_sit_tavern|mtf_sit_night|mtf_culture_all),

  ("uncertain_homestead", "uncertain_h.ogg",mtf_module_track|mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
  ...
  ("victorious_swadian", "victorious_swadian.ogg",mtf_module_track| mtf_persist_until_finished|mtf_culture_2|mtf_sit_victorious, 0),
  ...
  ("town_piste_1", "town_piste_1.ogg",mtf_module_track| mtf_sit_town|mtf_sit_travel, mtf_sit_tavern|mtf_sit_night),
 ("musique_intro_tournois", "ambiancejoute_loop.ogg",mtf_module_track|mtf_start_immediately| mtf_persist_until_finished, 0),
