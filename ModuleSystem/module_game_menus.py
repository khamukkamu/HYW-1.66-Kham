...
### HYW END		
  ...
  (
    ...
    [
      ...
      # Freelancer: Deserters
      (try_begin),
        (check_quest_active, "qst_freelancer_mission_1"),
        (neg|check_quest_succeeded, "qst_freelancer_mission_1"),
        (neg|check_quest_failed, "qst_freelancer_mission_1"),
        
        (quest_get_slot, ":quest_party", "qst_freelancer_mission_1", slot_quest_target_party),
        (party_is_active, ":quest_party"),
        (party_get_attached_to, ":quest_party_attached"),
        (this_or_next|eq, ":quest_party", "$g_enemy_party"),
        (eq, ":quest_party_attached", "$g_enemy_party"),
        (call_script, "script_succeed_quest", "qst_freelancer_mission_1"),
      (try_end),
