...
#
#   Each game menu is a tuple that contains the following fields:SW -
#  
#  1) Game-menu id (string): used for referencing gamerandom-menus in other files.
#     The prefix menu_ is automatically added before each game-menu-id
#
#  2) Game-menu flags (int). See header_game_menus.pyjou for a list of available flags.
...
#        The prefix mno_ is automatically added before each menu-option.JOU
...
game_menus = [
  ("start_game_0",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    ...
    [
     ("continue",[],"Continue...",
#       [(jump_to_menu, "mnu_choose_skill"),#enlever pour ecourter le developement
	   [(jump_to_menu, "mnu_start_game_1"), ##remetre 
        ]
       ),
      ("go_back",[],"Go back",
       [
  ...
  ("start_phase_2",mnf_disable_all_keys,
    "You arrive in France, a land torn between the rival kingdoms of England and France, battling each other for supremacy and the French throne.\
 France is a haven for knights and mercenaries, cutthroats and adventurers, all willing to risk their lives in pursuit of fortune, power, or glory...\
 ...
 and that whatever course you take, great adventures will await you. Drawn by the tales you hear about France and its wars, you...",
    "none",
    [],
    [
      ("town_1",[(eq, "$current_startup_quest_phase", 0),],"join a pilgrimage to Dijon, in the land of France.",
       [
	  ...
	  (jump_to_menu, "mnu_start_phase_2_5"),#remetre!!!!!!!!!<<<<<<<<<<<<<<<REMETRE
         
##########################################################################################
##########################################################################################         
         #REMETRE (jump_to_menu, "mnu_start_phase_2_5") JUSTE EN HAUT ET ENLEVER CA,c'est tout! >>>
   ...
   #      (call_script, "script_enable_startjeanne_autority"),         
##########################################################################################
##########################################################################################enlever jusqu'ici
...
#      ("town_2",[(eq, "$current_startup_quest_phase", 0),],"Take ship to Brest, the English held town in Northern France.",
#       [
...
#       ]),
	...
	#    [
#      ("town_1",[(eq, "$current_startup_quest_phase", 0),],"Join a pilgrimage to Avignon, in Southern France.",
#       [
#         (assign, "$current_town", "p_town_6"),
#         (assign, "$g_starting_town", "$current_town"),
 #        (assign, "$g_journey_string", "str_journey_to_praven"),
...
#       ]),
 ...
 #     ("town_2",[(eq, "$current_startup_quest_phase", 0),],"Take ship to Caen, the English held town in Northern France.",
 #      [
 #        (assign, "$current_town", "p_town_8"),
#         (assign, "$g_starting_town", "$current_town"),
#         (assign, "$g_journey_string", "str_journey_to_reyvadin"),
...
#NPC companion changes begin azaza
...
#menu faim aqaqa
      ...
      ("view_document",[],"Lire des documents.",
       [(jump_to_menu, "mnu_docum_report"),
        ]
       ),      
#      
...
##  ),
    ...
    [
      ("start_male",[],"Male",
       [
         ...
         (jump_to_menu,"mnu_start_choix_classes"),         
        ]
       ),
      ("start_female",[],"Female",
       [
  ...
  (
    "start_choix_classes",mnf_disable_all_keys,
    "Qui etes vous ?...",
    "none",
    [
    (str_clear,s10),
    ...
    [
    ("start_noble2",[],"Un Noble Chevalier déchu.",[
	(jump_to_menu,"mnu_classe_chevalier"),
    ]),
    ("start_merchant2",[],"Un Mercenaire.",[
	(jump_to_menu,"mnu_classe_mercenaire"),
    ]),
    ("start_guard2",[],"Un Marchand.",[
	(jump_to_menu,"mnu_classe_marchant"),
    ]),
    ("start_forester2",[],"Un Chasseur.",[
	(jump_to_menu,"mnu_classe_chasseur"),
    ]),
    ("start_nomad2",[],"Un Rebelle Francais.",[
	(jump_to_menu,"mnu_classe_rebel"),
    ]),
    ("start_thief2",[],"Un Bandit de grands chemins.",[
	(jump_to_menu,"mnu_classe_bandit"),
    ]),
    ("start_thief22",[],"Un Soldat.",[
	(jump_to_menu,"mnu_classe_anglais"),
    ]),
    ("start_thief33",[],"Un Médecin.",[
	(jump_to_menu,"mnu_classe_bourgignon"),
    ]),
    ("go_back",[],"Go back",
...
#######################################menus texts + sons+images reprendre

     ( "classe_chevalier",mnf_scale_picture|mnf_disable_all_keys,
       "Vous etes le fils d'une noble famille de Chevaliers Francais dépossedée de ses terres et titres par la fourberie de nobles félons avides de vos terres et de votre pouvoir.c'est dans cette époque de déclin de l'esprit de Chevalerie que vous avez grandis,bien que vous ayez été élevé dans les régles et les coutumes de cette gloire passée,vous n'en etes pas moin rompu tant au maniement des armes qu'a la diplomacie,le sens de la stratégie et etes au fait des tactiques les plus fourbes pour mettre a genoux vos rivaux.sauriez vous dans un tel contexte redonner a vostre famille sa gloire passée ?",
       "none",
      [                          
       (set_background_mesh, "mesh_pic_chevalier"),      
        (play_sound, "snd_page_generique"),         
       ],
      [
      ...
      (troop_add_gold, "trp_player", 483),      
      (jump_to_menu, "mnu_choose_skill"),
       ]),
          
       ("retour",[],"Reviser votre choix.",             
      [
       (jump_to_menu, "mnu_start_choix_classes"),             
       ]),
     ]
...
#
     ...
     ( "classe_mercenaire",mnf_scale_picture,
       "Lorsque vous etiez enfant,vous voulliez suivre la carière de ce père mercenaire que vous n'aviez pas connu,lorsque vostre mère vous parlais de lui,elle le decrivais comme quelqu'un d'arogant,dépenssier et égoiste.vous subveniez tout deux grace a des petits travaux pénibles,puis en grandissant,vous vous rendiez compte qu'une vie de mercenaire pourais vous offrire beaucoup plus,malgrés la grosse part de risque qu'elle comporte.",
       "none",
      [                          
       (set_background_mesh, "mesh_pic_mercenaire"),      
        (play_sound, "snd_page_generique"),         
       ],
      [
      ...
      (assign,"$background_item_mercenaire",1),      
      (assign, reg3, "$character_gender"),
      (assign,"$background_answer_2", cb2_page),
      (assign,"$background_answer_3",cb3_squire),
      (assign,"$background_answer_4",cb4_revenge),       
      (troop_add_gold, "trp_player", 798),         
        (jump_to_menu, "mnu_choose_skill"),
       ]),
...
#
     ...
     ( "classe_marchant",mnf_scale_picture,
       "Vous etes un marchand depuis votre plus jeune age,quand vous etiez enfant,vous échangiez déja des fleches fabriquées par vos camarades contre un panier de pommes,vous revendiez ces pommes sur les marchés,et achetiez des marchandises d'encore plus grande valeur.vous etes ambitieu et décidé a vous enrichire.quand vous transportiez vos marchandises d'une ville a l'autre,vous etiez souvent dépouillé par les bandits de grand chemins,ce qui vous a poussé bien vite a aquérire des notions de combat.vous penssez que la guerre entre francais et anglo bourgignons,pourais etre un bon moyen de pouvoir enfin vous enrichire. ",
       "none",
      [                          
       (set_background_mesh, "mesh_pic_marchand"),      
        (play_sound, "snd_page_generique"),         
       ],
      [
...
#
     ...
     ( "classe_chasseur",mnf_scale_picture,
       "Vous etes un mongtagnard et un chasseur,plus proche des loups et des ours que des habitants des grandes villes.vous etes un archer hors pair et vous gagnez souvent les concourts d'archerie dans les villages quand vous descendez revendre vos fourures.votre vie d'érmite faite de solitude commence a devenire insuportable,vous voullez voire autre chose,partir a l'aventure en proposant a qui en aura besoin vos compétances d'archer.",
       "none",
      [                          
       (set_background_mesh, "mesh_pic_chasseur"),      
        (play_sound, "snd_page_generique"),         
       ],
      [
...
#
     ...
     ( "classe_rebel",mnf_scale_picture,
       "Vous etiez un enfant calme,travaillant dans les champs avec vostre pere,quand l'alliance Anglo Bourgignone s'empara de vos terres les cadences de travail imposees devenirent rapidement impossibles a suivres,et la maigre part de recolte quand il en restait une etait loing de pouvoir subvenir a vos besoins.plus tard quand vostre pere fut condamne pour trahison envers la courone d'angleterre,qui n'etait en fait qu'une simple requete pour avoir une plus grosse part de la recolte aupres de vostre seigneur,vous avez decide de rejoindre les Rebelles qui selon les rumeurs des tavernes se cachent dans les forets pret des grandes villes.",
       "none",
      [         
       (set_background_mesh, "mesh_pic_rebel"),      
        (play_sound, "snd_page_generique"),         
       ],
      [
      ...
      [
      (assign,"$background_type",cb_guard),
      (assign,"$background_item_rebel",1),
      (assign, reg3, "$character_gender"),
      (assign,"$background_answer_2", cb2_urchin),
      (assign,"$background_answer_3",cb3_squire),
      (assign,"$background_answer_4",cb4_revenge),       
      (troop_add_gold, "trp_player", 538),         
        (jump_to_menu, "mnu_choose_skill"),
       ]),
...
#
     ...
     ( "classe_bandit",mnf_scale_picture,
       "Vous etes un bandit de grand chemin au coeur noir,vous ne vous intéressez qu'au profit en penssant au bon temp que vous pourez passer en revensant les biens pris a autruis,un jour on vous areta en train d'essayer de dérober des coffres d'or aux soldats anglais qui escortais le convoie des recettes des impots,vous vous etes dit ce jour la qu'a l'avenir vous préparerez mieux vos plants,et depuis cette époque vous vous etes juré de faire payer aux anglais leurs mauvais traitements infligés pendant vostre détention. ",
       "none",
      [                          
       (set_background_mesh, "mesh_pic_bandit"),      
        (play_sound, "snd_page_generique"),         
       ],
      [
...
#
     ...
     ( "classe_anglais",mnf_scale_picture,
       "Vous etes un soldat Francais,un patriote de premier rang,tres doué dans les arts de combat,ayant été formé aux armes de mélé et au bouclier vous etes un soldat complet et polivalent.vous avez entamé une carrière de guarde du corp perssonel auprés du Duc de Provence.mais vostre patrie en guerre a besoin de vous,avec l'accord de vostre seigneur,vous avez décidé de partir pour rejoindre une unité d'élite avec une lettre de recomandation signée par le Duc de provence en personne.",
       "none",
      [                          
       (set_background_mesh, "mesh_pic_anglais"),      
        (play_sound, "snd_page_generique"),         
       ],
      [
      ...
      (assign,"$background_item_anglais",1),       
      (assign, reg3, "$character_gender"),
      (assign,"$background_answer_2", cb2_steppe_child),
      (assign,"$background_answer_3",cb3_squire),
      (assign,"$background_answer_4",cb4_disown),
      (troop_add_gold, "trp_player", 572),      
      (jump_to_menu, "mnu_choose_skill"),
       ]),
     ...
     ( "classe_bourgignon",mnf_scale_picture,
       "Vous etes un médecin chirurgien,vous offrez vos services en parcourant les routes bes bourgs aux grandes villes,vostre gout pour l'aventure vous as amenné a de nombreuses situations délicates et variées,vous avez vue la grande peste,et soigné des bléssés de guerre,vous avez voué vostre vie a sauver les inocants et a combattre les injustices,en outre,vous etes assez habile au combat au baton et aux armes légères.vous décidez de rejoindre les champs de bataille au centre de la france pour proposer vos services.",
       "none",
      [                          
       (set_background_mesh, "mesh_pic_bourgignon"),      
        (play_sound, "snd_page_generique"),         
       ],
      [
...
###################################### atributs stats et items
  
#  ("atributs_items_chevalier",0,
#   "speech 2 iciiiiiiiiiiiiiiii",
#   "none",
#   [
#     ],
#    [	
#      ("fin_creation",[],"Accepter.",
#       [
         #ajouter stats et items iciiiiiiii

#         (jump_to_menu, "mnu_choose_skill"),
#        ]
#       ),

#      ("autre_persso_dernier_retour",[],"Reviser votre choix.",
#       [
#       (jump_to_menu, "mnu_start_choix_classes"),       
#        ]
#       ),     
...
##        (troop_raise_skill, "trp_player","skl_horse_archery",1),
        ...
        (troop_raise_proficiency, "trp_player",wpt_archery,30),
        (troop_raise_proficiency, "trp_player",wpt_throwing,10),
##        (troop_add_item, "trp_player","itm_battle_shieldredlions",0),
...
#qaqa hungry report
 #   (try_begin),
    #    (gt, "$malus_de_faim", 0),    
  #      (str_store_string, s10, "@Vous etes rassasié !", 0x33DD33),
 #   (else_try),
  #      (gt, "$malus_de_faim", 1),  
  #     (str_store_string, s10, "@Vous etes affamé et vous vous sentez faible ! malus: for -9/ ag -6", 0xFF0000),
 #   (try_end),
...
#    (try_begin),
#        (eq, "$malus_de_faim", 0),    
#        (str_store_string, s2, "@Vous etes rassasié !", 0x33DD33),
#    (else_try),
#        (eq, "$malus_de_faim", 1),  
#        (str_store_string, s2, "@Vous etes affamé et vous vous sentez faible ! malus: for -9/ ag -6", 0xFF0000),
#    (try_end),
#     ],
#    [
#      ("continue",[],"Continue...",
...
#hunger mod reports
    (try_begin),
      ...
      (else_try),        
        (str_store_string, s3, "@Vous etes affamé et vous vous sentez faible ! malus for -2/ ag -1"),#
    (try_end),
...
#wounds/death mod report azqs
    (try_begin),
      (eq, "$blesse_a_jambe", 0),
      (lt, "$blesse_a_jambe", 1),    
        (str_store_string, s9, "@intacts"),
      (else_try),   
        (str_store_string, s9, "@Vous etes blessé a la jambe ! malus for -1/ ag -1"),    
    (try_end),
    (str_store_string, s8, "@Jambes: {s9}"),
#
 
    (try_begin),
      (eq, "$blesse_au_bras", 0),
        (lt, "$blesse_au_bras", 1),    
        (str_store_string, s7, "@intacts"),
      (else_try),
        (str_store_string, s7, "@Vous etes blessé au bras ! malus for -3/ ag -4"),    
    (try_end),
    (str_store_string, s6, "@Bras: {s7}"),    

#
    (try_begin),
      (eq, "$blesse_a_tete", 0),
      (lt, "$blesse_a_tete", 1),    
    (str_store_string, s5, "@intacte"),
      (else_try),
        (str_store_string, s5, "@Vous etes griévement blessé a la tête ! malus for -1/ int -4/ cha -5/ equit/ -1"),    
    (try_end),
    (str_store_string, s4, "@Tête: {s5}"),  
...
#docum_report##     
        ...
        ("docum_report",0,
    "Quel document voullez vous examiner ?",
    "none",
    [],
...
#
    [
      ...
      ("camp_doc1",[(player_has_item, "itm_grimoire_rennes_chat"),],
       "Initiation au savoir franc maconique.",
       [
        (jump_to_menu, "mnu_savoir_maconique"),
        ]
       ),


      ("camp_doc2",[(player_has_item, "itm_grimoire_orleans"),],
       "Les loges secrettes.",
       [
        (jump_to_menu, "mnu_loges_s"),
        ]
       ),
...
#hunger mod reports
        ...
        (str_store_string, s1, "@Initiation au savoir franc maconique par Maistre Roncelinus"),
       
        (str_store_string, s4, "@Une page attire votre attention..."),#

        (str_store_string, s6, "@...Bien sur, il est des plus aisé pour le novice d'ouvrire la loge secrete de Carmel de Micy a Orléans tandis que cela est purement inaccessible au non initié, c'est bien la que nostre savoire prend toute son empleur.^Poser simplement la main gauche sur la genouillère, et la main droite sur le lion armé, et la loge vous ouvrirez..."),#
    ...
    [
      ("continue",[],"Retour...",
       [
             (try_begin),
      (eq, "$livre_fm_lu", 0),           
        (call_script, "script_succ_quest_rennes"),
         (assign, "$livre_fm_lu", 1),
              (try_end),             
           (jump_to_menu, "mnu_reports"),
...
#hunger mod reports
        ...
        (str_store_string, s1, "@Les loges secrettes par Maistre Roncelinus"),  
       
        (str_store_string, s4, "@Une page attire votre attention..."),#

        (str_store_string, s6, "@...La loge de loing la plus importante est celle de Rouen et nous savons pourquois elle est si bien gardée, son entrée est dissimulée dans le vieux cimetière, bien sur nous avons pris les plus grandes précautions, ce lieux ne sera jamais détruis ou meme transformé..."),#
    ...
    [
      ("continue",[],"Retour...",
       [
             (try_begin),
      (eq, "$livre_fm2_lu", 0),           
        (call_script, "script_succ_quest_loge_s"),
         (assign, "$livre_fm2_lu", 1),
              (try_end),             
           (jump_to_menu, "mnu_reports"),
...
#1429 camp joueur seul snow
       ...
       ,"Aller au campement dans la neige.",
       [
  (assign, "$entre_camp", 1),         
        (modify_visitors_at_site,"scn_town_19x_alley"),
        (reset_visitors),			
             (set_jump_entry, 1),
                (try_begin),
...
(player_has_item, "itm_cheval_praire_barder"),
        ...
        (set_jump_mission,"mt_snow_campement"),
        (mission_tpl_entry_set_override_flags, "mt_snow_campement", 1, af_override_horse),        

           (jump_to_scene, "scn_town_19x_alley"),
        (change_screen_mission),           
        ]
       ),

#1429 camp joueur seul snow foret
            ("camp_action_walk",
       [(party_get_current_terrain,":cur_terrain","p_main_party"),
...
#1429 camp snow
       ...
       [
           (assign, "$entre_camp", 1),
        (modify_visitors_at_site,"scn_camp_19_alley"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 2, "trp_campement_troupe_1"),
             (set_visitor, 3, "trp_campement_troupe_2"),
             (set_visitor, 4, "trp_campement_troupe_3"),
             (set_visitor, 5, "trp_campement_troupe_chant_1"),
             (set_visitor, 6, "trp_campement_troupe_serg_1"),
             (set_visitor, 7, "trp_campement_troupe_spec_1"),
...
(player_has_item, "itm_cheval_praire_barder"),
        ...
        (mission_tpl_entry_set_override_flags, "mt_snow_campement", 1, af_override_horse),        
           ...
           (jump_to_scene, "scn_camp_19_alley"),
        (change_screen_mission),           
        ]
       ),


#1429 camp snow forest
            ("camp_action_walk",
       [(party_get_current_terrain,":cur_terrain","p_main_party"),
       (eq, ":cur_terrain", rt_snow_forest),
       (call_script, "script_party_count_members_with_full_health", "p_main_party"),
       ...
       ,"Aller au campement dans la foret.",
       [
           (assign, "$entre_camp", 1),
        (modify_visitors_at_site,"scn_camp_19_alley"),
        (reset_visitors),			
...
#foret steppes joueur seul
       ...
       [
           (assign, "$entre_camp", 1),
        (modify_visitors_at_site,"scn_town_22x_alley"),
        (reset_visitors),			
             (set_jump_entry, 1),
                 (try_begin),
             (main_party_has_troop,"trp_npc1"),
...
(player_has_item, "itm_cheval_praire_barder"),
        ...
        (try_end),  
         ...
         (set_jump_mission,"mt_foret_campement"),
        (mission_tpl_entry_set_override_flags, "mt_foret_campement", 1, af_override_horse),        
       
           (jump_to_scene, "scn_town_22x_alley"),
        (change_screen_mission),           
        ]
       ),
...
#foret steppes
       ...
       [
           (assign, "$entre_camp", 1),
        (modify_visitors_at_site,"scn_camp_22_alley"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 2, "trp_campement_troupe_4"),
             (set_visitor, 3, "trp_campement_troupe_5"),
             (set_visitor, 4, "trp_campement_troupe_6"),
             (set_visitor, 5, "trp_campement_troupe_chant_2"),
             (set_visitor, 6, "trp_campement_troupe_serg_2"),
             (set_visitor, 7, "trp_campement_troupe_spec_2"), 
...
(player_has_item, "itm_cheval_praire_barder"),
        ...
        (mission_tpl_entry_set_override_flags, "mt_foret_campement", 1, af_override_horse),        
           ...
           (jump_to_scene, "scn_camp_22_alley"),
        (change_screen_mission),           
        ]
       ),
...
#steppes joueur seul 
       ...
       ,"Aller au campement dans la campagne.",
       [
           (assign, "$entre_camp", 1),
        (modify_visitors_at_site,"scn_town_20x_alley"),
        (reset_visitors),			
             (set_jump_entry, 1),
                (try_begin),
             (main_party_has_troop,"trp_npc1"),
...
(player_has_item, "itm_cheval_praire_barder"),
        ...
        (set_jump_mission,"mt_campagne_campement"),
        (mission_tpl_entry_set_override_flags, "mt_campagne_campement", 1, af_override_horse),        
        
           (jump_to_scene, "scn_town_20x_alley"),
        (change_screen_mission),           
        ]
       ),
...
#steppes
       ...
       [
           (assign, "$entre_camp", 1),
        (modify_visitors_at_site,"scn_camp_20_alley"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 2, "trp_campement_troupe_7"),
             (set_visitor, 3, "trp_campement_troupe_8"),
             (set_visitor, 4, "trp_campement_troupe_9"),
             (set_visitor, 5, "trp_campement_troupe_chant_3"),
             (set_visitor, 6, "trp_campement_troupe_serg_3"),
             (set_visitor, 7, "trp_campement_troupe_spec_3"), 
...
(player_has_item, "itm_cheval_praire_barder"),
        ...
        (mission_tpl_entry_set_override_flags, "mt_campagne_campement", 1, af_override_horse),        
           ...
           (jump_to_scene, "scn_camp_20_alley"),
        (change_screen_mission),           
        ]
       ),
...
#plaines joueur seul
       ...
       [
           (assign, "$entre_camp", 1),
        (modify_visitors_at_site,"scn_town_21x_alley"),
        (reset_visitors),			
             (set_jump_entry, 1),
                (try_begin),
             (main_party_has_troop,"trp_npc1"),
...
(player_has_item, "itm_cheval_praire_barder"),
        ...
        (mission_tpl_entry_set_override_flags, "mt_plain_campement", 1, af_override_horse),        
           ...
           (jump_to_scene, "scn_town_21x_alley"),
        (change_screen_mission),           
        ]
       ),
...
#plaines
       ...
       [
           (assign, "$entre_camp", 1),
        (modify_visitors_at_site,"scn_camp_21_alley"),
        (reset_visitors),			
             (set_jump_entry, 1),
...
(player_has_item, "itm_cheval_praire_barder"),
        ...
        (mission_tpl_entry_set_override_flags, "mt_plain_campement", 1, af_override_horse),        
           ...
           (jump_to_scene, "scn_camp_21_alley"),
        (change_screen_mission),           
        ]
       ),
...
#   camp END 
##########################################   CRAFT !!!!!!!!!!!
   #   ("craft_campementx",[],"GROUPE1.",
   #    [
    #    (jump_to_menu, "mnu_camp_group1"),           
    #    ]
     #  ),


     #       ("craft_campementxx",[],"GROUPE2.",
   #    [
    #     (jump_to_menu, "mnu_camp_group2"),           
   #     ]
   #    ),
      ...
      ("craft_campement",[],"Fabriquer une arme.",
       [
         (jump_to_menu, "mnu_camp_craft_type"),           
        ]
       ),

######plans de craft repertories !!!!!!!!! PLANS PLANS PLANS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!


      ("plancr_campement",[],"Verifier vos plans de fabrication.",
       [
         (jump_to_menu, "mnu_plan_craf"),           
        ]
       ),
  ...
  ("camp_cheat",0,
   ...
   [
    ...
    [
      ...
      ("camp_cheat_find_item_2",[], "Change weather..",
       [
...
#      ("action_modify_banner",[],"Choisir une nouvelle baniere.",
#       [
 #          (start_presentation, "prsnt_banner_selection"),
           #(start_presentation, "prsnt_custom_banner"),
#        ]
...
###Troop commentary changes end
  ...
  (
    "battle_debrief",mnf_scale_picture|mnf_disable_all_keys,#zaza
...
#       (call_script, "script_music_set_situation_with_culture", mtf_sit_victorious),
       ...
       (try_end),
     (else_try),
       (eq, "$g_battle_result", -1),###### btp variable a suivre !!!!
#     
      (call_script, "script_rr6"),#deth1
#      
       (ge, "$g_enemy_fit_for_battle",1),
       (this_or_next|le, "$g_friend_fit_for_battle",0),
       (le, "$playerparty_postbattle_regulars", 0),
       (str_store_string, s11, "@Battle was lost. Your forces were utterly crushed."),###### btp
  ...
  (
    ...
    [
        ...
        (try_begin),
		  ...
		  #(val_add, ":prosperity", 5), #voir prosperitee
		  ...
		  (val_min, ":str_id", 4),
		  (try_begin),
			(is_between, "$current_town", "p_village_90", villages_end),
...
#
 ...
 {reg5} denars and will take {reg6} days.",
    ...
    [(call_script, "script_get_improvement_details", "$g_improvement_type"),
     ...
     (store_div, ":improvement_time", ":improvement_cost", 300),
     (val_add, ":improvement_time", 1),
 ...
 It looks like you'll have a fight on your hands if you continue.",
    ...
    [
       ...
       (else_try),
        ...
        # (call_script, "script_rr6"),        
         #
        #(try_begin),        #deth 6 dernier decoment pour village en double
       # (eq, "$game_death", 0),
...
#NPC companion changes end
  ...
  (
    ...
    "Do you wish to continue looting this village?",#qqqq
    "none",
    [],
    [
...
#		(try_end),
    ...
    [
      ...
      ("join_tournament", [(neg|is_currently_night),(party_slot_ge, "$current_town", slot_town_has_tournament, 1),]# entree GM 1  
       ...
       [
          ...
          #(play_sound, "snd_tournois_fete"),### a faire, ou play track  
#(play_track, "track_musique_intro_tournois", 1),  
        (music_set_situation, 0),
    (jump_to_menu, "mnu_town_tournament_pay"),           
        ]),
...
#nouveaux pnj 1429
        (try_begin),
           ...
           (eq, "$pnj_tavern_new26", 1),        
             (set_visitor, ":cur_entry", "trp_alcolo_1"),
               (val_add, ":cur_entry", 1),           
                      (try_end),
        (try_begin),
              (call_script, "script_init_new_pnjtavern2"),         
           (eq, "$pnj_tavern_new27", 1),        
             (set_visitor, 27, "trp_courtisane_taverne"),
               (val_add, ":cur_entry", 1),           
             (try_end),
        (try_begin),
              (call_script, "script_init_new_pnjtavern3"),         
           (eq, "$pnj_tavern_new28", 1),        
             (set_visitor, ":cur_entry", "trp_organisateur"),
               (val_add, ":cur_entry", 1),           
            (try_end),

        (try_begin),
                    (eq, "$quete_templiers_donne", 0),
              (call_script, "script_init_new_pnjtavern4"),         
           (eq, "$pnj_tavern_new29", 1),        
             (set_visitor, ":cur_entry", "trp_v_aventurier"),
               (val_add, ":cur_entry", 1),           
            (try_end),

           
        (try_begin),
#les reinitialiser ici par un call script ?
        (assign, "$pnj_tavern_new26", 0),
        (assign, "$pnj_tavern_new27", 0),
        (assign, "$pnj_tavern_new28", 0),  # REMETRE CA !!!!!!!!!!!!!!!!!! <<<<<<<<<<<<<<<<<<<<<<<         
        (assign, "$pnj_tavern_new29", 0),
        (try_end),   
...
#             
			...
			(try_for_range,":entry",32,41),
					...
					(try_begin),
						...
						#(set_visitor,":entry","trp_musican_male",":dna"),
						#(assign,":bard",1),
					#(else_try),
...
##1429 scenes+ paris /model ville        
      ("town_paris_low_districts",#16
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_1"),		
      ],
     "[Quartier] Se rendre dans les quartiers pauvres St.Julien.",
     ...
     [
        ...
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_paris_merchant"),
             (set_visitor, 3, "trp_paris_mendiant1"),
             (set_visitor, 4, "trp_ribaude_1"),
         ...
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_1_alley"),
        (change_screen_mission),            
      ]),

#quartier paris 2
      ("town_paris_2_low_districts",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_1"),		
      ],
     "[Quartier] Visiter la Grande Ecurie.",
       
     [
        (modify_visitors_at_site, "scn_town_paris6_alley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_paris_formateurch"),
             (set_visitor, 3, "trp_paris_vendeurchevauxtop"),
             (set_visitor, 4, "trp_paris_ecuyer"),
             (set_visitor, 5, "trp_ressource_merchant_paris"),        
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_paris_ecurie"),
         (mission_tpl_entry_set_override_flags, "mt_town_paris_ecurie", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_paris6_alley"),
        (change_screen_mission),            
      ]),      


#quartier paris entree catacombes avec compagnon
      ("town_paris_3_low_districts",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_1"),        
      ],
     "[Quartier] Aller a l'entrée des Catacombes.",
       
     [
        (modify_visitors_at_site, "scn_town_paris_cataentry"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
        (try_begin),
           (eq, "$compagnon_catasrejoin", 0),        
             (set_visitor, 9, "trp_comp_catas"),
        (try_end),        
             (set_visitor, 40, "trp_cata_miliceparis"),        
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_cata_district_entry"),
         (mission_tpl_entry_set_override_flags, "mt_cata_district_entry", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_paris_cataentry"),
        (change_screen_mission),            
      ]),


#cathedrale
      ("town_paris_cath_districts",#16
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_1"),		
      ],
     "[Quartier] Visiter la Cathèdrale Notre Dame.",
       
     [
        (modify_visitors_at_site, "scn_town_1cat_alley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
           # (set_visitor, 2, "trp_paris_merchant"),
           ...
           (set_jump_mission,"mt_town_quartiers"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_1cat_alley"),
        (change_screen_mission),            
      ]),
...
##town_paris banque
     ...
     "[Banque] Aller a la banque de Paris.",
       
     [
        (modify_visitors_at_site, "scn_town_parisbanque"),
        (reset_visitors),
          # (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_paris_banquier"),                
            #(set_visitor, 3, "trp_sirene_2"),                       
           (set_jump_mission,"mt_trois_sirenn"),
         (mission_tpl_entry_set_override_flags, "mt_trois_sirenn", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_parisbanque"),
        (change_screen_mission),            
      ]),


##town_2|Reims modele /foret generique#SCENE REIMS LIBRE si besoin
      ("town_reims_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_2"),
   #cond quete active,pas si failed ou win
     ...
     "[Lieux] Aller au Manoire.",
     [
        (modify_visitors_at_site, "scn_assa_manoire"),
        (reset_visitors),       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_banquier"), # garder nom
            (set_visitor, 40, "trp_manoire_conviv_invit1"),        
            (set_visitor, 41, "trp_manoire_conviv_invit2"),        
            (set_visitor, 42, "trp_manoire_conviv_medic"),        
            (set_visitor, 43, "trp_manoire_chevalier"),        
            (set_visitor, 44, "trp_manoire_halberdier1"),        
            (set_visitor, 45, "trp_manoire_halberdier2"),        
            (set_visitor, 46, "trp_manoire_cuistot"),        
...
##town_3|Angers
      ...
      ("town_Angers_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_3"),		
      ],
     "[Quartier] Aller dans le vieux quartier.",
       
     [
        (modify_visitors_at_site, "scn_town_3_alley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
             (set_visitor, 4, "trp_anger_baner"),
             (set_visitor, 5, "trp_ressource_merchant_anger"),        
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
...
##town_4|Bourges BATAILLE entrepots vilandrandro

      ("town_Bourges_bat_entrepot",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_4"),
        #(lt, "$patmissionllyyssloose", 1),
     ...
     "[Quartier] Rejoindre la bataille des entrepots.",
       
     [
        (modify_visitors_at_site, "scn_town_4_battle_v"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
            (set_jump_entry, 1),
            (set_visitor, 2, "trp_sang_lysbatb1"),
            (set_visitor, 3, "trp_sang_lysbatb2"),
            (set_visitor, 4, "trp_sang_lysbatb3"),
            (set_visitor, 5, "trp_sang_lysbatb4"),
            (set_visitor, 6, "trp_sang_lysbatb5"),
            (set_visitor, 7, "trp_sang_lysbatb6"),
            (set_visitor, 40, "trp_sang_lysbatb7"),        
            (set_visitor, 40, "trp_sang_lysbatb8"),
            (set_visitor, 40, "trp_sang_lysbatb9"),        
            (set_visitor, 40, "trp_sang_lysbatb10"),
            (set_visitor, 40, "trp_sang_lysbatb11"),
             (set_visitor, 41, "trp_vilandrandro_bat_bourg1"),
             (set_visitor, 41, "trp_vilandrandro_bat_bourg2"),
             (set_visitor, 41, "trp_vilandrandro_bat_bourg3"),
             (set_visitor, 41, "trp_vilandrandro_bat_bourg4"),
             (set_visitor, 42, "trp_vilandrandro_bat_bourg5"),
             (set_visitor, 42, "trp_vilandrandro_bat_bourg6"),
             (set_visitor, 42, "trp_vilandrandro_bat_bourg7"),
             (set_visitor, 43, "trp_vilandrandro_bat_bourg8"),         
             (set_visitor, 43, "trp_vilandrandro_bat_bourg9"),
             (set_visitor, 43, "trp_vilandrandro_bat_bourg10"),
             (set_visitor, 43, "trp_vilandrandro_bat_bourg11"),
             (set_visitor, 44, "trp_vilandrandro_bat_bourg12"),
             (set_visitor, 44, "trp_vilandrandro_bat_bourg13"),
             (set_visitor, 44, "trp_vilandrandro_bat_bourg14"),        
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes             
           (set_jump_mission,"mt_t_quartiers_battle_entrepots"),
         (mission_tpl_entry_set_override_flags, "mt_t_quartiers_battle_entrepots", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_4_battle_v"),
        (change_screen_mission),
        (music_set_situation, 0),
      ]),

##town_4|Bourges MISSION TAVERNE sl ivre
      
      ("town_Bourges_districts_tavern",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_4"),
     ...
     "[Quartier] Allez a la taverne des Trois Lys.",
       
     [
        (modify_visitors_at_site, "scn_tavern_3lys"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
            (set_jump_entry, 1),
            (set_visitor, 8, "trp_tlys_tavernkeeper"),
             (set_visitor, 9, "trp_tlys_bookseller"),
             (set_visitor, 40, "trp_sang_lysivretlys"),
            # (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes             
           (set_jump_mission,"mt_quartiers_bourges_taverntl"),
         (mission_tpl_entry_set_override_flags, "mt_quartiers_bourges_taverntl", 1, af_override_horse),                                       
        (jump_to_scene, "scn_tavern_3lys"),
        (change_screen_mission),            
      ]),

##town_4|Bourges MISSION PATROUILLE entrepots

      ("town_Bourges_districts_scene3",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_4"),
        (lt, "$patmissionllyyssloose", 1),
     ...
     "[Quartier] Patrouiller aux entrepots.",
       
     [
        (modify_visitors_at_site, "scn_town_4_etpalley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
            (set_jump_entry, 1),
            (set_visitor, 8, "trp_entrepot_contremaitre"),
             (set_visitor, 40, "trp_entrepot_bandit_1"),
             (set_visitor, 41, "trp_entrepot_bandit_2"),
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes             
           (set_jump_mission,"mt_t_quartiers_bourges_entrepots"),
         (mission_tpl_entry_set_override_flags, "mt_t_quartiers_bourges_entrepots", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_4_etpalley"),
        (change_screen_mission),            
      ]),


##town_4|Bourges MISSION DUMY!!!!!!!

      ("town_Bourges_districts_scene2",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_4"),
         (eq, "$bougescendumy", 1),
      ],
     "[Quartier] Finire le test de recrutement sur la place Gordaine.",
       
     [
        (modify_visitors_at_site, "scn_town_4_alley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
            (set_jump_entry, 1),
            (set_visitor, 2, "trp_gordaine_sang_lys1"),
             (set_visitor, 40, "trp_gordaine_sang_lys2"),
             (set_visitor, 41, "trp_gordaine_sang_lys3"),
             (set_visitor, 16, "trp_gordaine_sang_lys4"),
             (set_visitor, 17, "trp_gordaine_sang_lys5"),
             (set_visitor, 18, "trp_gordaine_sang_lys6"),
             (set_visitor, 19, "trp_gordaine_sang_lys7"),
             (set_visitor, 20, "trp_gordaine_sang_lys8"),
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_quartiers_bourges_dumy"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers_bourges_dumy", 1, af_override_horse),                                       
...
##town_4|Bourges
      ...
      ("town_Bourges_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_4"),
        (eq, "$bougescendumy", 0),
      ],
     "[Quartier] Se ballader sur la place Gordaine.",
        ...
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
            ...
            (set_visitor, 2, "trp_gordaine_sang_lys1"),
             ...
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_quartiers_bourges"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers_bourges", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_4_alley"),
        (change_screen_mission),            
      ]),


##town_4|Bourges messgaers

      ("town_Bourges_districts2_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_4"),
      ],
     "[Quartier] Aller a la guilde des Messagers.",
       
     [
        (modify_visitors_at_site, "scn_town_bourges_messagers"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default),       
            (set_jump_entry, 1),
            #compagnon 
           (try_begin),
            (eq, "$comp_bourgg_avecmoi",0),#
             (set_visitor, 9, "trp_comps_bourges"),
             (try_end),
             #        
            (set_visitor, 2, "trp_messenger_master_bourges"),
          # (call_script, "script_mesenger_part"),        
             (assign, "$town_entered", 1),     
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_variation_quartiers"),
        # (mission_tpl_entry_set_override_flags, "mt_town_variation_quartiers", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_bourges_messagers"),
        (change_screen_mission),            
      ]),
      

#cathedrale bourges
      ("town_bourges_cath_districts",#16
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_4"),		
      ],
     "[Quartier] Visiter la Cathèdrale Saint Etienne.",
       
     [
        (modify_visitors_at_site, "scn_town_bourgcat_alley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
           # (set_visitor, 2, "trp_paris_merchant"),
           ...
           (set_jump_mission,"mt_town_quartiers"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_bourgcat_alley"),
        (change_screen_mission),            
      ]),
...
##town_bourges banque
     ...
     "[Banque] Aller a la banque de Bourges.",
       
     [
        (modify_visitors_at_site, "scn_town_bourgesbanque"),
        (reset_visitors),
          # (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_Bourges_banquier"),                
            #(set_visitor, 3, "trp_sirene_2"),                       
           (set_jump_mission,"mt_trois_sirenn"),
         (mission_tpl_entry_set_override_flags, "mt_trois_sirenn", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_bourgesbanque"),
        (change_screen_mission),            
      ]),
...
##town_5|Metz attaque entrepot
     ...
     "[Quartier] Passer par la rivière pour rejoindre la porte des allemands.",
       
     [
        (modify_visitors_at_site, "scn_town_5_batetp"),
        (reset_visitors),       
             (set_jump_entry, 2),       
            (set_visitor, 3, "trp_rebel_verzentrep1"),
             (set_visitor, 4, "trp_rebel_verzentrep2"),
             (set_visitor, 5, "trp_rebel_verzentrep3"),
             (set_visitor, 6, "trp_rebel_verzentrep4"),
             (set_visitor, 7, "trp_rebel_verzentrep5"),
             #(set_visitor, 7, "trp_rebel_verzentrep6"),
            # (set_visitor, 8, "trp_bourg_entrep_copie1"),
            (set_visitor, 40, "trp_bourg_entrep_copie1"),
             (set_visitor, 41, "trp_bourg_entrep_copie2"),
             (set_visitor, 42, "trp_bourg_entrep_copie3"),
             (set_visitor, 43, "trp_bourg_entrep_copie4"),
             (set_visitor, 44, "trp_bourg_entrep_copie5"),
             (set_visitor, 45, "trp_bourg_entrep_copie6"),
             (set_visitor, 46, "trp_bourg_entrep_copie7"),
             (set_visitor, 47, "trp_bourg_entrep_copie8"),        
           (set_jump_mission,"mt_bataill_etp_metz"),
         (mission_tpl_entry_set_override_flags, "mt_bataill_etp_metz", 2, af_override_horse),                                       
        (jump_to_scene, "scn_town_5_batetp"),
        (music_set_situation, 0),
        (change_screen_mission),            
      ]),
...
##town_5|Metz ballade 
     ...
     "[Quartier] Aller sur le lieu dit de la porte des Allemands.",
       
     [
        (modify_visitors_at_site, "scn_town_5_alley"),
        (reset_visitors),       
             (set_jump_entry, 1),        
            (set_visitor, 40, "trp_bourg_entrep_metz1"),
             (set_visitor, 41, "trp_bourg_entrep_metz2"),
             (set_visitor, 42, "trp_bourg_entrep_metz3"),
             (set_visitor, 43, "trp_bourg_entrep_metz4"),
             (set_visitor, 44, "trp_bourg_entrep_metz5"),
             (set_visitor, 45, "trp_bourg_entrep_metz6"),
             (set_visitor, 46, "trp_bourg_entrep_metz7"),
             (set_visitor, 47, "trp_bourg_entrep_metz8"),        
           (set_jump_mission,"mt_entrepots_metz"),
         (mission_tpl_entry_set_override_flags, "mt_entrepots_metz", 1, af_override_horse),                                       
...
##town_6|Dijon
      ...
      ("town_Dijon_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_6"),		
      ],
     "[Quartier] Visiter les hospices.",
       
     [
        (modify_visitors_at_site, "scn_town_6_fleuve"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_dijon_moine_guer_troup"),
             (set_visitor, 3, "trp_dijon_moine_discut_troup"),
             (set_visitor, 4, "trp_dijon_blesse_troop"),
             (set_visitor, 5, "trp_ressource_merchant_dijon"),
            #compagnon 
           (try_begin),
            (eq, "$comp_dijon_avecmoi",0),#
             (set_visitor, 9, "trp_comps_dijon"),
             (try_end),
             #         
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_quartiers"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_6_fleuve"),
        (change_screen_mission),            
      ]),


##town_7|Montpellier  jardin

      ("town_Montpellier_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_7"),		
      ],
     "[lieux] Visiter les jardins",
       
     [
        (modify_visitors_at_site, "scn_town_7_alley"),
        (reset_visitors),
         (assign, "$g_mt_mode", tcm_default),
             (set_jump_entry, 1),
              (set_visitor, 6, "trp_dame_jardin"),
          #    (set_visitor, 3, "trp_rebel_montpelier_tower_2"),
           #   (set_visitor, 4, "trp_rebel_montpelier_tower_3"),
         #     (set_visitor, 5, "trp_rebel_montpelier_tower_4"),
         #     (set_visitor, 6, "trp_rebel_montpelier_tower_5"),
       #      (set_visitor, 7, "trp_rebel_montpelier_tower_6"),
       #      (set_visitor, 8, "trp_rebel_montpelier_tower_7"),
        #     (set_visitor, 9, "trp_rebel_montpelier_tower_8"),
            (assign, "$town_entered", 1),
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_quartiers"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers", 1, af_override_horse),                                      
...
##town_8|marseille guild messagers
      ("town_Grenoble_districts2_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
     ...
     [
        (modify_visitors_at_site, "scn_town_marss_messagers"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default),     
             (set_jump_entry, 1),
            #compagnon 
           (try_begin),
            (eq, "$comp_marseille_avecmoi",0),
             
             (try_end),
             #        
            (set_visitor, 2, "trp_messenger_master_calais"),
           #  (set_visitor, 5, "trp_ressource_merchant_caen"),
          # (call_script, "script_mesenger_part"),
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_variation_quartiers"),
         (mission_tpl_entry_set_override_flags, "mt_town_variation_quartiers", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_marss_messagers"),
        (change_screen_mission),            
      ]),

##town_8|marseille abbayes generiques /grenoble/toulouse
      ("town_Grenoble_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_8"),		
      ],
     "[Lieux] Visiter l'abbaye aux dames.",
       
     [
        (modify_visitors_at_site, "scn_town_8_alley"),
        (reset_visitors),       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_soeur_1d"),
             (set_visitor, 3, "trp_soeur_3d"),
             (set_visitor, 4, "trp_soeur_2d"),
             (set_visitor, 5, "trp_soeur_4d"),         
           (set_jump_mission,"mt_abbayes_generiques"),
         (mission_tpl_entry_set_override_flags, "mt_abbayes_generiques", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_8_alley"),
        (change_screen_mission),            
      ]),

##town_marseille banque
     ("town_mars_banq",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_8"),                                                                 
      ],
     "[Banque] Aller a la banque de Marseille.",
       
     [
        (modify_visitors_at_site, "scn_town_marseillebanque"),
        (reset_visitors),
          # (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_marseille_banquier"),                
            #(set_visitor, 3, "trp_sirene_2"),                       
           (set_jump_mission,"mt_trois_sirenn"),
         (mission_tpl_entry_set_override_flags, "mt_trois_sirenn", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_marseillebanque"),
        (change_screen_mission),            
      ]),
...
##town_9|Caen
      ...
      ("town_Caen_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_9"),		
      ],
     "[Quartier] Aller au chateau Ducale.",
       
     [
        (modify_visitors_at_site, "scn_town_9_alley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_caen_spec_guard"),
             (set_visitor, 5, "trp_ressource_merchant_caen"),
         #    (set_visitor, 4, "trp_ribaude_1"),
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
...
##town_10|Limoges
      ...
      ("town_Limoges_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_10"),		
      ],
      "[Quartier] Aller a l'atelier de siege..",
       
     [
        (modify_visitors_at_site, "scn_town_10_alley"),
        (reset_visitors),       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_limoge_artisant1"),
             (set_visitor, 3, "trp_limoge_artisant2"),
           ...
           (try_begin),
            (eq, "$comp_limoge_avecmoi",0),#
             ...
             (try_end),
             #         
           (set_jump_mission,"mt_foret_generique"),
#         (mission_tpl_entry_set_override_flags, "mt_foret_generique", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_10_alley"),
        (change_screen_mission),            
      ]),


##town_11|Calais guild messagers
      ("town_Caen_districts2_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
     ...
     [
        (modify_visitors_at_site, "scn_town_9_messagers"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            #compagnon 
           (try_begin),
            (eq, "$comp_calais_avecmoi",0),#
             (set_visitor, 9, "trp_comps_calais"),
             (try_end),
             #          
            (set_visitor, 2, "trp_messenger_master"),
           # (call_script, "script_mesenger_part"),
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_variation_quartiers"),
         (mission_tpl_entry_set_override_flags, "mt_town_variation_quartiers", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_9_messagers"),
        (change_screen_mission),            
      ]),
...
##town_11|Calais
      ...
      ("town_Calais_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_11"),		
      ],
      "[Lieux] Se rendre au cimetière.",
       
     [
        (modify_visitors_at_site, "scn_town_11_alley"),
        (reset_visitors),       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_caen_foss"),      
           (set_jump_mission,"mt_foret_generique"),
         (mission_tpl_entry_set_override_flags, "mt_foret_generique", 1, af_override_horse),                                       
...
##town_12|Rouen vieux cimetiere

      ("town_Rouen_districts_sceness",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_12"),
         (check_quest_active, "qst_loge_s_paris"),
         (neg|check_quest_succeeded, "qst_loge_s_paris"),
         (neg|check_quest_failed, "qst_loge_s_paris"),
         (neg|check_quest_finished, "qst_loge_s_paris"),  
        
      ],
     "[Quartier] Aller au vieux cimetière de Rouen.",
       
     [
        (modify_visitors_at_site, "scn_vieux_cimetier_rouen"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            #(set_visitor, 2, "trp_paris_merchant"),
             #(set_visitor, 3, "trp_paris_mendiant1"),
            # (set_visitor, 4, "trp_ribaude_1"),
             #(set_visitor, 5, "trp_ressource_merchant_roen"),
             #(set_visitor, 6, "trp_rouen_merchantquest"),
            # (set_visitor, 7, "trp_rouen_mercenaire"),        
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_quartiers_roeun_quest"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers_roeun_quest", 1, af_override_horse),                                       
        (jump_to_scene, "scn_vieux_cimetier_rouen"),
        (change_screen_mission),            
      ]),

##town_12|Rouen

      ("town_Rouen_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_12"),		
      ],
     "[Quartier] Aller sur la place de l'eglise saint Maclou.",
       
     [
        (modify_visitors_at_site, "scn_town_12_alley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            #(set_visitor, 2, "trp_paris_merchant"),
...
##town_13|Toulouse 
      ...
      ("town_Toulouse_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_13"),		
      ],
     "[Lieux] Visiter le cloitre des Jacobins.",
       
     [
        (modify_visitors_at_site, "scn_town_13_alley"),
        (reset_visitors),       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_jacobin_gueris"),
             (set_visitor, 3, "trp_jacobin_vendor"),
             (set_visitor, 4, "trp_jacobin_chief"),
             (set_visitor, 5, "trp_jacobin_benis"),        
           (set_jump_mission,"mt_abbayes_generiques"),
         (mission_tpl_entry_set_override_flags, "mt_abbayes_generiques", 1, af_override_horse),                                       
...
##town_14|Bordeaux
      ...
      ("town_Bordeaux_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_14"),		
      ],
     "[Quartier] Se promener dans la rue Comercante Sainte Catherine.",
       
     [
        (modify_visitors_at_site, "scn_town_14_alley"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_bordeau_artisant1"),
             (set_visitor, 3, "trp_bordeau_artisant2"),
             (set_visitor, 4, "trp_bordeau_artisant3"),
             (set_visitor, 5, "trp_bordeau_artisant4"),
             (set_visitor, 6, "trp_messenger_master_bordeau"),        
             (set_visitor, 13, "trp_ressource_merchant_bordeau"),
           # (call_script, "script_mesenger_part"),
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_quartiers"),
...
##town_14|Bordeaux
      ...
      ("town_Bordport_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_14"),		
      ],
     "[Quartier] Se rendre au Port fluviale.",
       
     [
        (modify_visitors_at_site, "scn_town_14_port"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
           # (set_visitor, 2, "trp_bordeau_artisant1"),
           ...
           (set_jump_mission,"mt_town_quartiers"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_14_port"),
        (change_screen_mission),            
      ]),
...
##town_16|Tours
      ...
      ("town_Tours_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_16"),		
      ],
     "[Quartier] Aller au Quartier de la Caserne.",
     ...
     [
        ...
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_tour_caserne_4"),        
            (set_visitor, 5, "trp_tour_caserne_1"),
             (set_visitor, 6, "trp_tour_caserne_2"),
             (set_visitor, 7, "trp_tour_caserne_3"),
             (set_visitor, 40, "trp_tour_caserne_5"),
             (set_visitor, 41, "trp_tour_caserne_6"),
             (set_visitor, 13, "trp_ressource_merchant_tours"),        
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_caserne"),
         (mission_tpl_entry_set_override_flags, "mt_town_caserne", 1, af_override_horse),                                       
...
##town_16|Tours vieux chateau

      ("town_Tours_vieuxchateau",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_16"),
	 (neg|player_has_item, "itm_Chevaliere"),        
     ...
     "[Quartier] Aller au vieux Chateau.",
       
     [
        (modify_visitors_at_site, "scn_town_16_vchateau"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur
           (assign, "$premiernivchateau", 0),
           (assign, "$deuxiemnivchateau", 0),
           (assign, "$troisiemnivchateau", 0),        
             (set_jump_entry, 1),
             (set_visitor, 40, "trp_chateautours_7"),         
             (set_visitor, 41, "trp_chateautours_1"),               
             (set_visitor, 42, "trp_chateautours_2"),               
            # (set_visitor, 43, "trp_chateautours_3"),               
             (set_visitor, 44, "trp_chateautours_4"),               
             (set_visitor, 45, "trp_chateautours_5"),               
             (set_visitor, 46, "trp_chateautours_6"),       
             (assign, "$town_entered", 1),        
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_vieuxchateau"),
         (mission_tpl_entry_set_override_flags, "mt_town_vieuxchateau", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_16_vchateau"),
        (change_screen_mission),             
      ]),
...
##town_16|maison des trois sirenes
     ("town_Tours_troissirenes",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_16"),
     ...
     "[Quartier] Aller a la maison des trois sirènes.",
       
     [
        (modify_visitors_at_site, "scn_t_sirenes"),
        (reset_visitors),
          # (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_sirene_1"),                
            (set_visitor, 3, "trp_sirene_2"),                
            (set_visitor, 4, "trp_sirene_3"),                
            (set_visitor, 5, "trp_sirene_client"),                
            (set_visitor, 6, "trp_sirene_chambellan"),                
            (set_visitor, 7, "trp_sirene_4"),                             
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            #(call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_trois_sirenn"),
         (mission_tpl_entry_set_override_flags, "mt_trois_sirenn", 1, af_override_horse),                                       
        (jump_to_scene, "scn_t_sirenes"),
        (change_screen_mission),            
      ]),

##town_17|rencontrer licorne a Poitiers
     ...
     #     (check_quest_active, "qst_rebel_shearchlico"),
            (eq, "$rencontrdelicornpott", 1),        
      ],
     "[Lieux] Allez a la rencontre de Licorne dans les jardins.",
       
     [
        (modify_visitors_at_site, "scn_town_17_alley"),
        (reset_visitors),       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_rebel_licorn"),
            # (set_visitor, 3, "trp_paris_mendiant1"),
            # (set_visitor, 4, "trp_ribaude_1"),        
           (set_jump_mission,"mt_foret_generique"),
         (mission_tpl_entry_set_override_flags, "mt_foret_generique", 1, af_override_horse),                                       
...
##town_17|Poitiers
      ...
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_17"),
      #    (neg|check_quest_active, "qst_rebel_shearchlico"),
            (eq, "$rencontrdelicornpott", 0),        
      ],
     "[Lieux] Se promener dans les jardins.",
       
     [
        (modify_visitors_at_site, "scn_town_17_vide_alley"),
        (reset_visitors),       
             (set_jump_entry, 1),
            #(set_visitor, 2, "trp_paris_merchant"),
             #(set_visitor, 3, "trp_paris_mendiant1"),
           ...
           (set_jump_mission,"mt_foret_generique"),
         (mission_tpl_entry_set_override_flags, "mt_foret_generique", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_17_vide_alley"),
        (change_screen_mission),            
      ]),
...
##town_18|Avignon apres quetes avec milliciens
      ...
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         ...
         (this_or_next|check_quest_succeeded, "qst_sl_deffensse_benezet"),
         (check_quest_failed, "qst_sl_deffensse_benezet"),        
      ],
     "[Lieux] Aller sur le pont Saint Benezet.",
       
     [
        (modify_visitors_at_site, "scn_town_18_benezet_end"),
        (reset_visitors),       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_milliceneutre1"),
             (set_visitor, 3, "trp_milliceneutre2"),
                    
           (set_jump_mission,"mt_riviere_battle"),
         (mission_tpl_entry_set_override_flags, "mt_riviere_battle", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_18_benezet_end"),
        (change_screen_mission),            
      ]),     


##town_18|Avignon battle scene
     ...
     "[Lieux] Aller voire le pont Saint Benezet.",
       
     [
        (modify_visitors_at_site, "scn_town_18_alley"),
        (reset_visitors),       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_sang_lyspont1"),
             (set_visitor, 3, "trp_sang_lyspont2"),
             (set_visitor, 4, "trp_sang_lyspont3"),
             (set_visitor, 5, "trp_sang_lyspont4"),
            (set_visitor, 6, "trp_sang_lyspont5"),
             (set_visitor, 7, "trp_sang_lyspont6"),
             (set_visitor, 8, "trp_sang_lyspont7"),
             (set_visitor, 40, "trp_pontbenezet_troop1"),
             (set_visitor, 41, "trp_pontbenezet_troop2"),
             (set_visitor, 42, "trp_pontbenezet_troop3"),
             (set_visitor, 42, "trp_pontbenezet_troop4"),
             (set_visitor, 42, "trp_pontbenezet_troop5"),
             (set_visitor, 43, "trp_pontbenezet_troop6"),
             (set_visitor, 43, "trp_pontbenezet_troop7"),
             (set_visitor, 44, "trp_pontbenezet_troop8"),
             (set_visitor, 44, "trp_pontbenezet_troop9"),
             (set_visitor, 45, "trp_pontbenezet_troop10"),        
             (set_visitor, 45, "trp_pontbenezet_troop11"),
             (set_visitor, 46, "trp_pontbenezet_troop12"),
             (set_visitor, 46, "trp_pontbenezet_troop17"),
             (set_visitor, 46, "trp_pontbenezet_troop18"),
             (set_visitor, 46, "trp_pontbenezet_troop19"),
             (set_visitor, 46, "trp_pontbenezet_troop20"),
             (set_visitor, 46, "trp_pontbenezet_troop21"),        
             (set_visitor, 47, "trp_pontbenezet_troop13"),
             (set_visitor, 47, "trp_pontbenezet_troop14"),
             (set_visitor, 47, "trp_pontbenezet_troop15"),
             (set_visitor, 47, "trp_pontbenezet_troop16"),        
           (set_jump_mission,"mt_riviere_star_battle"),
         (mission_tpl_entry_set_override_flags, "mt_riviere_star_battle", 1, af_override_horse),                                       
...
##town_20|LYON aqaqaq
      ...
      ("town_lyon_districts_scene",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_20"),		
      ],
     "[Quartier] Aller a la Caserne de Lyon.",
       
     [
        (modify_visitors_at_site, "scn_town_casern_lyon"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_lyon_caserne_4"),        
            (set_visitor, 5, "trp_lyon_caserne_1"),
             (set_visitor, 6, "trp_lyon_caserne_2"),
             (set_visitor, 7, "trp_lyon_caserne_3"),
             (set_visitor, 40, "trp_lyon_caserne_5"),
             (set_visitor, 41, "trp_lyon_caserne_6"),
             #(set_visitor, 13, "trp_ressource_merchant_tours"),        
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_lyon_caserne"),
         (mission_tpl_entry_set_override_flags, "mt_lyon_caserne", 1, af_override_horse),                                       
        (jump_to_scene, "scn_town_casern_lyon"),
        (change_screen_mission),            
      ]),
     ...
     "[Quartier] Aller a la rue des Dames pour protéger le Comte de Rennes.",
       
     [
        (modify_visitors_at_site, "scn_rue_des_dames_rennes"),
        (reset_visitors),
           (assign, "$g_mt_mode", tcm_default), ##pas sur       
             (set_jump_entry, 1),
            (set_visitor, 2, "trp_rue_dame_comte"),
             (set_visitor, 3, "trp_rue_dame_interlocuteur"),
             (set_visitor, 4, "trp_rue_dame_assassin1"),
             (set_visitor, 5, "trp_rue_dame_assassin2"),
             (set_visitor, 6, "trp_rue_dame_assassin3"),
             (set_visitor, 7, "trp_rue_dame_assassin4"),         
             (set_visitor, 8, "trp_rue_dame_assassin5"),         
             (assign, "$town_entered", 1),  ## pas sur et revoir l'ordre des lignes differentes      
            (call_script, "script_init_town_walkers"),        
           (set_jump_mission,"mt_town_quartiers_rennes_quest"),
         (mission_tpl_entry_set_override_flags, "mt_town_quartiers_rennes_quest", 1, af_override_horse),                                       
        (jump_to_scene, "scn_rue_des_dames_rennes"),
        (change_screen_mission),            
      ]), 
...
#1429 scenes +FIN
	...
	[
       ...
       "Vous ne conaissez pas encore le Maistre de Guilde.",
       [
     ]),
	 ##nested diplomacy end+
	  ##diplomacy end
...
("town_recruit_volunteers",
  ...
  (
    "town_tournament_lost",0,#entree GM 3
  ...
  (
    "tournois_lost",0,# 
    "Vous etes éliminé du tournoi.{s53}",#"{s52}",
    "none",
    [ 
	...
	(try_begin),
		...
		(faction_slot_eq, "$g_encountered_party_faction", slot_faction_ai_state, sfai_feast),
		(faction_slot_eq, "$g_encountered_party_faction", slot_faction_ai_object, "$g_encountered_party"),
		(str_store_string, s53, "@Mais vous etes invité au banquet qui si déroule au chateau"),
        (try_end),

#(str_store_string, s52, "@Vous etes éliminé du tournois.{s53}"),
	
        ],
    [
      ("continue", [], "Continue...",
       [(jump_to_menu, "mnu_town_tournament_autre_vainqueur"),
        ]),
    ]
  ),
  ...
  (
    "town_tournament_victoire",0,
    "Vous avez remporté le tournoi ! sans compter la gloire que cela vous procure, vous gagnez la somme du grand prix qui s'éleve a {reg15} écus, et un objet de valeur vous est offert par le seigneur organisateur. {s58}",
    "none",
    [
       # (str_clear, s56), 

(play_sound, "snd_tournois_remporte"),
...
(assign, "$tournois_grand_prix_ecus", 6500),
...
(assign, "$tournois_grand_prix_ecus", 5500),
...
(assign, "$tournois_grand_prix_ecus", 5600),
...
(assign, "$tournois_grand_prix_ecus", 5800),


        (else_try),

(assign, "$tournois_grand_prix_ecus", 3800),
...
(try_end),
         ...
         (assign, reg15, "$tournois_grand_prix_ecus"),#
        #call script objet all?toire et le donner...
   ###  (str_store_string, s56, "@Vous avez remporté le tournois ! sans compter la gloire que cela vous procure, vous gagnez la somme du grand prix qui s'éleve a (reg15) écus, et un objet de valeur vous est offert par le seigneur organisateur. {s58}."),
       #assigner dedier la victoire a une dame,
        #voire si une condition a invitation chateau ? si banquet en court = delivrer l'invitation ???


(troop_add_gold, "trp_player", "$tournois_grand_prix_ecus"),
(call_script, "script_random_objet_tournois_win"),########
		...
		(try_begin),
			...
			(faction_slot_eq, "$g_encountered_party_faction", slot_faction_ai_state, sfai_feast),
			(faction_slot_eq, "$g_encountered_party_faction", slot_faction_ai_object, "$g_encountered_party"),
			(str_store_string, s58, "@Vous etes aussi invité au banquet qui si déroule au chateau"),
		(try_end),
...
# ? begin
 ...
 (assign, "$dedier_victoire_dame", 1),
  ...
  (
    "town_tournament_won",mnf_disable_all_keys,#entree GM 4
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} denars. {s8}",
  ...
  (
    "town_tournament_won_by_another",mnf_disable_all_keys, #entree GM 5
  ...
  (
    "town_tournament_autre_vainqueur",mnf_disable_all_keys, #entree GM 5
    "Le vainqueur du tournoi est : {s54}.",
    "none",
    [


(str_store_troop_name, s54, "$jouteur_1"),
        

        (try_begin),

          (call_script, "script_change_troop_renown", "$jouteur_1", 20),
        (try_end),
        ],
    [
      ("continue", [], "Continuer.",
...
(assign, "$tournois_cout", 2350),
     (assign, reg5, "$tournois_cout"),
(assign, "$tournois_grand_prix_ecus", 6500),
     (assign, reg6, "$tournois_grand_prix_ecus"),

        (else_try),
              (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_3"),
     
(assign, "$tournois_cout", 2030),
     (assign, reg5, "$tournois_cout"),
(assign, "$tournois_grand_prix_ecus", 5500),
     (assign, reg6, "$tournois_grand_prix_ecus"),
...
(str_store_string, s28, "@Les frais de l'inscription au tournoi et de location de l'équipement s'élèvent a {reg5} écus. Le prix au vainqueur est de {reg6} écus ainsi qu'un objet de valeur."),
...
#(assign, "$tour9", 0),#??? si utilis?pour victoire  
(troop_remove_gold,"trp_player","$tournois_cout"),
           
          (jump_to_menu, "mnu_town_tournament_choice"),  
        ]),



      ("tournament_pay2", [], "Quitter le Tournoi.",
       [(jump_to_menu, "mnu_town"),#
        ]),
    ]
  ),
  ...
  (
    "town_tournament_choice",0,#entree new
    ...
    [
       ("tournament_reglement1", [], "Lire le réglement des Joutes.",
       [
           (jump_to_menu, "mnu_reglement_joutes_entree"),   
        ]),
      ...
      ("cat1", [], "Groupe A : Joute a la lance et a cheval.",
       [
       #  (call_script, "script_fill_tournament_participants_troop_modif"),#  nouvelle metode        
        (call_script, "script_cf_tirage_jouteurs"),#### lancement de script test ici ANCIEN
        #          (call_script, "script_get_random_tournament_participant"),
            #      (music_set_situation, 0),
 (play_sound, "snd_trompette_tournois"),
           (jump_to_menu, "mnu_town_tournament_joutes"),  #copier tout type joutes 
      ...
      ("cat2", [], "Groupe B :Joute a pied et a l'épée.",
       [
       ...
       #  (call_script, "script_fill_tournament_participants_troop_modif"),#  nouvelle metode        
        ...
        #          (call_script, "script_get_random_tournament_participant"),
            #      (music_set_situation, 0),
 (play_sound, "snd_trompette_tournois"),
           (jump_to_menu, "mnu_town_tournament_joutes_a_pieds"),  #copier tout type joutes
           
        ]),
        

      ("continue4", [], "Se retirer du Tournoi.",
       [
           (jump_to_menu, "mnu_tournament_withdraw_verify_a_cheval"),# mettre en place se retirer
        ]),
    ]
  ),
  ...
  (
    "town_tournament",mnf_disable_all_keys,#entree GM 2
    ...
    [
       ...
       ("tournament_reglement", [], "Lire le réglement des Joutes.",
       [(jump_to_menu, "mnu_reglement_joutes"),   
        ]),
...
#           (try_end),
  ...
  (
    "town_tournament_joutes",mnf_disable_all_keys,#entree GM 2
    "{s29}",
    "none",
    [
...
#
       ...
       # (assign, ":num_participants", reg0),
#>>>>>>>>>>>>>>
         # (call_script, "script_get_random_tournament_participant_modif"),#nouvelle metode
#<<<<<<<<<<<<<<

        #(call_script, "script_add_jouteurs_tours"),#temporaire
##########>>>>>>> store string ici >>>>>>>>>
(str_clear, s1),
...
(eq, "$tour7", 0),
(eq, "$tour8", 0),
        (str_store_troop_name, s30, "trp_player"),
        (str_store_troop_name, s31, "$jouteur_8"),

        
     (str_store_string, s29, "@Vous êtes au tour 1 du tournoi dans le groupe A. Il reste 16 participants encore en lice.^Prochain combat:^Groupe A: {s30} contre {s31}."),
 #       (assign, ":troop_no", "$jouteur_1"),
(else_try),
...
(eq, "$tour8", 0),
        (str_store_troop_name, s30, "trp_player"),
        (str_store_troop_name, s31, "$jouteur_7"),

        
     (str_store_string, s29, "@Vous êtes au tour 2 du tournoi et vous restez invaincu dans le groupe A. Il reste 14 participants encore en lice.^Prochain combat:^Groupe A: {s30} contre {s31}."),
#  (assign, ":troop_no", "$jouteur_2"),
(else_try),
...
(eq, "$tour8", 0),
        (str_store_troop_name, s30, "trp_player"),
        (str_store_troop_name, s31, "$jouteur_6"),
          
    (str_store_string, s29, "@Vous êtes au tour 3 du tournoi et vous restez invaincu dans le groupe A. Il reste 12 participants encore en lice.^Prochain combat:^Groupe A: {s30} contre {s31}."),
#  (assign, ":troop_no", "$jouteur_3"),
(else_try),
(eq, "$tour4", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour8", 0),
        ...
        (str_store_troop_name, s30, "trp_player"),
        (str_store_troop_name, s31, "$jouteur_5"),
        
    (str_store_string, s29, "@Vous êtes au tour 4 du tournoi et vous restez invaincu dans le groupe A. Il reste 10 participants encore en lice.^Prochain combat:^Groupe A: {s30} contre {s31}."),
#  (assign, ":troop_no", "$jouteur_4"),
(else_try),
(eq, "$tour5", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour8", 0),
        ...
        (str_store_troop_name, s30, "trp_player"),
        (str_store_troop_name, s31, "$jouteur_4"),
        
    (str_store_string, s29, "@Vous êtes au tour 5 du tournoi et vous restez invaincu dans le groupe A. Il reste 8 participants encore en lice.^Prochain combat:^Groupe A: {s30} contre {s31}."),
 # (assign, ":troop_no", "$jouteur_5"),
(else_try),
(eq, "$tour6", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour8", 0),
        ...
        (str_store_troop_name, s30, "trp_player"),
        (str_store_troop_name, s31, "$jouteur_3"),

        
    (str_store_string, s29, "@Vous êtes au tour 6 du tournoi et vous restez invaincu dans le groupe A. Il reste 6 participants encore en lice.^Prochain combat:^Groupe A: {s30} contre {s31}."),
 # (assign, ":troop_no", "$jouteur_6"),
(else_try),
(eq, "$tour7", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
#(ge, "$tour9", 1),
        ...
        (str_store_troop_name, s30, "trp_player"),
        (str_store_troop_name, s31, "$jouteur_2"),

        
    (str_store_string, s29, "@Vous êtes au tour 7 du tournoi et vous restez invaincu dans le groupe A. Il reste 4 participants encore en lice.^Prochain combat:^Groupe A: {s30} contre {s31}."),
 # (assign, ":troop_no", "$jouteur_7"),
(else_try),
(eq, "$tour8", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour3", 0),
        ...
        (str_store_troop_name, s30, "trp_player"),
        (str_store_troop_name, s31, "$jouteur_1"),

        
    (str_store_string, s29, "@Vous êtes en finale du tournoi et vous restez invaincu dans le groupe A. Il ne reste que 2 participants encore en lice.^Prochain combat:^Groupe A: {s30} contre {s31}."),
 # (assign, ":troop_no", "$jouteur_8"),
(try_end),
    ...
    [
       ...
       ("tournament_reglement", [], "Lire le réglement des Joutes.",
       [(jump_to_menu, "mnu_reglement_joutes_cheval"),  
        ]),

             
      ("tournament_view_participants", [], "View participants.",
       [(jump_to_menu, "mnu_tournament_participants_cheval"),
        ]),
      


      ("tournament_join_next_fight_cheval",
       [
           ], "Rejoindre la piste.",
       [
...
(assign, "$message_pas_repete_joutes", 0),# mettre en place version vrais joutes et ceci est reserv?pour la version joutes a cheval
(assign, "$horse_joustes_dead", 0),# mettre en place version vrais joutes et ceci est reserv?pour la version joutes a cheval
           (party_get_slot, ":arena_scene", "$current_town", slot_town_arena),
           (modify_visitors_at_site, ":arena_scene"),
           (reset_visitors),

 #(call_script, "script_tirage_jouteurs"),   #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< ! aranger le script ou system a envoie de script pour que j'ai les seigneurs 1,2 ...a 8 de la meilleure facon possible, et si possible pas deux fois le meme...       
...
#(ge, "$tour9", 1),           
             ...
             (set_visitor, 61, "$jouteur_8"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
...
(eq, "$tour8", 0),           
             (set_visitor, 60, "trp_player"),#                
             (set_visitor, 61, "$jouteur_7"),# mettre en script :troop_no pour le concurent de ce tour...
...
(eq, "$tour8", 0),
             ...
             (set_visitor, 60, "trp_player"),#                
             (set_visitor, 61, "$jouteur_6"),# mettre en script :troop_no pour le concurent de ce tour...
...
(eq, "$tour8", 0),
             (set_visitor, 60, "trp_player"),#                
             (set_visitor, 61, "$jouteur_5"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
(eq, "$tour5", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour8", 0),
             (set_visitor, 60, "trp_player"),#                
             (set_visitor, 61, "$jouteur_4"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
(eq, "$tour6", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour8", 0),
             (set_visitor, 60, "trp_player"),#                
             (set_visitor, 61, "$jouteur_3"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
(eq, "$tour7", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
#(ge, "$tour9", 1),           
             (set_visitor, 60, "trp_player"),#                
             (set_visitor, 61, "$jouteur_2"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
(eq, "$tour8", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour3", 0),
             (set_visitor, 60, "trp_player"),#                
             (set_visitor, 61, "$jouteur_1"),# mettre en script :troop_no pour le concurent de ce tour...
(try_end),
...
(try_begin),
#(eq, ":town_original_faction", "fac_player_supporters_faction"),
(eq, "$g_encountered_party_faction", "fac_player_supporters_faction"),
#(display_message, "@player suporter faction"),
      #  (mission_tpl_entry_clear_override_items, "mt_joutes", 61),
       #   (mission_tpl_entry_add_override_item, "mt_joutes", 61, "itm_newlance_joutes_enemi", "itm_new_steel_greaves", "itm_new_joutes_horse_fr", "itm_plate_mittens","itm_new_bb_complet_plates_charles", "itm_new_helmet_tournament_blue_1"), 
(set_jump_mission, "mt_joutes"),
(else_try),

#(eq, ":town_original_faction", "fac_player_faction"),
(eq, "$g_encountered_party_faction", "fac_player_faction"),
#(display_message, "@player faction"),
      #  (mission_tpl_entry_clear_override_items, "mt_joutes", 61),
      #    (mission_tpl_entry_add_override_item, "mt_joutes", 61, "itm_newlance_joutes_enemi", "itm_new_steel_greaves", "itm_new_joutes_horse_fr", "itm_plate_mittens","itm_new_bb_complet_plates_charles", "itm_new_helmet_tournament_blue_1"), 
(set_jump_mission, "mt_joutes"),
(else_try),
...
(eq, "$g_encountered_party_faction", "fac_kingdom_2"),
#(display_message, "@engleterre"),
      #  (mission_tpl_entry_clear_override_items, "mt_joutes", 61),
       #   (mission_tpl_entry_add_override_item, "mt_joutes", 61, "itm_newlance_joutes_enemi","itm_new_steel_greaves","itm_new_joutes_horse_red","itm_new_wisby_gauntlets_red","itm_new_helmet_tournament_red_1","itm_new_bb_complet_plates_r","itm_new_helmet_tournament_red_1"), 
(set_jump_mission, "mt_joutes_eng"),
(else_try),
#(eq, ":town_original_faction", "fac_kingdom_3"),
(eq, "$g_encountered_party_faction", "fac_kingdom_3"),
#(display_message, "@bourgogne"),
      #  (mission_tpl_entry_clear_override_items, "mt_joutes", 61),
      #    (mission_tpl_entry_add_override_item, "mt_joutes", 61, "itm_newlance_joutes_enemi","itm_new_steel_greaves","itm_new_bourgogne_warhorse","itm_plate_mittens","itm_new_bb_complet_plates_bourg","itm_new_bb_hounskull_yp"),
(set_jump_mission, "mt_joutes_brg"),
(else_try),
#(eq, ":town_original_faction", "fac_kingdom_4"),
(eq, "$g_encountered_party_faction", "fac_kingdom_4"),
#(display_message, "@bretagne"),
     #   (mission_tpl_entry_clear_override_items, "mt_joutes", 61),
      #    (mission_tpl_entry_add_override_item, "mt_joutes", 61, "itm_newlance_joutes_enemi","itm_new_steel_greaves","itm_new_breton_warhorse_2","itm_hourglass_gauntlets","itm_new_breton_complet_plates","itm_new_bb_greathelm_bp"),
(set_jump_mission, "mt_joutes_bret"),
(try_end),

         #(mission_tpl_entry_set_override_flags, "mt_joutes", 61, af_override_all),
...
#(else_try),
#(eq, ":town_original_faction", "fac_kingdom_2"),#
#           (set_jump_mission, "mt_joutes_angleterre"), 
#(else_try),
#(eq, ":town_original_faction", "fac_kingdom_3"),#
#           (set_jump_mission, "mt_joutes_bourgogne"), 
#(else_try),
#(eq, ":town_original_faction", "fac_kingdom_4"),#
#           (set_jump_mission, "mt_joutes_bretagne"), 
#(else_try),
      #     (set_jump_mission, "mt_joutes"),
#(try_end),
      ...
      ("leave_tournament",[],"Quitter le Tournoi.",
       [
           (jump_to_menu, "mnu_tournament_withdraw_verify_a_cheval_joute"),
        ]),
    ]
  ),
  ...
  (
    "town_tournament_joutes_a_pieds",mnf_disable_all_keys,#entree GM 2
    "{s29}",
    "none",
    [
...
(eq, "$tour8", 0),
     ...
     (str_store_string, s29, "@Vous êtes au tour 1 du tournoi dans le groupe B. Il reste 16 participants encore en lice.^Prochain combat:^Groupe B: {s30} contre {s31}."),
 #       (assign, ":troop_no", "$jouteur_1"),
(else_try),
...
(eq, "$tour8", 0),
     ...
     (str_store_string, s29, "@Vous êtes au tour 2 du tournoi et vous restez invaincu dans le groupe B. Il reste 14 participants encore en lice.^Prochain combat:^Groupe B: {s30} contre {s31}."),
#  (assign, ":troop_no", "$jouteur_2"),
(else_try),
...
(eq, "$tour8", 0),
    ...
    (str_store_string, s29, "@Vous êtes au tour 3 du tournoi et vous restez invaincu dans le groupe B. Il reste 12 participants encore en lice.^Prochain combat:^Groupe B: {s30} contre {s31}."),
#  (assign, ":troop_no", "$jouteur_3"),
(else_try),
(eq, "$tour4", 1),
(eq, "$tour1", 0),
...
(eq, "$tour8", 0),
    ...
    (str_store_string, s29, "@Vous êtes au tour 4 du tournoi et vous restez invaincu dans le groupe B. Il reste 10 participants encore en lice.^Prochain combat:^Groupe B: {s30} contre {s31}."),
#  (assign, ":troop_no", "$jouteur_4"),
(else_try),
(eq, "$tour5", 1),
(eq, "$tour1", 0),
...
(eq, "$tour8", 0),
    ...
    (str_store_string, s29, "@Vous êtes au tour 5 du tournoi et vous restez invaincu dans le groupe B. Il reste 8 participants encore en lice.^Prochain combat:^Groupe B: {s30} contre {s31}."),
 # (assign, ":troop_no", "$jouteur_5"),
(else_try),
(eq, "$tour6", 1),
(eq, "$tour1", 0),
...
(eq, "$tour8", 0),
    ...
    (str_store_string, s29, "@Vous êtes au tour 6 du tournoi et vous restez invaincu dans le groupe B. Il reste 6 participants encore en lice.^Prochain combat:^Groupe B: {s30} contre {s31}."),
 # (assign, ":troop_no", "$jouteur_6"),
(else_try),
(eq, "$tour7", 1),
(eq, "$tour1", 0),
...
#(ge, "$tour9", 1),
    ...
    (str_store_string, s29, "@Vous êtes au tour 7 du tournoi et vous restez invaincu dans le groupe B. Il reste 4 participants encore en lice.^Prochain combat:^Groupe B: {s30} contre {s31}."),
 # (assign, ":troop_no", "$jouteur_7"),
(else_try),
(eq, "$tour8", 1),
(eq, "$tour1", 0),
...
(eq, "$tour3", 0),
    ...
    (str_store_string, s29, "@Vous êtes en finale du tournoi et vous restez invaincu dans le groupe B. Il ne reste que 2 participants encore en lice.^Prochain combat:^Groupe B: {s30} contre {s31}."),
 # (assign, ":troop_no", "$jouteur_8"),
(try_end),
   ...
   #    ("tournament_reglement", [], "Lire le réglement des Joutes.",
    #   [(jump_to_menu, "mnu_reglement_joutes_a_pied"),  
    #    ]),

             
      ("tournament_view_participants", [], "Voire la liste des participants.",
       [(jump_to_menu, "mnu_tournament_participants_a_pied"),
        ]),
      


      ("tournament_join_next_fight_a_pied",
       [
           ], "Rejoindre la piste.",
       [
...
(eq, "$tour7", 0),
(eq, "$tour8", 0),           
             (set_visitor, 65, "trp_player"),#                
             (set_visitor, 66, "$jouteur_8"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
...
(eq, "$tour8", 0),           
             (set_visitor, 65, "trp_player"),#                
             (set_visitor, 66, "$jouteur_7"),# mettre en script :troop_no pour le concurent de ce tour...
...
(eq, "$tour8", 0),
             ...
             (set_visitor, 65, "trp_player"),#                
             (set_visitor, 66, "$jouteur_6"),# mettre en script :troop_no pour le concurent de ce tour...
...
(eq, "$tour8", 0),
             (set_visitor, 65, "trp_player"),#                
             (set_visitor, 66, "$jouteur_5"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
(eq, "$tour5", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour8", 0),
             (set_visitor, 65, "trp_player"),#                
             (set_visitor, 66, "$jouteur_4"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
(eq, "$tour6", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour8", 0),
             (set_visitor, 65, "trp_player"),#                
             (set_visitor, 66, "$jouteur_3"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
(eq, "$tour7", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour8", 0),          
             (set_visitor, 65, "trp_player"),#                
             (set_visitor, 66, "$jouteur_2"),# mettre en script :troop_no pour le concurent de ce tour...
(else_try),
(eq, "$tour8", 1),
(eq, "$tour1", 0),
(eq, "$tour2", 0),
...
(eq, "$tour3", 0),
             (set_visitor, 65, "trp_player"),#                
             (set_visitor, 66, "$jouteur_1"),# mettre en script :troop_no pour le concurent de ce tour...
(try_end),
...
(set_jump_mission, "mt_joutes_a_pied"),
(else_try),
...
(set_jump_mission, "mt_joutes_a_pied_eng"),
(else_try),

(eq, "$g_encountered_party_faction", "fac_kingdom_3"),

(set_jump_mission, "mt_joutes_a_pied_brg"),
(else_try),

(eq, "$g_encountered_party_faction", "fac_kingdom_4"),

(set_jump_mission, "mt_joutes_a_pied_bret"),
(try_end),
      ...
      ("leave_tournament",[],"Quitter le Tournoi.",
       [
           (jump_to_menu, "mnu_tournament_withdraw_verify_a_cheval_a_pied"),
        ]),
    ]
  ),
  ...
  (
    "tournament_participants_a_pied",0,#entree GM 6 
    "Liste des jouteurs encore en lice:^{s32}",
    "none",
    [
        (str_clear, s32),
...
#(ge, "$tour9", 1),            
  (str_store_troop_name, s33, "trp_player"),      
     (str_store_troop_name, s34, "$jouteur_1"),
     (str_store_troop_name, s36, "$jouteur_2"),        
     (str_store_troop_name, s37, "$jouteur_3"),        
     (str_store_troop_name, s39, "$jouteur_4"),        
     (str_store_troop_name, s40, "$jouteur_5"),        
     (str_store_troop_name, s41, "$jouteur_6"),        
     (str_store_troop_name, s43, "$jouteur_7"),        
     (str_store_troop_name, s44, "$jouteur_8"),       
     (str_store_troop_name, s45, "$jouteur_9"),        
     (str_store_troop_name, s46, "$jouteur_10"),        
     (str_store_troop_name, s47, "$jouteur_11"),        
     (str_store_troop_name, s48, "$jouteur_12"),        
     (str_store_troop_name, s49, "$jouteur_13"),        
     (str_store_troop_name, s50, "$jouteur_14"),        
     (str_store_troop_name, s51, "$jouteur_15"),        
       
             (str_store_string, s32, "@{!}{s33}^{s34}^{s36}^{s37}^{s39}^{s40}^{s41}^{s43}^{s44}^{s45}^{s46}^{s47}^{s48}^{s49}^{s50}^{s51}"),     
...
(eq, "$tour8", 0),           
  (str_store_troop_name, s33, "trp_player"),      
    ...
    # (str_store_troop_name, s51, "$jouteur_15"),        
             ...
             (str_store_string, s32, "@{!}{s33}^{s34}^{s36}^{s37}^{s39}^{s40}^{s41}^{s43}^{s44}^{s45}^{s46}^{s47}^{s48}^{s49}"),     
...
(eq, "$tour8", 0),
  ...
  #   (str_store_troop_name, s51, "$jouteur_15"),        
             ...
             (str_store_string, s32, "@{!}{s33}^{s34}^{s36}^{s37}^{s39}^{s40}^{s41}^{s43}^{s44}^{s45}^{s46}^{s47}"),     
...
(eq, "$tour8", 0),
  ...
  #   (str_store_troop_name, s51, "$jouteur_15"),        
             ...
             (str_store_string, s32, "@{!}{s33}^{s34}^{s36}^{s37}^{s39}^{s40}^{s41}^{s43}^{s44}^{s45}"),     
...
(eq, "$tour8", 0),
  ...
  #   (str_store_troop_name, s51, "$jouteur_15"),        
             ...
             (str_store_string, s32, "@{!}{s33}^{s34}^{s36}^{s37}^{s39}^{s40}^{s41}^{s43}"),     
...
#     (str_store_troop_name, s48, "$jouteur_12"),        
 ...
 #   (str_store_troop_name, s51, "$jouteur_15"),        
             ...
             (str_store_string, s32, "@{!}{s33}^{s34}^{s36}^{s37}^{s39}^{s40}"),     
...
#(ge, "$tour9", 1),           
  ...
  #   (str_store_troop_name, s51, "$jouteur_15"),        
             ...
             (str_store_string, s32, "@{!}{s33}^{s34}^{s36}^{s37}"),     
...
#          (str_store_troop_name, s33, ":troop_no"),
#(str_store_string, s11, "@{!}{s11}^{s33}^{s34}^{s36}^{s37}^{s39}^{s40}^{s41}^{s43}^{s44}^{s45}^{s46}^{s47}^{s48}^{s49}^{s50}^{s51}"),
        
        ],
    [
      ("go_back_dot_apied", [], "Revenir au tournoi.",
       [(jump_to_menu, "mnu_town_tournament_joutes_a_pieds"),
        ]),
    ]
  ),
...
###tournament_join_next_fight ORIGINAL decomenter pour revenir a une version native modifi? #############################
...
##           (jump_to_scene, ":arena_scene"),
 #          (change_screen_mission),
#        ]),
#      ("leave_tournament",[],"Quitter le Tournois.",
#       [
#           (jump_to_menu, "mnu_tournament_withdraw_verify_a_cheval"),
#        ]),
#    ]
#  ),
  ...
  (
    "tournament_withdraw_verify",0, #entree GM 8
  ...
  (
    "tournament_withdraw_verify_a_cheval_a_pied",0, #entree GM 8
    "Etes vous sur de vouloir quitter le Tournoi ?",
    "none",
    [],
    [
      ("tournament_withdraw_yes", [], "Oui, je n'ai aucune chance.",
       [(jump_to_menu, "mnu_town_tournament_autre_vainqueur"),
        ]),
      ("tournament_withdraw_no", [], "Non, .",
       [(jump_to_menu, "mnu_town_tournament_joutes_a_pieds"),
        ]),
    ]
  ),
  ...
  (
    "tournament_withdraw_verify_a_cheval",0, #entree GM 8
    "Etes vous sur de vouloir quitter le Tournoi ?",
    "none",
    [],
    [
      ...
      ("tournament_withdraw_no", [], "Non, plus vaut le courrage que la force je l'emporterais.",
       [(jump_to_menu, "mnu_town_tournament_choice"),
        ]),
    ]
  ),
  ...
  (
    "tournament_withdraw_verify_a_cheval_joute",0, #entree GM 8
    "Etes vous sur de vouloir quitter le Tournoi ?",
    "none",
    [],
    [
  ...
  (
    "reglement_joutes_entree",0,#
    "Réglement des joutes.^^Le Jouteur devra commencer par choisir une catégorie: joutes a la lance et a cheval ou joute a pied et a l'épée.^^    Réglement des joutes a cheval.^     Les deux jouteurs se faisant face dans leur couloir devrons renverser leur adversaire en le frappant de sa lance.^     Les jouteurs ne devrons point blésser le cheval du concurrent sous peine d'estre disqualifié.^     Si personne ne chute, la joute sera déclarée nule.^     Le Jouteur est contraint de s'en tenire aux régles courtoises de la Chevalerie et de la noble Jouste.^^La somme en écus du grand prix revenant au vainqueur est défini par le Seigneur organisateur, il lui sera aussi remis un trophé de valeur.",
    "none",
    [

        ],
    [
      ("go_back_dot", [], "Revenire a l'entrée du Tournoi.",
       [(jump_to_menu, "mnu_town_tournament_choice"),
        ]),
    ]
  ),
 ...
 #    "If you bet {reg1} denars, you will earn {reg2} denars if you win the tournament. Is that all right?",
  ...
  (
    "tournament_participants",0,#entree GM 6
  ...
  (
    "tournament_participants_cheval",0,#entree GM 6 
    "Liste des jouteurs encore en lice:^{s32}",
    "none",
    [
        (str_clear, s32),
...
#(str_store_string, s11, "@{!}{s11}^{s33}^{s34}^{s36}^{s37}^{s39}^{s40}^{s41}^{s43}^{s44}^{s45}^{s46}^{s47}^{s48}^{s49}^{s50}^{s51}"),
    ...
    [
      ("go_back_dot", [], "Revenir au tournoi.",
       [(jump_to_menu, "mnu_town_tournament_joutes"),
        ]),
    ]
  ),
...
#1429
    ...
    # (ge, ":player_gold", 100),  
      ...
      "Demander au Maîstre d'armes d'entrainer vos soldats.",
      [
...
#      (else_try),
  ...
  (
    ...
    [
      ...
      ("continue_2",[],"Tell the woman to inform her mistress that you will come shortly",
       [
      ...
      ("continue_3",[],"Tell the woman to inform her mistress that you are indisposed",
       [
...
#HYW
  ...
  ("start_phase_2_5",mnf_disable_all_keys,
    ...
    [
      ("continue",[], "Continue...",
       [
		 (jump_to_menu, "mnu_start_phase_finale"),
       ]),
    ]
  ),
...
##1429 menu ribaudes
       ( "courtesan_accept",mnf_scale_picture,
          "Vous suivez la jeune femme jusqu'a l'auberge. une fois dans la chambre elle se deshabille et vous fait passer du bon temps,vous vous sentez en pleine forme quand c'est fini.",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_sexy_1"),
          (music_set_situation, 0),      
          (play_sound, "snd_sex_1a"),          
         ],
         [
           ("continue",[],"Partir...",             
            [
...
##
       ( "courtesan_accept_2",mnf_scale_picture,
          "Vous suivez la fille jusqu'a un recoin sombre,elle laisse tomber sa robe a ses pieds,et vous passez un bon moment,vous vous sentez en pleine forme quand c'est fini.",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_sexy_2"),
          (music_set_situation, 0),      
          (play_sound, "snd_sex_2a"),          
         ],
         [
           ("continue",[],"Partir...",             
            [
...
#
       ( "courtesan_accept_3",mnf_scale_picture,
          "Vous accompagnez la jeune femme jusqu'a l'ecurie. une fois a l'interieure elle retire ses vetements,vous restez tous les deux un bon moment,vous sentez en pleine forme quand c'est fini.",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_sexy_3"),
          (music_set_situation, 0),      
          (play_sound, "snd_sex_3a"),          
         ],
         [
           ("continue",[],"Partir...",             
            [
...
#tavernes
       ...
       ( "courtesan_accept5",mnf_scale_picture,
          "Vous suivez la jeune fille jusqu'a la chambre de la taverne. elle semble effectivement douée pour detendre certains de vos muscles, vous vous sentez en pleine forme quand c'est fini.",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_sexy_4"),
          (music_set_situation, 0),      
          (play_sound, "snd_sex_1a"),          
         ],
         [
...
#1429E      
  ...
  ("pugilat",0,#copier ce bloc 4 fois pour les quatres scenes
    "Vous vous appretez a descendre dans les caves de la taverne, qu'allez vous faire ?",
    "none",
    [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
        (eq, "$current_town", "p_town_1"),        
    ...
    [
      ("entrer.",[
       ...
       [       
        (modify_visitors_at_site,"scn_pugilat_4"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_parieur_1"),
             (set_visitor, 3, "trp_spectapugilat_1"),
             (set_visitor, 4, "trp_spectapugilat_2"),
             (set_visitor, 5, "trp_spectapugilat_3"),
             (set_visitor, 6, "trp_combatant_pugilat"),               
        (set_jump_mission,"mt_pugilatt"),
...
#2
  ("pugilat",0,#copier ce bloc 4 fois pour les quatres scenes
    ...
    [
      ("entrer.",[
        # (eq, "$entreeatoul", 0),# assigner condition a MT
          ], "avancer.",
       [       
        (modify_visitors_at_site,"scn_pugilat_1"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_parieur_12"),
             (set_visitor, 3, "trp_spectapugilat_12"),
             (set_visitor, 4, "trp_spectapugilat_22"),
             (set_visitor, 5, "trp_spectapugilat_32"),
             (set_visitor, 6, "trp_combatant_pugilat2"),                
        (set_jump_mission,"mt_pugilatt"),
        (mission_tpl_entry_set_override_flags, "mt_pugilatt", 1, af_override_all), 
       # (mission_tpl_entry_clear_override_items, "mt_pugilatt", 1),
       # (mission_tpl_entry_add_override_item, "mt_pugilatt", 1, "itm_staff"),#items suplementaires baton
  ...
  ("pugilat",0,#copier ce bloc 4 fois pour les quatres scenes
    ...
    [
      ("entrer.",[
       ...
       [       
        (modify_visitors_at_site,"scn_pugilat_2"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_parieur_13"),
             (set_visitor, 3, "trp_spectapugilat_13"),
             (set_visitor, 4, "trp_spectapugilat_23"),
             (set_visitor, 5, "trp_spectapugilat_33"),
             (set_visitor, 6, "trp_combatant_pugilat3"),               
        (set_jump_mission,"mt_pugilatt"),
        (mission_tpl_entry_set_override_flags, "mt_pugilatt", 1, af_override_all), 
       # (mission_tpl_entry_clear_override_items, "mt_pugilatt", 1),
       # (mission_tpl_entry_add_override_item, "mt_pugilatt", 1, "itm_staff"),#items suplementaires baton
  ...
  ("pugilat",0,#copier ce bloc 4 fois pour les quatres scenes
    ...
    [
      ("entrer.",[
       ...
       [       
        (modify_visitors_at_site,"scn_pugilat_3"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_parieur_14"),
             (set_visitor, 3, "trp_spectapugilat_14"),
             (set_visitor, 4, "trp_spectapugilat_24"),
             (set_visitor, 5, "trp_spectapugilat_34"),
             (set_visitor, 6, "trp_combatant_pugilat4"),               
        (set_jump_mission,"mt_pugilatt"),
        (mission_tpl_entry_set_override_flags, "mt_pugilatt", 1, af_override_all), 
       # (mission_tpl_entry_clear_override_items, "mt_pugilatt", 1),
       # (mission_tpl_entry_add_override_item, "mt_pugilatt", 1, "itm_staff"),#items suplementaires baton
...
######## pugilat end 
       ( "training_horseparis",mnf_scale_picture,
          "vous passez un long moment a essayer de comprendre l'art de l'equitation de combat,vous decouvrez des astuces que vous ne soupssoniez pas auparavent,vous repartez avec un douleure aigue au bas du dos, mais plus habile avec les montures plus exigeantes.",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_trainig_equit"),
          (music_set_situation, 0),      
          (play_sound, "snd_traing_equitation1"),
         (call_script, "script_training_equitation"),                    
         ],
         [
           ("continue",[],"Partir...",             
            [
...
##
       ( "generic_soins",mnf_scale_picture,
          "Vous vous allongez et essayez de vous detendre pendant que le pretre soigne vos bléssures,vous finissez par vous endormir dans le calme de l'abbaye,vous vous reveillez peut de temp apres disponible et en pleine forme.",
          "none",         
         [                          
          (set_background_mesh, "mesh_pic_soins"),
          (music_set_situation, 0),      
          (play_sound, "snd_soin1"),
         (call_script, "script_soins"),                    
         ],
         [
           ("continue",[],"Partir...",             
            [
...
##
       ( "generic_soins_low",mnf_scale_picture,
          "Vous vous maintenez fermement a la table d'operation,pendant que le moine vous recous,heureusement il ne met pas longtemp avant de s'apercevoir qu'il recousais une vielle cicatrice,vous repartez avec la desagreable senssation d'aller encore plus mal qu'avant.",
          "none",         
         [                          
          (set_background_mesh, "mesh_pic_soins"),
          (music_set_situation, 0),      
          (play_sound, "snd_soin2"),
         (call_script, "script_soins2"),                    
         ],
         [
           ("continue",[],"Partir...",             
            [
...
##
       ( "generic_benire",mnf_scale_picture,
          "Vous rassemblez vos hommes et les faites se mettre en rang,tandis que le pretre passe devans chacun d'eux en recitant ses prieres vous sentez la ferveur monter en eux,la fureur se lis dans leurs yeux et ils sont plus determines que jamais a livrer bataille...",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_benire"),
          (music_set_situation, 0),      
          (play_sound, "snd_benir1"),
         (call_script, "script_benir"),                    
         ],
         [
           ("continue",[],"Partir...",             
            [
...
##
       ( "generic_benire_high",mnf_scale_picture,
          "Vous rassemblez vos hommes et les faites se mettre en rang,tandis que le pretre passe devans chacun d'eux en recitant ses prieres vous sentez la ferveur monter en eux,la fureur se lis dans leurs yeux et ils sont plus determines que jamais a livrer bataille...",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_benire"),
...
##
       ( "training_ingenieur",mnf_scale_picture,
          "Vous ecoutez attentivement les ensseignements du maitre ingenieur,il vous explique qu'il faut entre autre prendre en compte l'humidite ambiante avant de se servire d'arme a ressort a cordes.",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_trainig_generique"),
          (music_set_situation, 0),      
          (play_sound, "snd_training1"),
         (call_script, "script_trainig_ingenieur1"),                    
         ],
         [
           ("continue",[],"Partir...",             
            [
...
##
       ( "training_arme_deux_mains",mnf_scale_picture,
          "Le maitre d'arme vous aprend toutes les astuces et ruses qu'il conais,vous aprenez a vous servire du poid de l'arme d'une autre facon,afin d'avoir toujours l'avantage sur le champ de bataille.",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_trainig_generique"),
          (music_set_situation, 0),      
          (play_sound, "snd_training1"),
         (call_script, "script_trainig_deuxmain_1"),                    
         ],
         [
           ("continue",[],"Partir...",             
            [
...
##
       ( "training_arme_une_mains",mnf_scale_picture,
          "Le maitre d'arme vous aprend toutes les astuces et ruses qu'il conais,vous aprenez a coordonner vos deux bras de facon a toujours avoir l'avantage sur le champ de bataille.",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_trainig_generique"),
          (music_set_situation, 0),      
          (play_sound, "snd_training1"),
         (call_script, "script_trainig_unemain_1"),                    
         ],
         [
           ("continue",[],"Partir...",             
            [
  ...
  ("banner_choix_generique",0,
   ...
   [
    ...
    [
      ...
      ("banner_choix_1",[],"Choisir une nouvelle banniere.",
       [
           (start_presentation, "prsnt_banner_selection"),
        ]
       ),
...
##premiere scene saut musicfleuve
  ("start_phase_finale",mnf_disable_all_keys,
    "{s16}^^Vous vous reveillez tres tot dans votre campement l'activité sur le port a proximité vous a tiré de votre someil,vous comptez dans vostre boursse les quelques réserves d'argent que vous avez put dissimuller aux bandits et vous n'avez pratiquement plus de vivres,vous devez a present les gerer au mieux afin de vous equiper et payer une place sur le navire pour achever vostre voyage...",
    "none",
    [      
      (assign, ":continue", 1),

      (try_begin),#test
        (eq, "$current_startup_quest_phase", 1),#test
        (try_end),     #test
    ...
    [
      ("continue",[], "Continue...",
       [         
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$talk_to_rebel", 0),
         (assign, "$paye_place_bateau", 0),         
         (call_script, "script_player_arrived"),
         (party_set_morale, "p_main_party", 100),
         (set_encountered_party, "$current_town"),
         (call_script, "script_premiere_scene"),
         (music_set_situation, 0),
         (play_sound,"snd_music_fleuve"),
       ]),
    ]
  ),

##deuxieme scene saut pirates atack

    ("start_phase_pirates",mnf_disable_all_keys,
    "{s16}^^Vous êtes partis pour une longue expedition sur le fleuve,vous vous apprêtez a vous endormire sur le pont du bateau,quand une fléche en flames viens se ficher sur le mat principale.les pirates du fleuve vous attaquent! defendez vous pour sauver vostre vie!",
    "none",[],
    [
      ("continue",[], "Continuer...",
       [
         (call_script, "script_pirates_scene"),
         (play_sound, "snd_chrono_cry_pirates"),
       ]),
    ]
  ),
...
#pirates VICTOIRE
    ...
    ("start_pirates_victoire",mnf_disable_all_keys,
    "{s16}^^Vous êtes venu a bout des pirates du fleuve,vous jettez les cadavres par dessus bord et reprenez le voyage apres avoir eteint les flames.",
    "none",[],
    [
      ("continue",[(call_script, "script_change_troop_renown", "trp_player", 2),], "Continuer...",
       [


     #rajouter enlever objets avec condition les avoire pour chaques!!!!!!!!!!!!!
     #rajouter enlever or a condition d'avoir plusieurs paliers de sommes d'or !!!!!!!!           
        (assign, "$current_town", "p_town_6"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_praven"),
    ...
    [
      ...
      (str_clear, s16),
         ...
         (set_encountered_party, "$current_town"),
          ...
          (assign, "$current_startup_quest_phase", 2),
          (party_set_morale, "p_main_party", 50),#laisser?
...
##chateau ducale passage        
  
      ("town_Caen_castle_scene",0,
    "Vous entrez pour rejoindre le banquet,vous vous mellez a la reception et aux invités en scrutant rapidement le moindre recoin a la recherche d'un plan d'action.",
    "none",
   [
     ],
    [
      ...
      ("caen_choix_1",[],"Entrer.",
       [
#REMOVE item lettre d'invitation!!!           
         (call_script, "script_chateau_duc_caen"),
        ]
       ),
...
##chateau ducale armement           
  
      ("choose_armes_caen",0,
    "Quel type d'arme allez vous choisir ?.",
    "none",
   [
     ],
    [
      ...
      ("caens_choix_1",[],"Une arbaléte,je préfére tuer le comte a distance!.",
       [
         (assign, "$arme_caen_ok", 1),
         (call_script, "script_chateau_duc_caen_arbalete"),
        ]
       ),


      ("caens_choix_2",[],"Une épée,pour etre sur que je ne manquerais pas ma cible!",
       [
         (assign, "$arme_caen_ok", 1),
         (call_script, "script_chateau_duc_caen_epee"),
        ]
       ),
      ]
  ),

  # test gordaine instructeur epee FAILED
      ("gordaine_test_failed",0,
      "Vous avez échoué! retentez votre chance plus tard,apres un entrainement intessif...",
      "none",       
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_4"),		
...
# test gordaine instructeur epee WIN 
      ("gordaine_test_win",0,
      "Vous avez passé l'epreuve avec succes! retournez voire l'instructeur.",
      "none",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_4"),		
...
##########################################################################
  # test tour instructeur epee FAILED
      ("tourbatl_loose",0,
      "Vous etes battu!.",
      "none",       
      [
...
# test tour instructeur epee WIN 
      ("tourbatl_win",0,
      "Vous avez vaincu l'instructeur! certains voudrons certainement vous offrire une chope a la taverne du coin!",
      "none",
      [
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
         (eq, "$current_town", "p_town_16"),		
...
#aqaqaq
  ...
  # test lyon instructeur epee FAILED
      ("lyonbatl_loose",0,
      "Vous etes battu!.",
      "none",       
      [
...
# test lyon instructeur epee WIN 
      ("lyonbatl_win",0,
      "Vous avez vaincu l'instructeur! certains voudrons certainement vous offrire une chope a la taverne du coin!",
      "none",
      [
...
##vilandrandro repaire passage        
  
      ("repaire_vilandr",0,
    "Le guide déverouille la lourde porte pour vous laisser entrer dans le repaire de Villandrandro.qu'allez vous faire?",
    "none",
   [
    (set_background_mesh, "mesh_pic_catacombs"),       
     ],
    [
	

      ("catac_choix_1",[],"Aller au repert des brigands.",
       [         
         (call_script, "script_rencontre_rv"),
        ]
       ),


      ("catac_choix_2",[],"Aller a l'entrée.",
       [         
         (call_script, "script_start_enbas"),
        ]
       ),

      ("catac_choix_3",[],"Quitter les catacombes.",
       [
          #enlever torche
	(try_begin),           
...
###################catacombes cote ville / rebels
      ...
      ("cata_suiteparis",0,
    "Vous etes dans les Catacombes de Paris.Vous ne pourez pas en sortire sans trouver un chemin en passant par les portes... vers ou allez vous vous diriger ?",
    "none",
   [
    (set_background_mesh, "mesh_pic_catacombs"),       
     ],
    [
      ...
      ("catac_choix_1",[],"Aller a l'entrée.",
       [         
         (call_script, "script_entre_de_catap"),
        ]
       ),
      ...
      ("catac_choix_2",
       ...
       "Aller a la citerne.",
       [         
         (call_script, "script_repertrebcata"),
        ]
       ),
      ...
      ("catac_choix_2a",
       ...
       "Aller a la citerne.",
       [         
         (display_message, "@Le camp Rebelle a été demantelé, et le chemin de la Citerne es scellé.", 0x8B0000),#rouge
         ]
       ),
      
################################################# quete crypte des ducs begin
      ("catac_choix_3",
       [
#cond quete trouver bijoux ou arme ancetre PAS ACTIVE coffre vide
         (neg|check_quest_active, "qst_crypt_sworr"),          
           ],"Se rendre a la crypte des Ducs.",
       [         
         (call_script, "script_crypt_duc_vide"),
        ]
       ),
...
#########################
      ("catac_choix_4",
       [
#cond quete trouver bijoux ou arme ancetre ACTIVE!!! coffre avec item de quete
       ...
       [         
         (call_script, "script_crypt_duc_item"),
        ]
       ),

################################################# quete patrouille anglaise
      ("catac_choix_5",
       [
#que si quete rebel patrouille en bas, active !!!
         ...
         (neg|check_quest_finished, "qst_rebel_cataparang"),          
           ],"Attaquer le poste de patrouilles sous terrain Anglois.",
       [         
         (call_script, "script_attak_camp_angcata"),
        ]
       ),      
################################################## quete patrouille anglaise END    

      ("catac_choix_8",[],"Quitter les catacombes.",
       [
          #enlever torche
	(try_begin),           
         (this_or_next|player_has_item,"itm_torch"),
...
#####################type d'armes
        ...
        ("camp_craft_type",0,
    "Que voullez vous fabriquer? (si vous en possédez lez ressources et l'agilité requise)",
    "none",
    [],
...
#
    [
      ...
      ("camp_craftchoix_a1",[],
       "Une épée.",
       [
        (jump_to_menu, "mnu_craft_epee_type"),
        ]
       ),


      ("camp_craftchoix_a2",[],
       "Des carreaux ou des flèches.",
       [
        (jump_to_menu, "mnu_craft_fleches_type"),
        ]
       ),
      ...
      ("camp_craftchoix_a3",[],
       "Un bouclier.",
       [
        (jump_to_menu, "mnu_craft_bouclier_type"),
        ]
       ),
      ...
      ("camp_craftchoix_a5",[],
       "Une arme a distance.",
       [
        (jump_to_menu, "mnu_craft_arc_type"),
        ]
       ),
      ...
      ("camp_craftchoix_a6",[],
       "Une lance.",
       [
        (jump_to_menu, "mnu_craft_lance_type"),
        ]
       ),


      ("camp_craftchoix_a6g",[],
       "Une armure de plates simple.",
       [
        (jump_to_menu, "mnu_craft_armor_type"),
        ]
       ),
      ...
      ("camp_craftchoix_a7",[],
       "Une objet special.",
       [
        (jump_to_menu, "mnu_craft_special_type"),
        ]
       ),

#bouffe
      ("camp_craftchoix_a7b",[],
       "cuisiner pour la troupe.",
       [
        (jump_to_menu, "mnu_craft_food_type"),
        ]
       ),

#return
      ("camp_craftc_return",[],"retour...",
       [
         (jump_to_menu, "mnu_camp"),
        ]
       ),
...
#
      ("camp_craftchoix_3",
       ...
       "Une épée de chevalier hospitaller.",
       [
        (troop_remove_item, "trp_player", "itm_iron"),
        (troop_remove_item, "trp_player", "itm_bois"),
        (troop_remove_item, "trp_player", "itm_cuir"),
...
#
      ("camp_craftchoix_9",
       ...
       "Une épée a deux mains de Mercenaire.",
       [
        (troop_remove_item, "trp_player", "itm_iron"),
        (troop_remove_item, "trp_player", "itm_bois"),
        (troop_remove_item, "trp_player", "itm_cuir"),
...
#
      ("camp_craftchoix_10",
       ...
       "Une épée a deux mains de Baron.",
       [
        (troop_remove_item, "trp_player", "itm_iron"),
        (troop_remove_item, "trp_player", "itm_bois"),
        (troop_remove_item, "trp_player", "itm_cuir"),
...
#      
      ("camp_craftchoix_12",
       ...
       "Une épée a deux mains de Comte.",
       [
        (troop_remove_item, "trp_player", "itm_iron"),
        (troop_remove_item, "trp_player", "itm_bois"),
        (troop_remove_item, "trp_player", "itm_cuir"),
...
#fleches
        ...
        ("craft_fleches_type",0,
    "Quelle type de flèches allez vous fabriquer ?",
    "none",
    [],  
...
# bolts!!!!!
      ("camp_craftchoix_17",
       ...
       "Des carreaux d'arbalete simples.",
       [
        (troop_remove_item, "trp_player", "itm_iron"),
        (troop_remove_item, "trp_player", "itm_bois"),
        (troop_remove_item, "trp_player", "itm_plume"),
...
#
      ("camp_craftchoix_18",
       ...
       "Des carreaux d'arbalete en fer.",
       [
        (troop_remove_item, "trp_player", "itm_iron"),
        (troop_remove_item, "trp_player", "itm_plume"),
        (troop_remove_item, "trp_player", "itm_pier"),         
...
#bouclier
        ...
        ("craft_bouclier_type",0,
    "Voullez vous fabriquer un bouclier en bois ?",
    "none",
    [],  
...
#arc
    ("craft_arc_type",0,
    "Quel type d'arme a distance voullez vous confectioner ?",
    "none",
    [],  
...
#lance
    ("craft_lance_type",0,
    "Quelle type de lance allez vous fabriquer ?",
    "none",
    [],  
...
#armure aazzaa
        ...
        ("craft_armor_type",0,
    "Voullez vous fabriquer une armure de plates ?",
    "none",
    [],  
...
#
      ("camp_craftchoix_19",
       [
        ...
        (player_has_item, "itm_cuir"),
        (player_has_item, "itm_iron"),
        (player_has_item, "itm_wool_cloth"),        
        (store_attribute_level, ":agility", "trp_player", ca_agility),
        (ge, ":agility", 14),
         ],
       "Fabriquer.",
...
# objets speciaux  
          ("craft_special_type",0,
    "Quel objet voullez vouz creer?",
    "none",
    [],  
...
#
      ("camp_craftchoix_z1",
       [
        (player_has_item, "itm_champiv"),        
        (player_has_item, "itm_alchimi"),
        (store_attribute_level, ":agility", "trp_player", ca_agility),
        (ge, ":agility", 10),        
         ],
       "Fabriquer du poison!",
       [
        (troop_remove_item, "trp_player", "itm_champiv"),
        (troop_remove_item, "trp_player", "itm_alchimi"),         
      ...
      ("camp_craftchoix_z2",
       [
        ...
        (player_has_item, "itm_arrows"),        
         ],
       "Fabriquer une flèche empoisonée.",
       [
      ...
      ("camp_craftchoix_z3",
       [
        (player_has_item, "itm_poison"),        
        (player_has_item, "itm_bolts"),        
         ],
       "Fabriquer un carreau empoisoné.",
       [
        (troop_remove_item, "trp_player", "itm_poison"),
        (troop_remove_item, "trp_player", "itm_bolts"),         
...
# cuisine
          ("craft_food_type",0,
    "Quel repas voullez vous cuisiner ?",
    "none",
    [],  
...
#
      ("camp_craftchoix_z1",
       [
        (player_has_item, "itm_ustensil"),        
        (player_has_item, "itm_chaudron"),
        (player_has_item, "itm_legum"),        
        (store_attribute_level, ":agility", "trp_player", ca_agility),
        (ge, ":agility", 10),        
         ],
       "de la soupe de légumes",
       [
        (troop_remove_item, "trp_player", "itm_legum"),        
        (troop_add_item, "trp_player","itm_soup",0),
        (play_sound, "snd_food_camp"),
        ]
       ),
...
#
      ("camp_craftchoix_z2",
       ...
       "une potée de choux",
       [
        (troop_remove_item, "trp_player", "itm_cabbages"),
        (troop_remove_item, "trp_player", "itm_sausages"),         
        (troop_add_item, "trp_player","itm_potee",0),
        (troop_add_item, "trp_player","itm_potee",0),        
        (play_sound, "snd_food_camp"),
        ]
       ),
...
#
      ("camp_craftchoix_z3",
       [
        ...
        (player_has_item, "itm_chaudron"),
        (player_has_item, "itm_legum"), 
        (player_has_item, "itm_smoked_fish"),        
        (store_attribute_level, ":agility", "trp_player", ca_agility),
        (ge, ":agility", 10),        
         ],
       ...
       [
        (troop_remove_item, "trp_player", "itm_legum"),
        (troop_remove_item, "trp_player", "itm_smoked_fish"),         
        (troop_add_item, "trp_player","itm_poiss_soup",0),
        (troop_add_item, "trp_player","itm_poiss_soup",0),        
        (play_sound, "snd_food_camp"),
        ]
       ),
...
####
        ...
        ("plan_craf",0,
    "Vous possédez les plans de fabrication suivants:",
    "none",
   [
     ],
    [
#copier model envoie menu plans
      ("plancrt_choix_1",[(player_has_item, "itm_plan_1"),],"Plan de fabrication d'épées.",
       [
         (jump_to_menu, "mnu_plan_epees"),
        ]
       ),
#      
      ("plancrt_choix_2",[(player_has_item, "itm_plan_2"),],"Plan de fabrication de flèches.",
       [
         (jump_to_menu, "mnu_plan_fleches"),
        ]
       ),
# 
      ("plancrt_choix_3",[(player_has_item, "itm_plan_3"),],"Plan de fabrication de carreaux.",
       [
         (jump_to_menu, "mnu_plan_careaux"),
        ]
       ),
# 
      ("plancrt_choix_4",[(player_has_item, "itm_plan_4"),],"Plan de fabrication d'un bouclier.",
       [
         (jump_to_menu, "mnu_plan_bouclier"),
        ]
       ),
# 
      ("plancrt_choix_5",[(player_has_item, "itm_plan_5"),],"Plan de fabrication d'arcs.",
       [
         (jump_to_menu, "mnu_plan_arc"),
        ]
       ),
# 
      ("plancrt_choix_6",[(player_has_item, "itm_plan_6"),],"Plan de fabrication d'arbalètes.",
       [
         (jump_to_menu, "mnu_plan_arbalete"),
        ]
       ),
# 
      ("plancrt_choix_7",[(player_has_item, "itm_plan_7"),],"Plan de fabrication de lances.",
       [
         (jump_to_menu, "mnu_plan_lances"),
        ]
       ),
# 
      ("plancrt_choix_8",[(player_has_item, "itm_plan_8"),],"Plan de fabrication d'une armure de plates simple.",
       [
         (jump_to_menu, "mnu_plan_armure"),
        ]
       ),      
# 
      ("plancrt_choix_9",[(player_has_item, "itm_plan_9"),],"Recette d'une soupe de légumes.",
       [
         (jump_to_menu, "mnu_plan_soupe"),
        ]
       ),      
# 
      ("plancrt_choix_10",[(player_has_item, "itm_plan_10"),],"Recette de la potée de choux.",
       [
         (jump_to_menu, "mnu_plan_potee"),
        ]
       ),      
# 
      ("plancrt_choix_11",[(player_has_item, "itm_plan_11"),],"Recette d'une soupe de poissons.",
       [
         (jump_to_menu, "mnu_plan_poisson_soup"),
        ]
       ),      

      ("plancrt_choix_12",[(player_has_item, "itm_plan_12"),],"Plan de fabrication de torches.",
       [
         (jump_to_menu, "mnu_plan_torch"),
        ]
       ),      

#return plan to menu camp
      ("camp_craftchoix_return",[],"retour...",
       [
         (jump_to_menu, "mnu_camp"),
        ]
       ),
...
#########menus plans craft !!!!!!!!!!!!!!
#copier modele plan craft
      ("plan_epees",0,
    "Pour forger une bonne épée,il faut d'abord une enclume et des outils,puis: un lingot de fer pour faire le pomeau,la garde et bien sur la lame,puis du bois et du cuir pour fabriquer la fusée,et pour finire une bonne pierre a aiguiser pour rendre le fil tranchant,selon le niveau d'agilité du forgeron,on peut avec les memes materiaux forger de bien meilleures pieces et les revendre plus cheres,une agilité d'au moin 10 es requise pour pouvoire devenire forgeron.",
    "none",
   [
     ],
    [

      ("camp_craf_return",[],"retour...",
       [
         (jump_to_menu, "mnu_plan_craf"),
        ]
       ),
...
#
      ("plan_fleches",0,
    "Pour fabriquer une flèche digne de ce nom,il faut d'abord des outils et une enclume,puis: un lingot de fer,du bois,une plume pour faire l'empennage,et une pierre a aiguiser,plus le fabricant aura d'agilité et plus les flèches et carreaux qu'il fabriquera seront èlabrès,une agilitè d'au moin 6 es requise pour fabriquer des flèches.",
    "none",
   [
     ],
    [

      ("camp_craft2_return",[],"retour...",
       [
         (jump_to_menu, "mnu_plan_craf"),
        ]
       ),
...
#
      ("plan_careaux",0,
    "Pour fabriquer un carreau d'arbalète,il faut d'abord des outils et une enclume,puis: un lingot de fer,du bois,une plume pour faire l'empennage,et une pierre a aiguiserplus le fabricant aura d'agilité et plus les flèches et carreaux qu'il fabriquera seront èlabrès,une agilitè d'au moin 8 es requise pour fabriquer des carreaux.",
    "none",
   [
     ],
    [

      ("camp_craft3_return",[],"retour...",
       [
         (jump_to_menu, "mnu_plan_craf"),
        ]
       ),
...
#
      ("plan_bouclier",0,
    "Pour faire un solide bouclier en bois,il faut des outils,puis: du bois et du cuir,une agilité de 8 es requise pour fabriquer un bouclier.",
    "none",
   [
     ],
    [

      ("camp_craft4_return",[],"retour...",
       [
         (jump_to_menu, "mnu_plan_craf"),
        ]
       ),
...
#
      ("plan_arc",0,
    "Pour fabriquer un bon arc,il faut des outils,puis: du bois,une corde,et du cuir pour la poignée,plus le fabriquant a d'agilité et plus ses arcs seront élaborés,il faut au moin une agilité de 6 pour pouvoire fabriquer un arc.",
    "none",
   [
     ],
    [

      ("camp_craft5_return",[],"retour...",
       [
         (jump_to_menu, "mnu_plan_craf"),
        ]
       ),
...
#
      ("plan_arbalete",0,
    "Fabriquer une arbalète n'es point chose aisée,il faut une enclume,des outils,puis: du bois pour fabriquer le corp,un lingot de fer pour faconer le levier de declanchement du tir,l'arc,le mecanisme et bien sur de la corde,plus le fabriquant aura d'agilité et plus les arbaletes qu'ils fabriquera seront élaborées,une agilité d'au moin 8 es requise pour confectioner une arbalete.",
    "none",
   [
     ],
    [

      ("camp_craft6_return",[],"retour...",
       [
         (jump_to_menu, "mnu_plan_craf"),
        ]
       ),
...
#
      ("plan_lances",0,
    "Pour fabriquer une lance,il faut une enclume des outils,puis: un lingot de fer pour forger la pointe et du bois,bien sur on peut se passer de fer et d'une enclume pour tailler un simple baton,il faut une agilité de 10 pour pouvoir fabriquer une guisarme,et seulement 6 pour tailler un baton de bois.",
    "none",
   [
     ],
    [

      ("camp_craft7_return",[],"retour...",
       [
         (jump_to_menu, "mnu_plan_craf"),
        ]
       ),
...
#
      ("plan_armure",0,
    "En temps normale, seul un maistre forgeron serais capable de faconer une armure de plates compléte de bonne qualité, mais avec beaucoup d'habileté n'importe qui peut avec de la patience et le materiel nescéssaire tenter de fabriquer une bonne armure a condition d'avoire une enclume, des outils , du cuir pour les lanières et du Tissu de laine pour ne pas a avoir a porter le metal a meme la peau.",
    "none",
   [
     ],
    [
...
#
      ("plan_soupe",0,
    "Préparer une soupe de légumes es on ne peut plus simple, il faut un vieux chaudron, des ustenssils de cuisinier, des légumes frais, allumer un feu et laisser mijoter les légumes sans oublier de les éplucher au préalable.",
    "none",
   [
     ],
    [
...
#
      ("plan_potee",0,
    "Pour réussire une potée de choux, il faut d'abord bien choisire son chaudron, bien sur des ustenssils de cuisine, il faudra en suite du choux et des saussices bien juteuses.",
    "none",
   [
     ],
    [
...
#
      ("plan_poisson_soup",0,
    "Une soupe de poisson es assez simple a préparer, il faudra un chaudron, des ustenssils de cuisine, des légumes et bien entendue du poisson.",
    "none",
   [
     ],
    [
      ...
      ("plan_torch",0,
    "Rien n'est plus simple que de confectionner une torche, du bois et du cuir enroul?trempé dans un peut d'huile ferons parfaitement l'affaire.",
    "none",
   [
     ],
    [
...
##menu camp anglais quete rebels


  (
    "camp_brit",0,
    "Vous etes au camp Anglais decrit par les Rebelles,qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("camp_atack",[
         (eq, "$atackcampenglfin", 0),#
          ], "Attaquer le camp.",
       [
        #(party_get_slot, ":cur_terrain","p_main_party"), # precedent
        #(modify_visitors_at_site,":cur_terrain"),       
        (modify_visitors_at_site,"scn_camp_brit_alley"),
          (reset_visitors),			
            (set_jump_entry, 1),
            (set_visitor, 2, "trp_rebel_quest_ca1"),
            (set_visitor, 3, "trp_rebel_quest_ca2"),
            (set_visitor, 4, "trp_rebel_quest_ca3"),
            (set_visitor, 5, "trp_rebel_quest_ca4"),
            (set_visitor, 6, "trp_rebel_quest_ca5"),
            (set_visitor, 7, "trp_rebel_quest_ca6"),
            (set_visitor, 40, "trp_rebel_quest_ca7"),        
            (set_visitor, 40, "trp_rebel_quest_ca8"),
            (set_visitor, 40, "trp_rebel_quest_ca9"),        
            (set_visitor, 40, "trp_rebel_quest_ca10"),
            (set_visitor, 40, "trp_rebel_quest_ca11"),
             (set_visitor, 41, "trp_eng_quest_ca1"),
             (set_visitor, 42, "trp_eng_quest_ca2"),
             (set_visitor, 42, "trp_eng_quest_ca3"),
             (set_visitor, 43, "trp_eng_quest_ca4"),
             (set_visitor, 43, "trp_eng_quest_ca5"),
             (set_visitor, 44, "trp_eng_quest_ca6"),        
        (set_jump_mission,"mt_english_campement_atack"),
        (mission_tpl_entry_set_override_flags, "mt_english_campement_atack", 1, af_override_horse),         
           (jump_to_scene, "scn_camp_brit_alley"),
        (change_screen_mission),
        (music_set_situation, 0),        
         ]),

      ("leavx",[],"Battre en retraite.",
       [(change_screen_return),
        ]),
    ]
  ),

##village de toul quete rebels


  (
    "toul_v",0,
    "Vous etes au village de Toul,le drapeau noir annoncant la peste flotte encore au dessus des maisons abandonnées,qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("entrer.",[
       ...
       [       
        (modify_visitors_at_site,"scn_villag_toul"),
          (reset_visitors),			
            (set_jump_entry, 1),
          #  (set_visitor, 2, "trp_rebel_quest_ca1"),        
        (set_jump_mission,"mt_toul_vil"),
      #  (mission_tpl_entry_set_override_flags, "mt_english_campement_atack", 1, af_override_horse),         
           (jump_to_scene, "scn_villag_toul"),
        (change_screen_mission),
        (music_set_situation, 0),        
         ]),
...
##camp de verzy quete rebels 
  (
    "rebel_verzy",0,
    "Vous avez découvert le camp Rebelle de la foret de Verzy,qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("entrer.",[
       ...
       [       
        (modify_visitors_at_site,"scn_verzy_camp"),
          (reset_visitors),			
            (set_jump_entry, 1),
            (set_visitor, 2, "trp_rebel_verzy1"),
            (set_visitor, 3, "trp_rebel_verzy2"),        
            (set_visitor, 4, "trp_rebel_verzy3"),        
            (set_visitor, 5, "trp_rebel_verzy4"),
            (set_visitor, 6, "trp_rebel_verzy5"),
            (set_visitor, 7, "trp_rebel_verzy6"),                
        (set_jump_mission,"mt_foret_verzycamp"),
      #  (mission_tpl_entry_set_override_flags, "mt_english_campement_atack", 1, af_override_horse),         
           (jump_to_scene, "scn_verzy_camp"),
        (change_screen_mission),
        (music_set_situation, 0),        
         ]),
...
##place forte apres victoire
#  (
 #   "placeforte",0,
 #   "Vous approchez de la place forte,qu'allez vous faire ?",
 #   "none",
 #   [
 #                    (check_quest_finished, "qst_rebel_placeforte"),                      
  ...
  #    ("entrer.",[
   ...
   #       ], "Aller a la place forte.",
   #    [       
    #    (modify_visitors_at_site,"scn_p_forte"),
    #      (reset_visitors),			
    #        (set_jump_entry, 1),
          #  (set_visitor, 2, "trp_rebel_pfort1"),
          #  (set_visitor, 3, "trp_rebel_pfort2"),        
          #  (set_visitor, 4, "trp_rebel_pfort3"),        
          #  (set_visitor, 5, "trp_rebel_pfort4"),
          #  (set_visitor, 6, "trp_rebel_pfort5"),
           # (set_visitor, 40, "trp_bourg_pfort1"),
           #  (set_visitor, 41, "trp_bourg_pfort2"),
            # (set_visitor, 42, "trp_bourg_pfort3"),
            # (set_visitor, 43, "trp_bourg_pfort4"),
            # (set_visitor, 44, "trp_bourg_pfort5"),
            # (set_visitor, 45, "trp_bourg_pfort6"),
            # (set_visitor, 46, "trp_bourg_pfort7"),
            # (set_visitor, 47, "trp_bourg_pfort8"),        
     #   (set_jump_mission,"mt_pf_bovictoire"),
        #(mission_tpl_entry_set_override_flags, "mt_pf_bourg", 1, af_override_horse),         
      #     (jump_to_scene, "scn_p_forte"),
      #  (change_screen_mission),
      #  (music_set_situation, 0),        
      #   ]),
...
##place forte
  (
    "placeforte",0,
    "Vous approchez de la place forte Bourgignone,qu'allez vous faire ?",
    "none",[],
    ...
    [
      ("entrer.",
       [
        ...
        (neg|check_quest_succeeded, "qst_rebel_placeforte"),          
         (eq, "$combatalpesfinis", 0),# assigner condition a MT
          ], "s'infiltrer.",
       [       
        (modify_visitors_at_site,"scn_p_forte"),
          (reset_visitors),			
      ...
      ("entrer_neutral.",
       ...
       [       
        (modify_visitors_at_site,"scn_p_fneutral"),
          (reset_visitors),			
            (set_jump_entry, 1),
            (set_visitor, 2, "trp_pfrebel_neutre1"),
            (set_visitor, 3, "trp_pfrebel_neutre2"),        
            (set_visitor, 4, "trp_pfrebel_neutre3"),        
            (set_visitor, 5, "trp_pfrebel_neutre4"),
            (set_visitor, 6, "trp_pfrebel_neutre5"),
            (set_visitor, 7, "trp_pfrebel_neutre6"),        
           # (set_visitor, 40, "trp_bourg_pfort1"),
           #  (set_visitor, 41, "trp_bourg_pfort2"),
            # (set_visitor, 42, "trp_bourg_pfort3"),
            # (set_visitor, 43, "trp_bourg_pfort4"),
...
##tour des pins
  (
    "tourpins",0,
    "Vous approchez du repaire des Rebelles dans les ruines de la tour des pins,qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("entrer.",[
        # (eq, "$entreeatoul", 0),# assigner condition a MT
          ], "avancer vers le repaire.",
       [       
        (modify_visitors_at_site,"scn_tour_pins"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_rebel_montpelier_tower_1"),
             (set_visitor, 3, "trp_rebel_montpelier_tower_2"),
             (set_visitor, 4, "trp_rebel_montpelier_tower_3"),
             (set_visitor, 5, "trp_rebel_montpelier_tower_4"),
             (set_visitor, 6, "trp_rebel_montpelier_tower_5"),
...
##passage catacombs      
      ...
      ("catacomb_arived",0,
    "Aprés une courte marche sans rien y voire vous vous aretez,le brigand enlève le sac sur votre tête et vous dit d'utiliser votre torche,qu'allez vous faire?",
    "none",
   [
    (set_background_mesh, "mesh_pic_catacombs"),        
     ],
    [
      ...
      ("catacomb_choix_1",[],"Rester dans les catacombes.",
       [          
         (call_script, "script_start_catacombs"),
        ]
       ),


      ("catacomb_choix_2",[],"remonter dans les rues.",
       [
	(try_begin),           
         (this_or_next|player_has_item,"itm_torch"),
         (troop_has_item_equipped,"trp_player","itm_torch"),
...
##
  (
    "fermem",0,
    "Vous approchez de la ferme du traitre décrite par Villandrandro,qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("approch.",
       ...
       [       
        (modify_visitors_at_site,"scn_ferm_mat"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_mathieu_farm"),
             (set_visitor, 3, "trp_femme_farm"),        
        (set_jump_mission,"mt_mat_farmer"),
      #  (mission_tpl_entry_set_override_flags, "mt_tour_pins", 1, af_override_horse),         
           (jump_to_scene, "scn_ferm_mat"),
        (change_screen_mission),        
         ]),
...
## camp de chasse
  (
    "campchasss",0,
    "Vous approchez du camp de chasse ou es installé le gouverneur a abattre,qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("approch_camp.",
       ...
       [       
        (modify_visitors_at_site,"scn_camp_chasseur"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_chasse_camp_gouv"),   #gouverneur
             (set_visitor, 3, "trp_chasse_camp_cond"),   
             (set_visitor, 4, "trp_chasse_camp_bour"),   
             (set_visitor, 40, "trp_chasse_camp_1"),   
             (set_visitor, 41, "trp_chasse_camp_2"),    
        (set_jump_mission,"mt_campachass"),
      #  (mission_tpl_entry_set_override_flags, "mt_tour_pins", 1, af_override_horse),
...
##
       ( "conffes",mnf_scale_picture,
          "Vous vous conffessez...",
          "none",
         [                          
          (set_background_mesh, "mesh_pic_benire"),
          (music_set_situation, 0),      
...
######## sainte catherine de fierbois
  (
    "chap_fierbois",0,
    "Vous approchez de la chapelle de sainte Catherine de Fierbois,qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("approch_camp.",
       [
#reporter au mt pour ne plus a avoir a entrer bloquer d'une facon ou d'une autre pour ne pas avoir deux epees
        # (eq, "$epee_mystrecuperee", 0), ### reporter                   
          ], "approcher.",
       [       
        (modify_visitors_at_site,"scn_fierbois_cha"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_pretre_fierbois1"),  
             (set_visitor, 3, "trp_pretre_fierbois2"),   
             (set_visitor, 4, "trp_pretre_fierbois3"),       
        (set_jump_mission,"mt_fierbois-cat"),       
        (jump_to_scene, "scn_fierbois_cha"),
        (change_screen_mission),        
         ]),
  ...
  (
    "chap_fierboientry",0,
    "Vous entrez dans la chapelle pour vous mettre a la recherche de l'épée, qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("approch_camp.",
       ...
       [       
        (modify_visitors_at_site,"scn_chapelle_indoor"),
          (reset_visitors),			
            (set_jump_entry, 1),    
        (set_jump_mission,"mt_chapelle_interior"),
        (mission_tpl_entry_set_override_flags, "mt_chapelle_interior", 1, af_override_horse),        
        (jump_to_scene, "scn_chapelle_indoor"),
        (change_screen_mission),        
         ]),
...
######## foret de rouen
  (
    "foret_de_rouen",0,
    "Vous penetrez dans la foret de Rouen,qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("approch_camp.",
       [
           (eq, "$finiend_fortrouen", 0),                  
          ], "Entrer dans la foret.",
       [       
        (modify_visitors_at_site,"scn_rouen_forest"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 40, "trp_rouenf_traire1"),  
             (set_visitor, 41, "trp_rouenf_traire2"),   
             (set_visitor, 42, "trp_rouenf_traire3"),
             (set_visitor, 2, "trp_rouenf_fill"),        
        (set_jump_mission,"mt_foretrouen"),       
        (jump_to_scene, "scn_rouen_forest"),
        (change_screen_mission),        
         ]),
...
######## camp des cranes de fer
  (
    "camp_cranede_fer",0,
    "Vous approchez du camp de la compagnie des mercenaires des Cranes de Fer, qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("approch_camps.",
       ...
       [       
        (modify_visitors_at_site,"scn_camp_crane_defer"),
          (reset_visitors),			
            (set_jump_entry, 1),
             (set_visitor, 2, "trp_crane_de_fercamp_troop1"),  
             (set_visitor, 3, "trp_crane_de_fercamp_troop2"),  
             (set_visitor, 4, "trp_crane_de_fercamp_troop3"),  
             (set_visitor, 5, "trp_crane_de_fercamp_troop4"),  
             (set_visitor, 6, "trp_crane_de_fercamp_troop5"),  
             (set_visitor, 7, "trp_crane_de_fercamp_troop6"),  
             (set_visitor, 8, "trp_crane_de_fercamp_troop7"),  
             (set_visitor, 13, "trp_crane_de_fercamp_troop8"),  
             (set_visitor, 14, "trp_crane_de_fercamp_troop9"),  
             (set_visitor, 15, "trp_crane_de_fercamp_troop10"),  
             (set_visitor, 16, "trp_crane_de_fercamp_troop11"),  
             (set_visitor, 17, "trp_crane_de_fercamp_troop12"),  
             (set_visitor, 18, "trp_crane_de_fercamp_troop13"),  

# # # 
  #(assign, "$ep_generic", 0),
  # # #
        (set_jump_mission,"mt_camp_crane_defer"),       
        (jump_to_scene, "scn_camp_crane_defer"),
        (change_screen_mission),        
         ]),
      ...
      ("captain_cdf", 
       ...
       "Parler au Capitaine de la compagnie.",
       [
...
# # # 
 # (assign, "$ep_generic", 0),
        # # # 
        (set_jump_mission,"mt_camp_crane_deferdial"),        

        
           (jump_to_scene, "scn_camp_crane_defer"),
          (change_screen_map_conversation, "trp_crane_de_fercamp_troop1"),      
...
#       ( "death_game_over",mnf_scale_picture,
         ...
         [                          
          ...
          (music_set_situation, 0),      
          (play_sound, "snd_death"),#faire
          (assign, "$game_death", 0),   #securit?meme si a 0 dans une sauvegarde       
         ],
         [
           ("end",[],"Terminer...",             
            [
...
################# CAMP GROUPE END a effacer ... #################
  ...
  (
    "fo_braconnier1",0,
    "Vous approchez de la foret de Levet,qu'allez vous faire ?",
    "none",
    [
...
(call_script, "script_quest_forest1s"),           
  ...
  (
    "fo_braconnier2",0,
    "Vous approchez de la foret d'Aurillac,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"), 
       ...
       [       
(call_script, "script_quest_forest2s"),       
         ]),
  ...
  (
    "fo_braconnier3",0,
    "Vous approchez de la foret de Narbone,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"),
       ...
       [       
(call_script, "script_quest_forest3s"),        
         ]),
  ...
  (
    "fo_braconnier4",0,
    "Vous approchez de la foret de Rodez, qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"),  
       ...
       [       
(call_script, "script_quest_forest4s"),        
         ]),
  ...
  (
    "fo_braconnier5",0,
    "Vous approchez de la foret de Arles,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"), 
       ...
       [       
(call_script, "script_quest_forest5s"),        
         ]),
  ...
  (
    "fo_braconnier6",0,
    "Vous approchez de la foret du Puy,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"), 
       ...
       [       
(call_script, "script_quest_forest6s"),        
         ]),
  ...
  (
    "fo_braconnier7",0,
    "Vous approchez de la foret de Vierzon,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"), 
       ...
       [       
(call_script, "script_quest_forest7s"),       
         ]),
  ...
  (
    "fo_braconnier8",0,
    "Vous approchez de la foret de Beaune,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"),
       ...
       [       
(call_script, "script_quest_forest8s"),        
         ]),
  ...
  (
    "fo_braconnier9",0,
    "Vous approchez de la foret de Montargis,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"),  
       ...
       [       
(call_script, "script_quest_forest9s"),        
         ]),
  ...
  (
    "fo_braconnier10",0,
    "Vous approchez de la foret d'Evreux,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"),
       ...
       [       
(call_script, "script_quest_forest10s"),       
         ]),
  ...
  (
    "fo_braconnier11",0,
    "Vous approchez de la foret de Guines,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"), 
       ...
       [       
(call_script, "script_quest_forest11s"),       
         ]),
  ...
  (
    "fo_braconnier12",0,
    "Vous approchez de la foret de Bayeux,qu'allez vous faire ?",
    "none",
    [
   ...
   (neg|check_quest_succeeded, "qst_braconage"),
    (neg|check_quest_failed, "qst_braconage"),
       ...
       [       
(call_script, "script_quest_forest12s"),        
         ]),
  ...
  (
    "tournois_training",0, 
    "Vous etes sur le terrain d'entrainement aux joutes, qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("s'entrainer.",[
       ...
       [       
  #    (call_script, "script_try_villes_joutes"),###<<<<<<<<
...
(assign, "$message_pas_repete_joutes", 0),
(assign, "$horse_joustes_dead", 0),
(party_get_slot, ":arena_scene", "$current_town", slot_town_arena),
       (modify_visitors_at_site, ":arena_scene"),
    (reset_visitors),
...
(mission_disable_talk),
  ...
  (
    "auberge1",0,
    "Vous approchez de l'Auberge, une agréable odeur de gibier roti se dégage de la cheminée, l'endroit semble paisible et reposant, qu'allez vous faire ?",
    "none",
    [
 ...
 #   (neg|check_quest_failed, "qst_braconage"),
       ...
       [       
 #(call_script, "script_entree_auberge_1"),



        (modify_visitors_at_site,"scn_auberge_ext_1"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 2, "trp_auberge_troop_1"),
             (set_visitor, 3, "trp_auberge_troop_2"),
             (set_visitor, 6, "trp_camelot_1"),
        #     (set_visitor, 5, "trp_auberge_troop_4"),
        #     (set_visitor, 6, "trp_auberge_troop_5"),
        

        (set_jump_mission,"mt_auberges1"),        
        
           (jump_to_scene, "scn_auberge_ext_1"),
        (change_screen_mission),           
     ...
     ("interrieur",[],"Entrer dans l'Auberge.",
       [
     (call_script, "script_passage_auberge_1"),
        ]),
	...
	#	  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
        ...
        #  (neq, ":current_town_faction", "fac_player_supporters_faction"),
          ...
          (store_div, reg1, ":num_men", 4),
          (val_add, reg1, 1),
          (str_store_string, s1, "@ ({reg1} écus par nuitée.)"),
          (store_troop_gold, ":gold", "trp_player"),
          (lt, ":gold", reg1),
          (assign, ":can_rest", 0), 
        (try_end),
     ...
     #   (assign, "$g_town_visit_after_rest", 1),
      ...
      ("vendeur_cheuv1",
       ...
       [
        ...
        (set_jump_mission,"mt_auberges1"),        
           ...
           (jump_to_scene, "scn_auberge_ext_1"),
          (change_screen_map_conversation, "trp_auberge_troop_1"),      
      ...
      ("vendeur_ca1",
       ...
       [
        ...
        (set_jump_mission,"mt_auberges1"),        
           ...
           (jump_to_scene, "scn_auberge_ext_1"),
          (change_screen_map_conversation, "trp_camelot_1"),      
      ...
      ("leavx",[],"partir.",
       [
 #    (assign,"$debug_braconier",0),
#(assign,"$parler_braconier",0),
           (change_screen_return),
        ]),
    ]
  ),
 ...
 #(call_script, "script_entree_auberge_1"),
        ...
        (modify_visitors_at_site,"scn_auberge_ext_2"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 2, "trp_auberge_troop_3"),
             (set_visitor, 3, "trp_auberge_troop_4"),
             (set_visitor, 6, "trp_camelot_2"),
            # (set_visitor, 5, "trp_auberge_troop_4"),
            # (set_visitor, 6, "trp_auberge_troop_5"),
        

        (set_jump_mission,"mt_auberges2"),        
        
           (jump_to_scene, "scn_auberge_ext_2"),
        (change_screen_mission),           
     ...
     ("interrieur",[],"Entrer dans l'Auberge.",
       [
     (call_script, "script_passage_auberge_2"),
        ]),
      ...
      ("vendeur_cheuv2",
       ...
       [
        ...
        (set_jump_mission,"mt_auberges2"),        
           ...
           (jump_to_scene, "scn_auberge_ext_2"),
          (change_screen_map_conversation, "trp_auberge_troop_3"),      
      ...
      ("vendeur_ca2",
       ...
       [
        ...
        (set_jump_mission,"mt_auberges2"),        
           ...
           (jump_to_scene, "scn_auberge_ext_2"),
          (change_screen_map_conversation, "trp_camelot_2"),      
...
#(assign,"$parler_braconier",0),
 ...
 #(call_script, "script_entree_auberge_1"),
        ...
        (modify_visitors_at_site,"scn_auberge_ext_3"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 2, "trp_auberge_troop_5"),
             (set_visitor, 3, "trp_auberge_troop_6"),
             (set_visitor, 6, "trp_camelot_3"),
          #   (set_visitor, 5, "trp_auberge_troop_4"),
           #  (set_visitor, 6, "trp_auberge_troop_5"),
        

        (set_jump_mission,"mt_auberges3"),        
        
           (jump_to_scene, "scn_auberge_ext_3"),
        (change_screen_mission),           
      ...
      ("client_perd",
       ...
       "Rechercher le client perdu dans la foret.",
       [

        (modify_visitors_at_site,"scn_foret_neige_auberge"),
        (reset_visitors),			
             (set_jump_entry, 1),
             (set_visitor, 8, "trp_pnj_mort_df"),
        
        (set_jump_mission,"mt_auberge_foret_eneigee"),        
        
           (jump_to_scene, "scn_foret_neige_auberge"),
             (change_screen_mission), 
     ...
     ("interrieur",[],"Entrer dans l'Auberge.",
       [
     (call_script, "script_passage_auberge_3"),
        ]),
      ...
      ("vendeur_cheuv3",
       ...
       [
        ...
        (set_jump_mission,"mt_auberges3"),        
           ...
           (jump_to_scene, "scn_auberge_ext_3"),
          (change_screen_map_conversation, "trp_auberge_troop_5"),      
      ...
      ("vendeur_ca3",
       ...
       [
        ...
        (set_jump_mission,"mt_auberges3"),        
           ...
           (jump_to_scene, "scn_auberge_ext_3"),
          (change_screen_map_conversation, "trp_camelot_3"),      
...
#(assign,"$parler_braconier",0),
 ...
 #(call_script, "script_entree_auberge_1"),
        ...
        (modify_visitors_at_site,"scn_auberge_ext_4"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 2, "trp_auberge_troop_7"),
             (set_visitor, 3, "trp_auberge_troop_8"),
             (set_visitor, 6, "trp_camelot_4"),
         #    (set_visitor, 5, "trp_auberge_troop_4"),
          #   (set_visitor, 6, "trp_auberge_troop_5"),
        

        (set_jump_mission,"mt_auberges4"),        
        
           (jump_to_scene, "scn_auberge_ext_4"),
        (change_screen_mission),           
     ...
     ("interrieur",[],"Entrer dans l'Auberge.",
       [
     (call_script, "script_passage_auberge_4"),
        ]),
      ...
      ("vendeur_cheuv4",
       ...
       [
        ...
        (set_jump_mission,"mt_auberges4"),        
           ...
           (jump_to_scene, "scn_auberge_ext_4"),
          (change_screen_map_conversation, "trp_auberge_troop_7"),      
      ...
      ("vendeur_ca4",
       ...
       [
        ...
        (set_jump_mission,"mt_auberges4"),        
           ...
           (jump_to_scene, "scn_auberge_ext_4"),
          (change_screen_map_conversation, "trp_camelot_4"),      
...
#(assign,"$parler_braconier",0),
  ...
  (
    "prairie_bourges",0,
    "Vous approchez des prairies de Bourges a la recherche du cheval, qu'allez vous faire ?",
    "none",
    [
  ...
  (neg|check_quest_finished, "qst_cheval_perdu"),
          ], "Avancer dans les prairies.",
       [       


        (modify_visitors_at_site,"scn_prairie_bourges"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 8, "trp_cvalier_invisible_quete_prairie"),
        #     (set_visitor, 3, "trp_auberge_troop_8"),
        #     (set_visitor, 6, "trp_camelot_4"),
         #    (set_visitor, 5, "trp_auberge_troop_4"),
          #   (set_visitor, 6, "trp_auberge_troop_5"),
        ...
        (set_jump_mission,"mt_prairie_bourge"),        
        
           (jump_to_scene, "scn_prairie_bourges"),
        (change_screen_mission),           
  ...
  (
    "foret_lorges",0,
    "Vous approchez de l'entre de la foret de Lorges, qu'allez vous faire ?",
    "none",
    [
    ...
    [
      ("entrer.",[
          ...
          ], "Avancer vers la foret.",
       [       
        
(call_script, "script_rpg_foret7"),


         ]),

### zones foret si explor?s
     ("entrer2.",
      [
(eq, "$rpg_foret_exploree_2", 1),
          ], "Aller a la croisée.",
       [       
...
(call_script, "script_rpg_foret2"),
         ...
         ("entrer3.",
      [
(eq, "$rpg_foret_exploree_3", 1),
          ], "Aller au village de la mine.",
       [       
        
(call_script, "script_rpg_foret3"),
           ...
           ("entrer4.",
      [
(eq, "$rpg_foret_exploree_6", 1),
          ], "Se rendre a la porte du lac.",
       [       
        
(call_script, "script_rpg_foret6"),
           ...
           ("entrer5.",
      [
(eq, "$rpg_foret_exploree_1", 1),
          ], "Aller au cimetiere.",
       [       
        
(call_script, "script_rpg_foret1"),
...
### menu quitter poste de garde rue des dames
  

  (
    "abandon_post",0,
    "Allez vous abandonner votre poste ? la mission sera un échec.",
    "none",
    [
  ...
  (
    "quintin_siege",0,
    "Vous approchez du chateau de Quintin assiègé par la compagnie des Cranes de Fer, qu'allez vous faire ?",
    "none",
    [
...
(eq, "$peut_attendre", 1),
  ...
  (neg|check_quest_finished, "qst_siege_penthievre"),
          ], "Attendre les armées du Duc qui doivent nous remplacer, [términer la mission et ne plus revenir].",
       [       


 
####### attendre quelques heure et variable ne plus rentrer au siege + mission accomplie systeme          
        (call_script, "script_succeed_quest", "qst_siege_penthievre"),
  ...
  (neg|check_quest_finished, "qst_siege_penthievre"),
       ...
       [       
        ...
        (modify_visitors_at_site,"scn_chateau_panthievre"),
        (reset_visitors),			
             (set_jump_entry, 1),

             (set_visitor, 8, "trp_siege_crane_de_fercamp_troop1"),
             (set_visitor, 9, "trp_siege_crane_de_fercamp_troop2"),
             (set_visitor, 10, "trp_siege_crane_de_fercamp_troop3"),
             (set_visitor, 11, "trp_siege_crane_de_fercamp_troop4"),
             (set_visitor, 12, "trp_siege_crane_de_fercamp_troop5"),
             (set_visitor, 13, "trp_siege_crane_de_fercamp_troop6"),
             (set_visitor, 14, "trp_siege_crane_de_fercamp_troop7"),
             (set_visitor, 15, "trp_siege_crane_de_fercamp_troop8"),
             (set_visitor, 16, "trp_siege_crane_de_fercamp_troop9"),

        
 
        (set_jump_mission,"mt_chat_panthievre"),        
        
           (jump_to_scene, "scn_chateau_panthievre"),
        (change_screen_mission),           
