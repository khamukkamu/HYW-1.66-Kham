...
#  ("vaegir_caravans","Vaegir Caravans", 0, 0.5,[("outlaws",-0.8), ("dark_knights",-0.2)], []),
  ...
  ("player_supporters_faction","Player's Supporters",0, 0.9, [("player_faction",1.00),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("black_khergits", 0.05),("sang_lys", -0.00)], [], 0x00308F), #rouge 0xFF4433  bleu 0x00308F changed name so that can tell difference if shows up on map
#  ("faction_fake_end","faction_fake_end",0, 0.9, [], []),
  
  ("kingdom_1",  "Kingdom of France", 0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("black_khergits", 0.02),("sang_lys", 0.02),("cane_de_fer",0.00)], [], 0x4169E1),
  ("kingdom_2",  "Kingdom of England",    0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("black_khergits", -0.05),("sang_lys", -0.2),("cane_de_fer",0.00)], [], 0xE93014),
  ("kingdom_3",  "Kindom of Bourgogne", 0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("black_khergits", -0.05),("sang_lys", -0.2),("cane_de_fer",0.00)], [], 0xDDDD33),
  ("kingdom_4",  "Duche de Bretagne",    0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("black_khergits", 0.00),("sang_lys", -0.2),("cane_de_fer",0.05)], [], 0x999999),#bleu marine noir 0x000038 #gris 0x7A7A7A #gris clair 0x999999
...
##  rebels 1429
  #("black_khergits","Rebels", 0, 0.5,[("player_faction",0.4),("kingdom_1",0.0),("kingdom_2",-0.6),("kingdom_3",-0.6),("deserters", -0.02),("outlaws",-0.02),("sang_lys",-0.00)], [], 0x33DD33),
##sang lys 1429
...
##  rebels 1429
  ("black_khergits","Rebels", 0, 0.5,[("player_faction",0.2),("kingdom_1",0.02),("kingdom_2",-0.6),("kingdom_3",-0.6),("deserters", -0.02),("outlaws",-0.02),("sang_lys",-0.00),("cane_de_fer",0.00)], [], 0x228B22),#0x4B5320 camo
##sang lys 1429
  
  ("sang_lys","Compagnie du sang Lys", 0, 0.5,[("player_faction",0.4),("kingdom_1",0.2),("kingdom_2",-0.2),("kingdom_3",-0.2),("deserters", -0.00),("outlaws",-0.02),("black_khergits", 0.00),("kingdom_4",-0.02),("cane_de_fer",0.00)], [], 0x4169E1),    


##Vilandrandro
  ("vilandrandro","La grande Compagnie de Vilandrandro", 0, 0.5,[("player_faction",0.0),("kingdom_1",-0.2),("kingdom_2",-0.2),("kingdom_3",-0.2),("deserters", 0.05),("outlaws",0.05),("black_khergits", 0.00),("cane_de_fer",0.00)], [], 0x000000),
