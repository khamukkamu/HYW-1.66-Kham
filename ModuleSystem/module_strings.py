...
##  ("nothing", "nothing"),
  ...
  ("given_by_s1_in_wilderness", "Given by {hs1} whilst in the field"),
...
#npc10 = sir john
#npc11 = katrin
#npc12 = father anthony
#npc13 = ismail
#npc14 = giovanni
#npc15 = jacques
#npc16 = klethi
  
  ("npc1_intro", "May God be praised, traveller."),
  ("npc2_intro", "Greetings. Would you commiserate with a lowly squire such as myself?"),
  ("npc3_intro", "Good day to you, traveller."),
  ...
  ("npc6_intro", "Greetings {m'lordship/m'lady}...why are you talkin' to a lowly wretch such as me?"),
  ("npc7_intro", "Yes? Keep your distance, by the way."),
  ("npc8_intro", "Bah, what is it you want?"),
  ("npc9_intro", "Hm, you seem adequate. Yes, what is it you wish of me?"),
  ("npc10_intro", "Greetings fellow traveller. You wouldn't sit and have a drink with me, now would you?"),
  ("npc11_intro", "Hello there, {laddie/lassie}. Have a drink on me."),
  ("npc12_intro", "Good day to you my child. Will you sit with a servant of God?"),
  ("npc13_intro", "Peace be with you traveller. I am wondering if you know the way to Constantinople?"),
  ("npc14_intro", "Ah, hello there traveller. I saw you entering town at the head of an armed company. You are soldiers, no doubt."),
  ("npc15_intro", "Good day. Are you by chance the leader of the mercenary company that entered town?"),
  ...
  ("npc1_intro_response_1", "Indeed. What brings you here so equipped for war? "),
  ("npc2_intro_response_1", "Lost your way? What has befallen you, squire?"),
  ("npc3_intro_response_1", "Greetings. What's a young lordling like you doing in this tavern?"),
  ...
  ("npc6_intro_response_1", "A lowly wretch? What is the matter, exactly?"),
  ("npc7_intro_response_1", "My apologies. I was merely going to say that you look a bit down on your luck."),
  ("npc8_intro_response_1", "Only to speak to a fellow traveller, if you don't mind."),
  ("npc9_intro_response_1", "Adequate? What do you mean, sir? Are you in the market for mercenaries?"),
  ("npc10_intro_response_1", "Why not? What is the occasion?"),
  ("npc11_intro_response_1", "What's the occasion?"),
  ("npc12_intro_response_1", "No harm in it, I guess. What is a monk doing in a tavern?"),
  ("npc13_intro_response_1", "What is a Saracen like you doing in France? Aren't you afraid of the danger?"),
  ("npc14_intro_response_1", "We are. What is it to you, sir?"),
  ("npc15_intro_response_1", "I am. What concern is it of yours, may I ask?"),
  ("npc16_intro_response_1", "I could be. What's your story?"),

  ("npc1_intro_response_2", "Praised to God's name but I am in a hurry. Farewell."),
  ("npc2_intro_response_2", "I have pressing matters to attend to. Go to a whorehouse or get drunk, that should cheer you up."),
  ("npc3_intro_response_2", "I've no time for talk, sir."),
  ("npc4_intro_response_2", "Eh? No thanks, we don't want any."),
  ("npc5_intro_response_2", "I have no time for that."),
  ("npc6_intro_response_2", "Begone peasant, I've no mood for charity."),
  ("npc7_intro_response_2", "Right. I'll not bother you, then."),
  ("npc8_intro_response_2", "From you? Nothing. Good day."),
  ("npc9_intro_response_2", "Adequate? What am I? Cattle at a market? Good day to you, sir."),
  ("npc10_intro_response_2", "I'm sorry but I have better things to do than lose time at the tavern. Good day."),
  ("npc11_intro_response_2", "I think not, madame."),
  ("npc12_intro_response_2", "I have other matters to attend to, father. Good day."),
  ("npc13_intro_response_2", "I don't know. Follow the sun from where it rises and keep going until the people speak Greek I suppose."),
  ("npc14_intro_response_2", "I've no wish to be seen talking to the likes of you, sellsword."),
...
#backstory intro
  ("npc1_backstory_a", "Well, {sir/madame}, I come from war to tell you the truth. God's work is never done."),
  ("npc2_backstory_a", "It is a most tragic tale, good sir, but I am glad that someone wishes to hear it."),
  ("npc3_backstory_a", "Fair enough that I should tell you. No harm could come of it, I suppose."),
  ...
  ("npc6_backstory_a", "I'm doomed, {m'lord/m'lady}, but I don't see why you'd be the one to care. If it please your lordship, though, I'd as gladly tell you my story."),
  ("npc7_backstory_a", "My luck? You could say that."),
  ("npc8_backstory_a", "I guess I was somewhat unpolite. I am Stewart, John Stewart, though everyone calls me the Black Stewart. I guess it's because of my mood. You may have heard of my father."),
  ("npc9_backstory_a", "In the market for mercenaries? I am one! Well, my well-to-do peers would find my views distasteful but that is what all knights are. And I am a knight. A masterless one, at that."),
  ("npc10_backstory_a", "I'm currently out of employment. The last nobleman I worked for found my methods antiquated and my philosophy of training ineffective. Get a drink and I'll tell you all there is to know."),
  ...
  ("npc12_backstory_a", "Why, I am a travelling monk my child! It is my God-given task to travel the land, helping people with baptisms, weddings and funerals. As of late, though, funerals have been my specialization."),
  ("npc13_backstory_a", "What danger? I'm safer here than I would be in my homeland, since any God-fearing Muslim is as like to slit my throat as the next willing crusader."),
  ("npc14_backstory_a", "Well, it just so happens that I am a most esteemed mercenary captain who is currently out of a job, my friend. Have a seat, and I will tell you everything about my misadventures."),
  ("npc15_backstory_a", "I am a surgeon desperately in need of an employer. I am also a barber, but I do not consider that to be my greatest skill."),
...
#backstory main body
  ("npc1_backstory_b", "For my name is Ulrich von Baden and I am a Teutonic Knight from the Far East, where men are men and wild beasts claim rule of the wilderness. Believe me, my friend, there is nothing better in life than fighting in God's name with the sign of the Cross on your banner. But alas, I am not fully a knight, merely a lay-brother of the Order, for I am not yet a priest. And it is for that reason that I come to the West to garner support for our cause. I search for knights, French, English or Burgundian to bolster our cause and I wouldn't refuse if I could take part in the fighting between them myself."),
  ("npc2_backstory_b", "I was squire to Lord Graham. Some would call my former master a petty-lord with litle fortune, but my liege was nonetheless a valiant and chivalrous warrior who bore arms in the name of his own liege, King Edward. All until the day he met one of our king's sons in a tournament at London. His Majesty Prince Lionel jousted against Lord Graham but a terrible accident befell both of them. The prince could not control his destrier and the beast crashed into the lists, making the prince's lance unsteady as well. As the prince fell, my lord's own steed tripped on the prince's mount, sending both animals to the ground. My lord fell on the prince's lancepoint, however, and it drove through his neck-guard, slaying him instantly."),
  ("npc3_backstory_b", "I may look every bit a lordling to you, and I may also act like one so brought up, but I am in truth merely an illegitimate son. My father is a much greater man than I will ever be. A king, in fact! And kings rarely lack in children, either to carry their name or to serve them in ways unbeknownst to others. Do not, however, presume to call me a bastard, for my mother was also noble. I am merely a son who does not carry his father's name. And as is fitting for a worthy son, I intend to prove my worth to my father. Soldiering here in France would be the best way to earn a small lordship for myself back in Scotland. There are many lands that go without sheriffs to rule over them."),
  ...
  ("npc6_backstory_b", "I used to be a serf from a village not far from {s20}. My village is gone, though as of the last week. A group of deserters rode into the village, but I'll be damned if I know what the bastards were. English or French, though, they burned everything there was to burn and stole all our livelihoods, meagre as they were. Worst of all, they killed my son and left my woman bloody after raping her, as like. How I wish I would have fought them instead of running for my life in the woods and leaving my family to die! At least I would have taken some of them with me, and maybe my loved ones could have escaped in the woods like I did. Now, however, there is nothing I can do to save my wife and child..."),
  ...
  ("npc8_backstory_b", "I am the bastard son of Robert the Second, formerly High Steward of Scotland and current king of the same. I like to be frank about my heritage to all I meet and come across, unlike some of my half-brothers who seem to think it a shame when asked who their mother bedded. Just as well, unlike most sons of royalty and high nobles, bastards have no lands or titles of their own so we have to fight for whatever we have. Since that layabout who calls himself king doesn't much care for me, I have to make a name for myself in this world, and the best way to do it is by killing English or French, makes no difference to me really, here in this hell-hole. So I took my weapons and armour, and came here."),
  ("npc9_backstory_b", "I had a liege lord not long ago. He was an old fool, though, whose wife always eloped with other men, from scullions to household knights like myself. After a while, I started sleeping with her as well, but my lord somehow caught on. Ever chivalrous, he challenged me to a duel in the name of his insulted wife, who told him that I had actually seduced her, not the other way around. After a short bout, my dirk found purchase through his opened visor. You can imagine that my former liege wasn't going to get back up with a knife in his eye. After the duel, however, his son banished me from his estate, thus leaving me a masterless mercenary."),
  ("npc10_backstory_b", "I've been a master-at-arms ever since I was knighted. I've travelled the length and breadth of both England and France, training knights and squires in the chivalric arts of combat and I've done a good job of it if I can say so myself. All until I pledged my service to the lord of Nevers. He hired me because of a lack of other choices, so he always seemed to have disdain for me. His son was also spoiled and unwilling when it came to training. During his first tournament, the lazy whelp had his arm broken in a match. It was no fault of mine, yet his father took advantage of the boy's misfortune and dismissed me from his retinue."),
  ...
  ("npc12_backstory_b", "I set out from a monastery not far from Rouen on a journey to help the poor common folk living here in France, especially the ones who did not have a church in their villages. In these downtrodden villages I came across many young men who wished to be my apprentices, and leave their villages. I happily took them with me on my travels since they could help if we were waylaid by cutthroats. And waylaid we were. I had money to pay the bandits, yet I would rather die than do so and my apprentices agreed. In the ensuing battle, I stained my hands with sinner's blood. The cutthroats were all slain, yet so were my followers."),
  ("npc13_backstory_b", "My fortunes have been quite low as of late, friend. I am a renegade in my own homeland, the Emirate of Granada and the men of the Emir seek my head for a crime I did not commit. I must admit that I am a sinner, yet I am on the path to redemption. I was thinking to go to Constantinople, and help the Turks of Rum fight the Byzantines since none here seem to want my service. Either way, I have to slay at least fifty of the Infidel to return to my homeland with a clean face. If I fight alongside Infidels against other Infidels, it makes no difference to me."),
  ("npc14_backstory_b", "You are looking at one who was once count of Genoa, yet the schemings of jealous nobles brought me down from that position and forced me to make a livelihood by training soldiers in the noble arts of war. Since France is the place where all respectable mercenaries are plying their trades, I decided to come here as well and see what this war is all about. After a few months spent here, selling my sword and my men to this lord and that, I eventually participated in a great battle between the English and the French. My men fought most courageously yet most of them were killed and the survivors died of wounds afterwards."),
  ("npc15_backstory_b", "Up until the other day I was personal surgeon and barber to the lord of {s20}. Since he is in the best of health, however, and he doesn't much concern himself with the matters of war, he found that my wages as his personal surgeon were unacceptably high for someone who wasn't actually doing anything to earn his keep. So he dismissed me from his service. I've been looking for another employer ever since, but it seems mercenaries are more sought after than surgeons these days."),
...
#backstory recruit pitch
  ("npc1_backstory_c", "I was ambushed by outlaws near the German border, however, and my steed was slain and with it I lost most of my baggage train. If I could join a company of men and soldiers for a while, I would be most grateful."),
  ("npc2_backstory_c", "After his death, I took a vow to slay one hundred foes in his name, but so far none have taken me to squire for them."),
  ("npc3_backstory_c", "The first step to this would be to join with a mercenary company. You seem as good a way as any to help me!"),
  ...
  ("npc6_backstory_c", "There is, however, something I can do for their murderers. Repay them with the same coin, blood for blood. Theirs, for my slain family's! I may not understand them papers or what the priest says at mass, but I swear by God that those bastards are to pay dearly for what they did to me."),
  ...
  ("npc8_backstory_c", "I'll bide my time here, slaying enough foes and looting enough to amass a fortune, then I'll go back home, and show that father of mine what I truly think of him."),
  ("npc9_backstory_c", "After I slew my former liege, I tried to find employ among his friends, but they were too afraid to have me. Now, I hope I can find some captain whom I can soldier with, because my coin is almost out."),
  ("npc10_backstory_c", "After being dismissed from his service I've travelled from town to town in this damned land, looking for any lords and nobles who would have me train their whelps. None of the bastards seem eager to have a hard-nosed Englishman master-at-arms like me, however. I'd be very grateful if even a mercenary captain enlisted me in his company."),
  ...
  ("npc12_backstory_c", "After that blood-letting, though, I realized that it was easier to save sinners by sending them to God. Literally. By way of club or dagger, I am eager to send more sinners to the Heavens, be they French or English-born and I would be grateful if I could have some like-minded companions with me."),
  ("npc13_backstory_c", "So, to be brief for I believe there are already religious fanatics close behind me, would you have the service of a disgraced one such as me?"),
  ("npc14_backstory_c", "That battle left me a mere mercenary for hire with no men to his name and that is a disgrace for one who was once the captain of a free company and a count of Genoa. You wouldn't have knowledge of a captain hiring men, would you?"),
  ("npc15_backstory_c", "I would be awfully grateful if someone were to take me in, and that person would also find that the advantages of having a barber-surgeon in your employ are many."),
...
### use these if there is a short period of time between the last meeting 
  ("npc1_backstory_later", "I've been travelling, trying to rally knights to the Order's cause but thus far I've had little luck. I need to return with at least five knights and their retinues. I will keep trying, however."),
  ("npc2_backstory_later", "I've travelled from estate to estate and have hired myself out as a mercenary, but it is most unchivalrous, and not what my lord would have wanted."),
  ("npc3_backstory_later", "I've been travelling here and about, but people seem woefully ignorant when it comes to my heritage. Some even go so far as to insult me by calling me a bastard. Imagine the nerve! If only I could hire myself out to a proper company of men."),
  ...
  ("npc6_backstory_later", "I have been travelling from here to there, begging where I could and trying to live off the land, all the while asking for those deserters."),
  ...
  ("npc8_backstory_later", "I've been travelling, looking for someone to fight with. I can't be a soldier on my own, so I need to find a mercenary company soon, else I'm doomed to starve in this land."),
  ("npc9_backstory_later", "I've gone around the land, offering service to this lord and that, but other than unmarried ones who are too poor to even sustain a household knight, the others all seem hesitant. It seems I am doomed to ever wander."),
  ("npc10_backstory_later", "I've pledged service to a few French lords, but you'd say they were women, not red-blooded men. They tell me I am too hard on their children and they send me away. If only I could find someone who wasn't disdained by a little old-fashioned discipline."),
  ...
  ("npc12_backstory_later", "I travel between cities and settlements, purifying highwaymen and bandits whenever I catch them at unawares. The desperate men created by this war, however are growing in number. Soon, I will not be able to save them by myself."),
  ("npc13_backstory_later", "I have been making my way to Constantinople, yet people seem either not to care or give me false directions. It is a most concerning state of affairs."),
  ("npc14_backstory_later", "I've travelled from one city to another, but there are no free captains hiring."),
  ("npc15_backstory_later", "I've been here and about, trying to find a worthwhile employer, but either I get hired to shave people or I don't get hired at all. Does no one truly need a surgeon instead of a barber?"),
  ...
  ("npc1_backstory_response_1", "I am the leader of one such mercenary company. Perhaps you could join God's banner to my own?"),
  ("npc2_backstory_response_1", "Perhaps you would join my own company? I have need of a good companion who can fight by my side and aid me in battle."),
  ("npc3_backstory_response_1", "Well, matter of fact is, I run a company of mercenaries."),
  ...
  ("npc6_backstory_response_1", "I think I have a good opportunity for you to avenge your wife and child."),
  ("npc7_backstory_response_1", "WIP."),
  ("npc8_backstory_response_1", "You could amass enough of a fortune in my employ through fighting and pillaging."),
  ("npc9_backstory_response_1", "You could join my company for a while. It may not be the court of King Edward, but it's better than nothing."),
  ("npc10_backstory_response_1", "If you're looking for soldiers to train and enemies to fight, I've a large enough supply of both."),
  ("npc11_backstory_response_1", "What will you do now?"),
  ("npc12_backstory_response_1", "Well, you could travel with us, but we might also fight opponents who are more organized than bandits."),
  ("npc13_backstory_response_1", "I could use another sword in my company and it makes no difference to whom you pray at the end of the day, as long as you earn your keep."),
  ("npc14_backstory_response_1", "I myself am such a captain and I might have a use for you in my company."),
  ("npc15_backstory_response_1", "I would have use for a good surgeon, but you would also have to fight with us."),
  ("npc16_backstory_response_1", "I might be. What can you do?"),

  ("npc1_backstory_response_2", "I shall tell you if I find any willing knights, Sir."),
  ("npc2_backstory_response_2", "I am sorry, but my company is no place for glory-seeking youngsters."),
  ("npc3_backstory_response_2", "France is no place for you, you pampered princeling."),
  ...
  ("npc6_backstory_response_2", "There is much hatred in your soul. Try to forget about it."),
  ("npc7_backstory_response_2", "Actually, I'm rather fond of the place. Good day to you."),
  ("npc8_backstory_response_2", "Go find another captain, you grim bastard."),
  ("npc9_backstory_response_2", "I'm sorry, but you appear too dangerous to have around. Good day."),
  ("npc10_backstory_response_2", "I might find a willing lord on my travels. I'll tell you when I do. Farewell."),
  ...
  ("npc13_backstory_response_2", "I am sorry, but I couldn't be seen with someone like you following me."),
  ("npc14_backstory_response_2", "Sorry, but I don't want my men in the hands of one like you. Good day."),
  ("npc15_backstory_response_2", "Sorry but I'm not desperately in need of a shave."),
  ("npc16_backstory_response_2", "Sorry, lass. You sound like you might be trouble."),

  ("npc1_signup", "{Sir/Madame} -- I would be most honoured to fight alongside you and measure the valour of the great knights of the West."),
  ("npc2_signup", "Truly? Your men seem to be of the good sort, and you seem to esteem chivalry, which is hard to find in today's knights, sadly. I would gladly join your company."),
  ("npc3_signup", "You do? Well, I'd gladly join your company."),
  ("npc4_signup", "Good! I look forward to vanquishing your enemies."),
  ("npc5_signup", "Why, that is a most generous offer."),
  ("npc6_signup", "You would have one such as me in in your employ? You will not be sorry for this, {m'lord/m'lady}!"),
  ("npc7_signup", "I might be. I could certainly use the money."),
  ("npc8_signup", "It sounds acceptable. Fine, I'll do it."),
  ("npc9_signup", "You would have me? I'm not one to care about the comforts of an estate or whatnot. Give me coin and foes to slay, and I'm content."),
  ("npc10_signup", "Do you now? Well, we have ourselves a deal, captain. Note, however, that I am rather strict when it comes to discipline. It's life and death in battle, and you can't be careless about training."),
  ...
  ("npc12_signup", "Well, nobles are the greatest sinners of them all. I would be happy to save a few of them in my quest for salvation."),
  ("npc13_signup", "Truly? I cannot believe my ears. May God bless you, friend for you have truly done me a good turn! I will do you many such good turns in battle, to show my gratitude."),
  ("npc14_signup", "You would? It would be my greatest honour to ride with one such as you, for a share of loot and pay fitting one of my rank."),
  ("npc15_signup", "Fighting shouldn't be a problem. Setting broken bones and healing wounds afterwards is the greatest task awaiting. That and a shave, once in a while."),
  ...
  ("npc1_signup_2", "I have fought my own share of Polish and Lithuanian knights, and I have quite a few accomplishments to my name. I have also ridden down a fair number of Tartars so that should tell you a great deal about my horsemanship."),
  ("npc2_signup_2", "I am a better rider than most, better than prince Lionel at least. I am also an earnest swordsman and jouster as many of my tournament opponents can approve. I believe you will find me of great use in pitched battle when there are none to ride at your side."),
  ("npc3_signup_2", "You shall find me a priceless addition to your retinue, for I am skilled both with the pen and with the sword. Well, truth be told, I've not cut down a man yet but there is always time to learn. At least I am good at something other than butchery, unlike some of my half-brothers."),
  ...
  ("npc6_signup_2", "I might not be much of a fighter, but I took my bow with me as I ran from the village. Despite the fact it's outlawed, you see, I did sometimes go on trips through the local lord's domain to see how his animals were doing. The deers were especially healthy, you could tell as much from their red meat. I'm also a tracker, {m'lord/m'lady}."),
  ...
  ("npc8_signup_2", "Despite the fact that there is no love lost between me and my father, he did give me one thing for which I'm thankful. Training. Knight's training. I've trained ever since I was seven since I realised there was nothing better for me. And you will see the fruits of that training in battle."),
  ("npc9_signup_2", "I'm a fair enough rider and skilled with sword and dirk but not many of my foes can attest to that, since I take care not to leave them breathing, unlike some knights who consider it 'chivalrous' to spare foes. I hope, for your sake, you are not one of those fools."),
  ("npc10_signup_2", "I am just as skilled with a sword as I am with training men for war and tournament and I also value common sense more than haughtiness and glory seeking."),
  ...
  ("npc12_signup_2", "In my days as a travelling monk I have learned how to travel light and fast. I also know how to best make due of supplies and I can also soothe any of your men who are having religious doubts."),
  ("npc13_signup_2", "The blade, the lance or the bow, all are weapons that I handle fairly well. Almost as well as your squires or knights, I could say. I admit, though, there are many who are better than me."),
  ("npc14_signup_2", "I have respectable skill with both the longsword and all manners of shorter blades and I can also train your men, seeing as I was once the leader of a company of mercenaries, or Free Lances as we call them in Genoa. "),
  ("npc15_signup_2", "My best skill is healing wounds after battle and making sure the soldier recovers in time. I am also a barber, if the situation calls for it."),
  ...
  ("npc1_signup_response_1", "I am sure you can be useful to our cause, noble knight."),
  ("npc2_signup_response_1", "That would be excellent and we would be happy to take you along."),
  ("npc3_signup_response_1", "And right you are. Get moving, my lord of Scotland."),
  ...
  ("npc6_signup_response_1", "I'm just glad to help a fellow soul. Prepare to leave."),
  ("npc7_signup_response_1", "I will hire you. Try not to shoot anyone on your first day."),
  ("npc8_signup_response_1", "Good enough. Pack your things and be ready to move out."),
  ("npc9_signup_response_1", "That shouldn't be a problem, sir. Prepare to leave town."),
  ("npc10_signup_response_1", "Good man. We were in need of a proper master-at-arms like you, sir."),
  ("npc11_signup_response_1", "It sounds like you'll be useful. You are hired."),
  ("npc12_signup_response_1", "Welcome to our company then, father."),
  ("npc13_signup_response_1", "Make ready then for we leave soon. "),
  ("npc14_signup_response_1", "Good. You sound like just what we need."),
  ("npc15_signup_response_1", "That sounds great. Who knows? I might need a shave while on campaign."),
  ("npc16_signup_response_1", "It sounds like you can do the job. I will hire you."),

#11
  ("npc1_signup_response_2", "I'm not sure if my company is the place for such a warrior. Good day."),
  ("npc2_signup_response_2", "You sound too boastful, and I'd rather not take such risks when my own life is involved. Good day."),
  ("npc3_signup_response_2", "I was rather looking for someone with more experience in the field. Good luck to you."),
  ...
  ("npc8_signup_response_2", "A bastard, and a bitter one at that. I'd prefer discipline to your rage."),
  ("npc9_signup_response_2", "I am sorry, but I value an opponent for his power and skill, and an opponent today might prove to be an ally tomorrow."),
  ("npc10_signup_response_2", "My men might not take too well to someone who is used to tormenting high-born children. You should look elsewhere."),
  ("npc11_signup_response_2", "Sorry, madame. We've already got as many in our company as we can handle."),
  ("npc12_signup_response_2", "My men would not take kindly to a glorified preacher like you. Good day, monk."),
  ("npc13_signup_response_2", "Actually, having you in my company might cause a mutiny. Good luck on your travels."),
  ("npc14_signup_response_2", "On second thought, I would not have an obvious charlatan like you in my ranks. Good day to you."),
  ("npc15_signup_response_2", "I would do better with an actual warrior. Good day, doctor."),
  ("npc16_signup_response_2", "To be honest, I'd prefer someone who was a little less tempted to larceny."),

  ("npc1_payment", "You shall find my uses in time, {sir/madame}, of that you can be sure. Before we leave, however, could you give me a gift of {reg3} Florins? I am afraid that most of my wealth was robbed alongside my baggage train when I crossed the border from the German lands and I have need of coin to pay the inn-keep here."),
  ("npc2_payment", "Wonderful, but there is one more request I have of you. Before we leave, I have need of {reg3} Florins to pay for my equipment and to buy some supplies."),
  ("npc3_payment", "."),
  ("npc4_payment", "Excellent. Before we depart, would you be so kind to lend me {reg3} Florins? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."),
  ("npc5_payment", "Thank you. Now, to seal off our agreement, I ask for {reg3} Florins from you. It's an advice my father gave me. He told me 'Baheshtur, never fight for a barbarian before {he/she} pays you your worth of gold first'."),
  ("npc6_payment", "."),
  ("npc7_payment", "All right then. I will come with you. But I want a payment of {reg3} Florins first. You aren't expecting me to work for free, do you?"),
  ("npc8_payment", "If you'll have me, then give me a purse of {reg3} Florins as a sign of riches to come. I need the money and you need a warrior by your side."),
  ("npc9_payment", "That would be great. But, before we depart, I want {reg3} Florins up-front to make sure I'm dealing with a serious captain who knows how to treat his men, and not some glory-seeking princeling."),
  ("npc10_payment", "That would be wonderful captain, but I require a small sum before we leave as a token of your seriosity as an employer. It's a principle of mine to receive at least a symbolic sum before pledging service to someone. {reg3} Florins should be enough."),
  ("npc11_payment", "Hey thank you captain. But before joining up with you, I would ask for a payment of {reg3} Florins. I know that in war parties soldiers can go on for weeks without seeing any wages. I am wise enough not to sign anywhere without having myself covered."),
  ("npc12_payment", "."),
  ("npc13_payment", "Before I come with you, however, there is the matter of a debt I have to the inkeep here for some tables and chairs I broke in a brawl with two zealous fellows -- {reg3} Florins. Do you think you could pay that out of your purse, to show your friendship?"),
  ("npc14_payment", "And you should know that the tradition in my country is for every Free Lancer to be payed before embarking on campaign. I believe the token sum of {reg3} Florins should do."),
  ("npc15_payment", "Great. But as I've said, I am desperately in need of money. If you had {reg3} Florins to spare, I would be most grateful, captain."),
  ...
  ("npc1_payment_response", "Very well, here's {reg3} Florins. Now, fall in with the rest."),
  ("npc2_payment_response", "Of course, here's {reg3} Florins for your expenses."),
  ("npc3_payment_response", "."),
  ("npc4_payment_response", "Certainly. Here's {reg3} Florins."),
  ("npc5_payment_response", "Well... here's {reg3} Florins, then. Your first payment."),
  ("npc6_payment_response", "."),
  ("npc7_payment_response", "No, of course not. Here's {reg3} Florins."),
  ("npc8_payment_response", "Of course. Here's {reg3} Florins for you."),
  ("npc9_payment_response", "That shouldn't be a problem, here's {reg3} Florins."),
  ("npc10_payment_response", "Of course. Here, {reg3} Florins."),
  ("npc11_payment_response", "Very well, here's {reg3} Florins. Make yourself ready. We leave soon."),
  ("npc12_payment_response", "."),
  ("npc13_payment_response", "Of course, here's {reg3} Florins. Make ready to leave soon."),
  ("npc14_payment_response", "All right, here's {reg3} Florins. You are most welcome in our company."),
  ("npc15_payment_response", "All right, here's {reg3} Florins. Glad to have you with us."),
  ("npc16_payment_response", "All right, here's {reg3} Florins for you. Make yourself ready."),
  ...
  ("npc2_morality_speech", "I hope you don't mind my saying so, but I am rather dismayed to see us {s21}. Perhaps I ought to be more open to such things for such is the way of war, but if we could show some mercy to our foes as is chivalrous, I'd sleep better."),
  ("npc3_morality_speech", "I do not know if I should say this, {sir/madame}, but I admit that I am somewhat surprised that we {s21}. I knew war was cruel, but not like this. The bards and minstrels should have a word with me for the truths of this 'chivalrous' war."),
  ...
  ("npc6_morality_speech", "Begging my pardons and all, {m'lord/m'lady}. I joined your company to avenge my slain family and I knew what I was up for, but I did not expect to {s21}."),
  ...
  ("npc8_morality_speech", "I was not pleased that you decided to {s21}. Retreating like a coward back to a life of nothing is weak. We should have fought until the bitter end."),
  ("npc9_morality_speech", "{Sir/Madame} -- it is not my way to {s21}. I may not pander to the standards of chivalry that all other knights adopt, but such acts are shameful nonetheless."),
  ("npc10_morality_speech", "Begging your pardon, captain. I can't say that I'm happy to see us {s21}. Those are just simple people, trying to make a living. If the land does not have common folk to work it, then it will grow into a wasteland and we would be out of a job."),
  ...
  ("npc12_morality_speech", "Captain -- I do not like to see us {s21}. I set out on this journey to set sinners on the path to salvation and to labour for the salvation of my own soul. This is foul work, and I'll not consent to it."),
  ...
  ("npc14_morality_speech", "I don't mind to {s21}. No one with a reputation for cowardice will be esteemed by his men."),
  ...
  ("npc1_2ary_morality_speech", " {Sir/Madame}-- I've no quarrel if we {s21}. After many a hard year of fighting off Tartar raids and Ruthenian uprisings I've learnt the value of preserving one's strength in favour of chasing battle foolishly."),
  ("npc2_2ary_morality_speech", "{Sir/Madame} -- I'm not very pleased that we {s21}. I am a knight above all, and in our lives one is bonded by one's given word. I don't want a reputation for dishonesty -- that would spell my end as an esteemed and chivalrous knight, {sir/madame}."),
  ("npc3_2ary_morality_speech", "{Sir/Madame} -- I believe that it was a wise decision you took to {s21}. Better sacrifice some base curs for the rescue of their betters. Their souls will be better off for it."),
  ...
  ("npc6_2ary_morality_speech", "{m'lordship/m'ladyship} -- it may not be my place to question you but I don't like it when you choose to {s21}. I hope you're not upset and all."),
  ("npc7_2ary_morality_speech", "[No secondary moral code]"),
  ("npc8_2ary_morality_speech", "[No secondary moral code]"),
  ("npc9_2ary_morality_speech", "Captain, I am dismayed that you {s21}. A {gentleman/gentlewoman} should at least try to be trustworthy in front of these nobles."),
  ("npc10_2ary_morality_speech", "Captain -- I can't say I like to see us {s21}. If the men are treated with neglect, then they will hesitate in battle and that will lead to defeats."),
  ...
  ("npc14_2ary_morality_speech", "Captain -- you should not let it bother you that you {s21}. Armies are made to do their leaders' bidding, and hardships are part of an earnest mercenary's career."),
  ...
  ("npc2_personalityclash_speech", "{Sir/Madame} -- as you recall I was a squire before I joined your company. I respect men who fight bravely and show both skill and compassion to their foes."),
  ...
  ("npc8_personalityclash_speech", "I have a problem, sir, and I'm not one to tarry about. My matter regards {s11}. That bloodthirsty barbarian slays men as he sees fit in each battle, yet makes calls for us to recant and seems to hold himself as holier than all of us."), 
  ("npc9_personalityclash_speech", "Sir -- {s11}, that Saracen you have travelling with us, isn't one to trust in a battle."),
  ...
  ("npc12_personalityclash_speech", "My good captain, I must bring to you my complaints about our nonetheless righteous company. That Scottish blade-for-hire, {s11}, is a godless bastard who holds no respect for the heavens above."),
  ("npc13_personalityclash_speech", "Captain, I am insulted by {s11}, who belittles me for my faith and for my belief in chivalry."),
  ...
  ("npc2_personalityclash_speech_b", "I don't much care to hear {s11} boast about the defenseless caravans he has looted, or he plans to loot, for that renders him as a lowly cutthroat in my eyes."),
  ...
  ("npc8_personalityclash_speech_b", "Does {s11} not know that, despite his way of life, murder is still a capital sin? Even I know that, and all above know I'm not awfully religious. Either way, that one will be rotting in hell, either by my hand or by our foe's. That's all I have to say about the matter."),
  ("npc9_personalityclash_speech_b", "Have you seen him in battle? Have you seen how he fights? He fights like he is dancing with his opponents, with narry a thread of hate for them or their religion, like a good Saracen should. The bastard also seems to be more chivalrous than some of the knights around here. He will get either himself or some of us killed eventually. That is all, {sir/madame}."),
  ...
  ("npc12_personalityclash_speech_b", "I saw that he had a troubled look about him and asked him if he wished to confess his sins, which I am sure are legion. The ungrateful soul almost turned to hit me when I made him that offer, saying that I shouldn't utter the name of God. Such acts of blasphemy must not be tolerated, my lord!"),
  ("npc13_personalityclash_speech_b", "He calls me naive for the fact that I hold a foe as a friend after the battle, even if he wronged me before. It is only the way I would like to be treated myself, so I do so unto others as well. He also tells me I fight like a tourney knight but I am not sure if that is a slight. Please tell him to cease insulting me or it shall come to blows, and I fear he shall be worse for wear afterwards."),
...
### set off by behavior after victorious battle
  ...
  ("npc2_personalityclash2_speech", "{Sir/Madame}. If you don't mind, I would prefer not to have to ride together with {s11} after what happened during the last battle."),
  ("npc3_personalityclash2_speech", "{Sir/Madame}. I've been relatively content since I joined your company, but I must admit that some things have irked me. Our pay has been acceptable, and so has the loot, but your choice of companions is simply unacceptable."),
  ...
  ("npc6_personalityclash2_speech", "{M'lord/M'lady}. Did you see that Saracen, {s11}, in our last fight? He fights as well as any man-at-arms, though any of our knights would rip him apart, but what really makes me angry is how he treats me during and after the battle."),
  ...
  ("npc8_personalityclash2_speech", "Captain, I wish to have a word with you about your choice of companions. I see that you have allowed my arrogant half-brother {s11} to join the company. Thinking of your kindness and skill as a warrior, I thought to ignore him but I can abide his repulsive behaviour no longer. He presumes to think himself better than me, simply because his mother is noble and mine is not. He is a bastard all the same, though."),
  ("npc9_personalityclash2_speech", "{Sir/My lady}, you might not find this of note, but {s11}, the grieving squire, is reckless and endargers both his own life and the life of his companions during battle. During that last battle, he fought a foe to submission, then turned his back on him like they were simply sparring."),
  ("npc10_personalityclash2_speech", "Captain -- I've a few complaints about that {s11} character, the one who claims he was Count of Genoa."),
  ...
  ("npc12_personalityclash2_speech", "Captain. I can stand {s11} and his gross iniquities no longer. After the last battle, I was travelling across the field of battle allowing wounded enemies their last prayers before their eventual communion with the Lord when suddenly this glorified barber comes along and tries to stop me!"),
  ("npc13_personalityclash2_speech", "Captain, I've a concern. {s11} shouldn't fight in our company. I, at least, will not fight with him along my side, and God is my witness in this!"),
  ("npc14_personalityclash2_speech", "Sir. {s11} is dangerous for the morale of the men. During the last battle, I was telling them to be all that they can be and dance through their foes like my own Free Lance did. They were getting excited when suddenly he appears and tells them to stand firm in formation and not over-extend themselves."),
  ("npc15_personalityclash2_speech", "Captain -- I must tell you that I am in doubt whether {s11} is completely sane. After our last battle, I saw him walking around the enemy dead and wounded, battering those who still drew breath until they joined their comrades. I naturally rushed to stop him, since those foes could be ransomed afterwards for quite a sum but the madman swung one of his clubs at me!"),
  ...
  ("npc1_personalityclash2_speech_b", "The way she whistles cheerfully as she does it -- it puts a chill down my spine, it does."),#ulrich - klethi 
  ("npc2_personalityclash2_speech_b", "We were charging through the enemy ranks, and I sought out a worthy foe to battle, so as to make Lord Graham proud of my exploits. After finding one, I fought him for what seemed like an hour until I finally made him yield and captured him. As I went off to find another foe, Enguerrand comes along and casually slits the throat of my former opponent. I swear it Captain, this matter will come to blows if ever it happens again."), #nicholas - enguerrand
  ("npc3_personalityclash2_speech_b", "I've seen that you associate yourself with cur of the lowest description like my savage bastard-brother. During the last battle he actually came close to attacking me, one of his own blood, though my blood is purer than his. He motivated his heinous act by saying that I wasn't throwing myself blindly forward like he was. How can you allow such madmen in your fine company? I assure you, though, things will not be like this much longer."),#Red Stewart - Black Stewart
  ...
  ("npc6_personalityclash2_speech_b", "In the fight he crossed paths with me and didn't even lift a finger as I was fighting for my own damned life! I'm just another infidel to him, after all. But after the battle, the bastard looks me down as I pass him trying to find something of worth to loot and he tells me that all thieves and law-breakers shall be punished in this life or after it. You can be sure that he did some of that Saracen witchcraft on me, the devils are famous for it after all!"), #hugues - ismail
  ...
  ("npc8_personalityclash2_speech_b",  "In the previous battle I saw him trying to direct the course of the battle from the rear and looking to avoid entering into combat at any cost. After the battle I passed him by, nursing a bruise on my arm and he told me I was a fool for risking my life in battle for anyone on a whim. You should know that he is referring to you when he says that. I cannot abide insults of any kind and would have struck him down there and there, brother or no brother, but I thought better of it and decided to let him live. Know, though, that this party will suffer if you keep him any longer."),  #tblack stewart- red stewart
  ("npc9_personalityclash2_speech_b", "Since he had turned his back to his foe, nothing was stopping him from pulling a dagger and stabbing our young friend in the back. So I slit the bastard's throat before he could get up. The odd thing is, the squire gave me the oddest of looks after I killed his former enemy. He is a skilled fighter, I will give him that, but he is more acquainted with tournaments where your foe is also your friend. If he is to survive long enough to avenge his fallen lord, he must learn these things."),# enguerrand - nicholas
  ("npc10_personalityclash2_speech_b", "He was telling me before the last battle of his so-called 'trials and tribulations' in his homeland and how he was unlawfully banished and forced to live the life of a mercenary. No offence, but I've seen dozens of self-made mercenaries like him in ditches with their throats slit. But the thing that most worries me is the advice he gives to the men. He tells them to fight in an entertaining fashion so as to make a good show in battle and impress their employers. That is not discipline!"), 
  ...
  ("npc12_personalityclash2_speech_b", "That Frenchman tried to stop a pious man of the cloth from doing his duties, captain! That is almost sacrilege. I thought of purifying the sinner right there and then, but then I thought you might need him to look to our own wounded so I left him live. Know, however, that if he gets in my righteous path once more, he shall soon be witnessing the Last Judgmenet in tow with all the other sinners and fornicants I have slain."), # father anthony - jacques
  ("npc13_personalityclash2_speech_b", "During the last clash, {s11} and I crossed paths and I saw him fighting a foe in a most devilish fashion. That would not have impressed me, for such things oft happen on the field, but after the battle was finished, I found out who he truly is. How can you travel and fight with one who has broken his lord's law? Such a criminal will be punished, both on this world and the next and you are tempting fate by keeping him close by."), #ismail - firentis
  ("npc14_personalityclash2_speech_b", "{Sir/Madame}, your valiant soldiers were finally getting excited and ready for pitched battle, when he appeared and ruined their appetite for bloodshed. If this company is to succeed in campaigns, it must make a name for itself and that will not happen if men like Sir John keep pulling the man back from their true potential."), #giovanni - sir john
  ("npc15_personalityclash2_speech_b", "I at first thought that the monk was only a preacher who bolstered the morale of the men before and after battle, and made them somewhat more comfortable with shedding blood. But I've seen his true face. He is nothing more than an enraged beast that is hungry for blood. I truly pity the man who let him off his leash."), #jacques - father anthony
  ...
  ("npc1_personalitymatch_speech", "{Sir/Madame}. I must admit that {s11} is quite an admirable fellow from what I've seen of him these past days."),
  ...
  ("npc3_personalitymatch_speech", "Greetings, {sir/madame}. I've been wanting to tell you for some time that {s11} has caught my eye. Did he not fight bravely in our last battle?"),
  ...
  ("npc6_personalitymatch_speech", "Captain. This constant search for revenge I have embarked on sometimes makes me feel drained and I often feel that my wife and son truly are in a better world, now. After all, they no longer have to pay rent, taxes or live the hard life that we had to live under our lord."),
  ...
  ("npc9_personalitymatch_speech", "Captain. {s11} is quite a fine man, bastard-born though he may be. You know what they say, however, about the bastards born of two noble parents. Great bastards, some call them. If by valour and force of arms he would forge his way back towards his homeland, I would gladly serve him there. What better way to insult the nobles than to serve a bastard?"),
  ...
  ("npc1_personalitymatch_speech_b", "His valiance, chivalry and surprisingly meak nature make me remember all that can be considered good in a knight, as opposed to what I've seen my fellow knights do. When I shall return to fighting in God's name on the Prussian marches, I shall try to convince Nicholas to accompany me. He would make a fine member of the Order, and the Lithuanians and Poles and whatever other pagans are out there would grow to fear his name."),
  ...
  ("npc3_personalitymatch_speech_b", "Despite the fact that his manners are rather lacking, and his wit is dry, he is an earnest warrior and a good man with sound principles. He would make a good member of my household, were I to become a sheriff in Scotland. Only if you have nothing against it, of course! Good day, {sir/madame}."),
  ...
  ("npc6_personalitymatch_speech_b", "Luckily, in those moments when my faith falters and I wish to stop killing people to avenge my family, {s11} is always there to bring me back on the good road, as he calls it. He likes to tell me that it takes an utmost faithful Christian to pursue vengeace as bloodily and as indiscriminately as I do. Whatever 'indiscriminately' means, that is."),
  ...
  ("npc9_personalitymatch_speech_b", "Imagine the outrage! A noble-born knight of French stock serving a Scottish bastard of supposedly uncertain parentage. I must admit, though, that he sometimes pretends to be a noble too much. Doesn't he feel embarassed by the fact that he is pretending to be something he's not?"),
  ...
  ("npc1_retirement_speech", "As foe after foe is beaten, it only serves to make me harken back to my Brothers left in the Eastern Marches of Christendom. I cannot bear to know that while I gather glory in France they are fighting an unsung war against the Heathen for the sake of all Christianity. My time under your lead has given me knowledge, and has made me wise in the ways of war. I shall put this wisdom to good use. Thank you and farewell!"),
  ("npc2_retirement_speech", "I am getting weary from all this bloodshed. It's not that I don't appreciate your kindness or your valour, but I've shed enough blood and slain my share of enemies thus far. I know, in my heart, that Lord Graham would be pleased of me and my showing. I think it is time to seek out a proper lord and offer my service to him. Farewell {sir/madame}."),
  ("npc3_retirement_speech", "I have some bad news for you, captain. I have travelled with you as much as I could, and I have fought well, I deem. Bitterness, however, seems to have taken rule of this company instead of good will and honour. I believe that some members of this party are to blame for that. I hope my fortunes will increase back in Scotland, {sir/madame}."),
  ...
  ("npc6_retirement_speech", "I joined the company to avenge my loved ones, slain with no reason. I think, though, that I have done in this time more than my share of crimes and unreasonable things, spurred on by men greater than me. I think it is time to go back to my usual life, for I am tired of war. Farewell."),
  ...
  ("npc8_retirement_speech", "Captain, I've come to tell that I think it's time I returned to Scotland. I've done well by you, I'll admit, but there are some things in this company are not entirely to my liking. Who knows, perhaps I will enter some lord's retinue and receive the title of sheriff or whatnot. If I have that luck, don't think to visit me because I wouldn't be able to afford many travellers in my hall."),
  ("npc9_retirement_speech", "We have fought long and hard together, and I am proud to say I have met such a captain as you and fought beside you in many a battle. But there comes a time when even a man like me gets fed up with all the stupidity around him and all the chivalrous glory-seekers who risk their lives in vain. I hope you manage to deal with them. Until we meet again, farewell captain."),
  ("npc10_retirement_speech", "War is tiresome. Did I ever tell you that? It sapps one's strength until it leaves you a husk of what you once were. I've had enough of it for now. Your men are well trained and I could even say they show discipline when it matters, but I've had enough. I think I'll go back to York and try to settle down and raise a family of my own. Good luck in your travels, {my good sir/my good lady}."),
  ...
  ("npc12_retirement_speech", "I've cleansed my share of sinners so as to do Saint Peter proud but I've been hearing of more unrest in the German lands. It seems they are not much different than the lands of these Frenchmen that we try to call our own. God's work is never done, as well you know, so I think I shall take my leave of your company and seek my fortunes there. Godspeed my child."),
  ("npc13_retirement_speech", "As I lay in this land, travelling with you and slaying Infidels both English and French, I feel that my blade is sated and I tire of these Christian lands. I long for the company of other Muslims, to whom I can speak in my own language. God willing, I will pass through the Spanish lands without harm. May peace be with you, friend and luck also!"),
  ("npc14_retirement_speech", "Commander, I am sorry to announce you that I am leaving your brave company. I believe I have made enough of a name for myself to return to Italy and try to reclaim my title as count. If I succeed, I will have you to thank and, if ever I have need of good soldiers, be sure that your company is the first one I will come to. Best of luck in your travels!"),
  ("npc15_retirement_speech", "I thank you for taking me in at a time when others would not even look at me, but a man can get tired of endless war. I am a surgeon at heart, and I would like to use the knowledge I've gained in a more peaceful environment, like a college or university. People there might also need a shave. Farewell, captain."),
  ...
  ("npc1_rehire_speech", "{Sir/Madame} -- I am happy to see you again, though I wish this meeting were in Marienburg and not here. Alas, I was once again taken at unawares by leaderless knights at the German border. The borders are beyond my power to pass, for the moment. It seems I shall have to bide my time here so I thought I should at least do it with someone I know and someone I've fought with before. It would be my honour to fight alongside you once more. Will it be yours?."),
  ("npc2_rehire_speech", "{Sir/Madame}! It is good to see you once more. I feared that your life had been finally claimed by some valorous adversary in this cruel and bloody war but it seems I was mistaken. Your fame, however, has grown with every battle won and each foe slain and I've been proud to say I once served with you. I have not been so successful, though. I've fought in my share of tournaments, but I still long for the feeling of chivalry that came from battles fought with you. Would you have me serve with you once more?"),
  ("npc3_rehire_speech", "Well, greetings {sir/madame}! I am glad to see you again. My fortunes were scarce better in your absence. I barely made my way North to Caen and already I had been accosted several times by brigans and highwaymen. What with this war, these scum have caught heart and have begun approaching travellers in broad daylight. With what wealth I had won fighting for you squandered by errant bandits, I have come to the conclusion that I must fight for you yet more, until I am worthy to return to my father's noble presence. Would you have me once more, noble captain?"),
  ...
  ("npc6_rehire_speech", "Remember me, {m'lord/m'lady}? I am Hugues, your faithful servant and tracker! You might remember that I wanted to return to a normal life, but I'm sad to say that things can never be the same now. I've killed. I done...wrong things. People do not look at me the same way and commoners do not accept me as their own. I have nowhere else to go. Seeing as this is the only place where I'm welcome, can I serve you some more?"),
  ...
  ("npc8_rehire_speech", "{playername}, good to see you again. I've tried to find a ship that would take me at least to England since I could travel to Scotland on my own from there and it would be cheaper as well but those Englishmen up in Northern France charge some ludicrous prices for passage to their homelands. So I thought I would soldier here some more, maybe curry some favour with a nobleman while I'm at it. So, do you have a need for me, despite our former bitterness?"),
  ("npc9_rehire_speech", "You can't imagine how glad I am to see you once more {playername}. I swear, this land is going to hell in a hog cart, and no one is doing anything to stop it. I thought my Armagnac kinsmen would be wiser than the Valois, but they are just as foolish like the others. It seems like the love of money has disappeared from the land and 'chivalry' and 'honour' are all that matter now. I long to serve under a worthy captain once more. Could I fight with you once more, in spite of all I've said?"), #Enguerrand
  ("npc10_rehire_speech", "Captain! It pleases me to see you are doing well. Word of your exploits has reached even England and many nobles are talking about you in hushed voices. At least that is what my uncle tells me. As for me? Well, I tried to find a wife, but I swear there are only hags and and children left to marry in England now. It's back to war for me I guess. Do you still need a master-at-arms to train your men?"),
  ...
  ("npc12_rehire_speech", "Ah, the Champion of Christ! It does my heart proud to see you captain. Even in the German lands they talk of your exploits as a great captain of war. It seems you've cleansed your fair share of sinners in my absence. Well, that shouldn't be a concern any longer. The German countries were sorrowfully at peace and were not fit for a man of the cloth like me. So I came here, knowing I would surely find some employer who could help me on my quest to save all sinners and fornicants. Are you still hiring?"),
  ("npc13_rehire_speech", "Peace be with you captain! You may be wondering what I am doing here yet again. Well, truth be told, crossing the mountains on the border of France and the Spanish lands was harder than I thought. I was waylaid by Basques, and they hate us Muslims as much as they hate the Spaniards. Perhaps, if I stay here a while longer, I might find passage through the mountains with a caravan that does not scorn my presence. Can I ride with you, until then, a little while longer?"),
  ("npc14_rehire_speech", "Captain! It does my hear great pleasure to see you again! I could not say the same for those filthy noblemen in my native Genoa, however. It seems they have no consideration for war veterans who return from foreign lands to reclaim what is rightfully theirs. I could not find nearly enough men on the way since it seems they are all here, either fighting with you or against you. Well, if my fellow Genoese sellswords find it wise to serve in France, then I will do as they do. Do you still have need of me in your Free Lance?"),
  ("npc15_rehire_speech", "Why hello, {playername}. I am rather pleased to see you. The colleges in Oxford and Cambridge wouldn't have a French doctor like me. They actually told me to take my barber skill to London since people there might need French shaves. The nerve! It is now that I realize how good a life I had in your company. Wounded to heal, foes to slay and loot to collect. Since I can't earn my keep in peace, I shall have to return to war. Will you help me once more?"),
...
#local color strings
  ("npc1_home_intro", "You should know that you westerners have quite an easy time here. The weather is mild, your foes are reasonable men who speak a similar language and the common-folk aren't savage barbarians who will gut you as soon as talk to you. Here, you don't even have to line the inside of your armour with furs to keep you warm. You have too much of a good thing to appreciate it, to tell you the truth."),
  ("npc2_home_intro", "Ah, we are approaching the site of one my fondest tournament triumphs."),
  ("npc3_home_intro", "Hm, I was thinking about bastards lately, captain. Dreadful name if you ask me, though some deserve it. I would prefer the term children born out of wedlock, personally. An awfully hard life we live."),
  ...
  ("npc6_home_intro", "The villages I saw on the way here remind me of home. A mere cot risen from the dirt it was, yet it was mine. Mine and my family's. We peasants live a hard life, {m'lord/m'lady}. I like calling you like that. Better than my former lord. Or any lord for the matter."),
  ("npc7_home_intro", "Do you smell that? Salt fish, rotting flax and river mud. The smells of my childhood. I want to retch."),
  ("npc8_home_intro", "I remember when I first came here, I wondered how it would be in another country. France. Just the name of it has you thinking of chivalry and noble knights."),
  ("npc9_home_intro", "Hm, we are getting closer to my lord's former estate. I still remember the months spent in his service. I couldn't say that they were wasted months of my life, because I got to trounce his squires and sons in the training yard each day until they could take no more. The funny thing was, since they were chivalrous to the bloody bone, they couldn't just yield at the first drop of blood. But then his over-eager wife appeared."),
  ("npc10_home_intro", "We are approaching the first French domain in which I served as master-at-arms. It was an interesting experience to say the least."),
  ("npc11_home_intro", "I see the mountains. We must be getting near home."),
  ("npc12_home_intro", "We are close to a site of great iniquity and sin. It would be best if we didn't linger."),
  ("npc13_home_intro", "Such beautiful castles here in France. I don't know how you people can suffer the cold of Winter, however. I come from Granada and there, it is always warm and pleasant. And so peaceful."),
  ("npc14_home_intro", "You see that castle aye? That was my first assignment in this land of turmoil my friend. I was supposed to train the lord's men in the Italian style of combat and train them I did. The lord of the domain was so fond of my methods, he soon had me teaching his squires and his sons the same methods. But I learned one important thing about these Frenchmen in the process."),
  ("npc15_home_intro", "That is the castle where I was employed as the lord's personal doctor and barber shortly before I met up with you. My memories of it are rather pleasant."),
  ("npc16_home_intro", "Aye, captain, do you see those? Those are hare tracks in the snow. We must be getting near to my birthplace."),


  ("npc1_home_description", "And your foes are human, flesh and blood, most importantly. I swear by my sire's bones, the Poles, the Lithuanians and most importantly the Ruthenians are not of God's making, though this may be heresy. The Polish knights, though they may be arrayed similarly to the ones you see here, have a resilience unlike many others given unto them by the cold wilderness they live in. And the Ruthenians, with their animal furs that give them the strength of bears. And I don't have to mention the Tartars, who ride as if they were united to those shaggy beasts they call horses."),
  ("npc2_home_description", "I was travelling with Lord Graham through France since he was going to pay homage to Edward the Third at Calais, but we stopped in Paris on the way. There was a tournament for squires going on at the time, and Lord Graham graciously allowed me to enter and test my skill against all the other squires. I entered the tournament and rode against several squires who were all older than me. There was even one squire who was as old as my master, a man grown in his own right. But what makes me smile when I think back to that day is the thought that I defeated a Prince of England."),
  ("npc3_home_description", "Some bastards have it lucky from the start, especially the bastards of kings. Well, I am one but my father hasn't been quite gracious to me, as of yet. Perhaps he still wishes to measure my worth. At least I know, in my heart, that I am of better quality than some of my half-brothers. I may not fight as well as them, but God is my witness when I say that I can grapple with the best of them when it comes to things like managing the supplies of an army or strategy. I dare to say that like most Scots, I am naturally clever."),
  ...
  ("npc6_home_description", "My life was a long row of harvests and hard labours, until those deserters came along and burned my village. They freed me in a way, so I'd as like be grateful to them, if they didn't kill almost everyone. Bloody robber knights. I wasn't really a good serf, though since I despised my lord and didn't pray for his health each and every night as a good serf should. I also hunted on his estates and relieved him of many a deer and stag. They was good eating, though."),
  ...
  ("npc8_home_description", "Bah. They kill each other here just like at home. It's just that here, there's a war going on, so all the more reason to kill each other if they have a good excuse at hand. Well, not so easy if you're an Englishman killing other Englishmen but still, not like anything is really holding you back. Love of one's country? Don't make me laugh. What surprised me, though, is how many mercenaries these French use. You see Germans, you see Italians, hell you even see Scotsmen!"),
  ("npc9_home_description", "She found the fact that I beat her sons in the training yard without a single consideration for their higher status as very attractive. And since I'm never one to turn a willing woman down, things went from bad to worse. I understood her, though. Since her husband was somewhat old, he might have forgotten which direction was up. One night, I took her in the lord's own bed while he was away on a hunt. I guess hunts were the only occasions when he could actually kill something with his own feeble hands, because he was too old to ride out and fight like the younger lords. Imagine my surprise when I saw him entering the bedroom, sword in hand."),
  ("npc10_home_description", "Now, when I first came to France in search of employment I came here thinking to serve only English lords, but it turned out that most of them had their own masters-at-arms and not many of them were actually English. Many of them were foreigners, mostly mercenaries come to take advantage of this war-torn land. That saddened me but soon I was forced to pledge service to a French lord and become something akin to a mercenary myself. Now I went there thinking the Frenchmen would be push-overs but I was surprised to see that they were able fighters as well as exceptional riders."),
  ...
  ("npc12_home_description", "That castle yonder was the first and only castle in which I served as a chaplain shortly before I retired to a monastery. I ministered to the lord and his family. Well, mostly his wife to be honest, since the master of the domain and his sons weren't much at home. They were often travelling to some tournament or other, or off hunting. That left me alone with quite an amount of wine and a woman who was awfully lonely. But my virtue was strong, and I never touched the lady of the castle. The wine, however, was another matter entirely I'm afraid."),
  ("npc13_home_description", "The Spaniards, however, are ever encroaching on our peace. Their outriders, the hidalgos as they call them, always raid our border villages, killing and burning as much as they can before our own riders can fight them. Then we strike back, and burn some of their own villages. It has been like this ever since I was born, and it will probably be like this after I die."),
  ("npc14_home_description", "Now I came here thinking that these French are one people, not like us Italians. We're a divided people and only a foreigner will call us Italians. Among ourselves, we are either Genoese, Milanese, Florentines, Venetians and many more cities and countries in between. These French are the same. They are all Armagnac, Bourbon, Valois or what have you. I thought them wiser but this is why the English keep defeating them. The English are united under one king and ruler, the French...not so much, sadly."),
  ("npc15_home_description", "I say this because I truly was a man being paid for doing nothing. Since the lord was rather uninterested in matters of war or tournaments, he rarely if ever got hurt. He was also in the best of health so there was no need to cure diseases. He sometimes need the occasional shave, I must admit, but all in all I spent my mornings admiring the countryside from the battlements and my evenings reading from old books."),
  ...
  ("npc1_home_description_2", "Remember my friend. You have not seen the terrors God's green earth can offer you if you haven't spent a winter in the furthest reaches of Prussia, where the demons of old still hold sway."),
  ("npc2_home_description_2", "During my last tournament match, I fought against a tall squire who wore a full helm, worthy of a knight. Despite the heat of the day, he had his visor down and as for heraldic arms, he bore none on his shield, merely a sable field. His skill was surprisingly poor for all his impressive panoply but he was still defiant and he defended his honour fiercely. At the end of the match, however, he was beaten and I requested him to take off his helm and show himself. He did so, and imagine my surprise when I saw that I had just battered Prince Thomas of Woodstock. He praised me on my skill, as a gentleman should then asked me who my lord was. I will treasure that day for as long as I live."),
  ("npc3_home_description_2", "Of course, I may be wrong, since there are so many brave peoples on God's green earth, but who have suffered more than the Scots? The English have tried so many times to conquer us and make us bend the knee to them, but heroes like Wallace or Robert the Bruce have kept our country free. For how long, I wonder? I believe that, if we were as clever as we hold ourselves to be, we should ally with the English and make them our friends. Then, we can sapp the strength of their kingdom from the inside, and make it ours. What force of arms cannot accomplish, wise diplomacy and scheming can. But I dawdle. I wonder if we can find supplies in that town yonder. I'm aching for a warm meal."),
  ...
  ("npc6_home_description_2", "I imagine though that his men would have hung me nice and proper if they was to catch me in the forests. A life of hiding from m'lord's men in the bushes and tall grass, and even in bear dens has taught me to be aware of tracks on the ground, and of my surroundings. I think I could have made a good scout if I wasn't a peasant. Be that as it may, I'm glad you found me. Who knows what I would have been if you didn't. Hanging by my neck in a town square, as like since I doubt I'd have been a good robber."),
  ...
  ("npc8_home_description_2", "These French seem to think that if the English longbows are so bloody common among the English, why not have their own? But they bring it up a notch! They're French, after all. They have their longbowmen, Scottish longbowmen mind you, be a company of elite troops and usually follow the king around! Compare that to plain English longbowmen that are usually peasants. Yes, skilled and dangerous peasants but peasants all the same. But I feel slighted when I look at all these Scots coming here to put their lives on the line for France. If only the bastards did that for their own country, the English wouldn't be holding us by the balls, like they are now."),
  ("npc9_home_description_2", "I could have slain him there and there, but I deemed not to do so for the sake of his wife. When she started saying that I had seduced her, however, I could have strangled both of them. Luckily for them several guardsmen stormed into the room. Then that duel took place. After my lord died, his estate was inherited by his younger son, who now rules it. I think you can imagine his anger if he were to see me now and my anger at the sight of his whore of a mother would be even greater. You can understand if I'll wait for you in the tavern, right?"),
  ("npc10_home_description_2", "Of course, these Frenchmen couldn't hold a candle to hardened English knights when on foot, but mounted on one of their destriers, they might just stand a chance. If ever there is an open-minded commander in this land, he would have French horsemen and scouts along with English footmen and archers. Few could beat such a host, and I would wager my life on that, captain."),
  ("npc11_home_description_2", "The Swadian king will tell you that Praven was the biggest city in Calradia back under the Empire, and that's why he should rule the whole land today. Mind you, I don't care much about politics, {sir/madame} -- I've sold provisions to every army that ever marched in Calradia, and I tell you that I wouldn't give a single one of them a single biscuit unless I had the cold, hard Florins in my hand first. Why these high and mighty kings and nobles can't pay their bills, I'll never know. But I prattle on a bit, there, don't I?"),
  ("npc12_home_description_2", "One bad turn came to another and I was eventually caught by the castellan while I was drinking the chapel wine. I was also taking some liberties with a scullion. But that is not what matters! I have since reedemed myself by leading the souls of many repentant sinners to salvation, whether they wished it or not. The Lord does work in mysterious ways, wouldn't you agree, captain?"),
  ("npc13_home_description_2", "Now, though, these English who also fight the French here have gotten involved in our wars, and it might be to our favour. The crown of the king of Castile, King Juan, is contested by the English prince John of Gaunt who claims that his wife, Constance I believe, is the rightful queen of Castile. Matters are complicated, but from what I understand, the father of King Juan, the late King Enrique, who was a bastard of the former King Alfonso the Eleventh, took the crown by killing his half-brother Pedro, who was Alfonso's rightful son. Constance is Pedro's daughter, so she has royal blood and could claim her cousin's throne. God willing, Granada will come out better from this conflict."),
  ("npc14_home_description_2", "But then again, that is good for us Genoese, and for our rivals the Venetians and for any Italian actually coming here to sell his sword, or his crossbow, or increasingly enough, his halberd. The Swiss, however, are doing the same thing and so are the Germans. But if someone were ever to unite the French, I doubt that all the mercenaries in this world could hope to stop them from defeating the English. I doubt that will happen even in fifty years, however."),
  ("npc15_home_description_2", "The old leather-bound tomes had been passed down over the generations, and the castellan told me that the oldest of them dated back to the time when Charlemagne was King of the Franks. You can imagine how long ago that was, captain. The old tomes spoke of many things, from healing to the history of France. But alas, the lord and his family have little interest in them and the castellan only kept them in good condition out of habit, not appreciation. I fear that, if this war does not end soon, such arcane knowledge will be lost and our sons and grandsons will not learn anything from those glorious times. Let us hope that together, we will bring this troubled land to what it once was."),
  ...
  ("npc1_home_recap", "Though I do God's work in the lands of the Order, I am from Germany."),
  ("npc2_home_recap", "I am an Englishman born-and-bred. I lived in the countryside near London for most of my childhood."),
  ("npc3_home_recap", "I was born in Scotland, like much of my low-born brothers and sisters. Unlike them, however, both my parents are noble."),
  ...
  ("npc6_home_recap", "I'm a mere peasant, {m'lord/m'lady}. I used to have a family of my own but they was killed."),
  ("npc7_home_recap", "I was born in a hovel in the fens, not far from {s21}."),
  ("npc8_home_recap", "My mother birthed me in Scotland, and there she remains along with my so-called father."),
  ("npc9_home_recap", "I am an Armagnac Frenchman born and raised in our heartlands."),
  ("npc10_home_recap", "I was born in Northern England, close to York, captain. I've been master-at-arms to many lords and knights ever since I was twenty."),
  ...
  ("npc12_home_recap", "I am an Englishman yet I was born here in France. I follow God's calling."),
  ("npc13_home_recap", "I am from Spain, my {lord/lady}, from the once great Emirate of Granada."),
  ("npc14_home_recap", "I was once a count of Genoa, but was unlawfully exiled."),
  ("npc15_home_recap", "I was born in Paris and have followed the profession of surgeon ever since I left my home. I am also a barber of some skill."),
  ...
  ("npc1_honorific", "{sir/madame}"), #ulrich
  ("npc2_honorific", "{sir/madame}"), #nicholas
  ("npc3_honorific", "{sir/madame}"),
  ("npc4_honorific", "{sir/madame}"),
  ("npc5_honorific", "{playername} Bahadur"), #beheshtur
  ("npc6_honorific", "{m'lord/m'lady}"), #hugues
  ("npc7_honorific", "captain"), #deshavi
  ("npc8_honorific", "{playername}"), #black stewart
  ("npc9_honorific", "captain"), #Enguerrand
  ("npc10_honorific", "captain"), #Sir John
  ("npc11_honorific", "{laddie/lassie} -- I mean Captain"), #katrin
  ("npc12_honorific", "captain"),
  ("npc13_honorific", "my good lord"), #ismail
  ("npc14_honorific", "commander"), #giovanni
  ("npc15_honorific", "{sir/madame}"), #jacques
  ...
  ("npc2_kingsupport_1", "Well, captain -- I'd support you. I think you'd give France the kind of enlightened rule which it has long needed."), #marnid
  ...
  ("npc9_kingsupport_2", "I would, sir, and others would too. But here's what I think -- you need to show the noble lords that you'll uphold their ancient rights. Right now, Europe's a mess -- the lord owns the land, except it's the king who owns the forest, but the city has the right to levee tax at its gates, and the commons can use the pastures on odd Tuesdays, except in Dijon when it's Wednesday. Who can remember? So I say you make things simple, like it was in the old days -- first the {king/sovereign}, then the lords, then everyone else."), #Alayen
  ...
  ("npc8_kingsupport_3", "Good! Then give me a few weeks and I'll go about the courts of this land, letting it be known that you're a {king/ruler} who respects the thegns and their ancient rights. You won't go sticking your royal nose where it doesn't belong, and France will be the better for it."), #matheld
...
#
  ...
  ("npc7_fief_acceptance", "Aye, I'll hold {s17} -- and give it a reputation that strikes fear in the hearts of thieves and brigands across France. Thank you, {sire/madame}, for this opportunity."), #deshavi
  ...
  ("npc13_turn_against", "It is sad to meet you as my enemy, Captain -- but on the other hand, to meet such a titan of the battlefield as yourself in combat is a rare privilege. Truly, the news of our contest today shall keep the bards and poets of France in wine and silver for months to come, do you think?"), #nizar
  ("npc14_turn_against", "Well, {playername}. We meet as enemies. I confess that I have mixed feelings. It grieves me to make war on you, but if we meet in battle and I prevail, I will have defeated the worthiest foe in all France, and I will know that my mastery of the military art is complete!"), #lazalit
...
("comment_intro_female_noble_cunning", "It is not unheard-of for a woman to seek her fortune on the battlefields of France, but neither is it usual. I shall be most interested in your progress."),
...
("comment_intro_female_common_cunning", "It is not unheard-of for a woman to seek her fortune on the battlefields of France, but neither is it usual. I shall be most interested in your progress."),
...
("rejoinder_intro_female_noble_sadistic", "Never mind my country. Here in France, it seems, dogs lead men to war."),
...
#steve post 0912 changes begin
  ...
  ("swadian_rebellion_pretender_intro",    "I am Charles the Second, king of Navarre and rightful ruler of France."),
  ("vaegir_rebellion_pretender_intro",     "I am Owain Lawgoch, known as Owain of the Red Hand to the English and Yvain de Galles to the French. I hail from neither, however. I am the rightful king of the Britons and thus of all Britain."),
  ...
  ("swadian_rebellion_pretender_story_1",  "By rights I should be King of France, but the machinations of the French and the iniquities of the English have thus far kept me from what should be mine. From what will, inevitably, be mine. None in the land has better claim to the throne than I for I am born of the fleur de lys on both sides. My father was first cousin to Philip the Sixth of the House of Valois and my mother was the only daughter of Louis the Tenth of House Capet."),
  ("vaegir_rebellion_pretender_story_1",   "Long have the English wronged the people of Wales. Ever since the reign of Edward Longshanks, Hammer of the Scots, Wales has been under English rule and I am angry to see that no Welshman has done anything to stop the bastards. I still remember Edward's deception. A group of Welsh nobles asked him to name a Welshman Prince of Wales to ensure our loyalty. Longshanks said he would give us a Prince who spoke no English at all and he then presented us his infant son who was as Welsh as I am Italian."),
...
#courtship
  ...
  ("credits_1", "The Hundred Years War Mod"),
  ("credits_2", "Mod Design:^Llew2^-GandalfTheGray"),
  ("credits_3", "Programming:^Llew2^Garnier^kt0"),
  ("credits_4", "Modelling:^Llew2^Lynores ^Luigi^RR_Raptor65^James^The Pop^ThorGrim"),
  ("credits_5", "Texture Artists:^Llew2^-GandalfTheGray^Raz^Ryuta^Thorgrim^Cataphract^RR_Raptor65^DaBlade"),
  ("credits_6", "Writing:^Agent Griff"),
  ("credits_7", "Original Music:^Justin R Durben"),
  ("credits_8", "LOD Support:^killkhergit^SantasHelper"),
  ("credits_9", "Consulting:^MartinF^^^\
Mount&Blade: Warband Copyright 2008-2010 Taleworlds Entertainment^^^\
Physics:^Havok^^^\
...
#multiplayer game type names
 ...
 # ("_age_reg1_family_", "^Age: {reg1}^Family:"),
  ...
  ("s21_cheat_mode_assessment_s14_", "{!}{s21}^Rumeurs: {s14}^"),
  ...
  ("noble", "noble"),
  ("common", "common"),
  ("may_find_that_you_are_able_to_take_your_place_among_calradias_great_lords_relatively_quickly", "may find that you are able to take your place among France's great lords relatively quickly"),
  ("may_face_some_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords", "may face some difficulties establishing yourself as an equal among France's great lords"),
  ("may_face_great_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords", "may face great difficulties establishing yourself as an equal among France's great lords"),
  ...
  ("khan", "khan"),
  ("i", "I"),
  ("according_to_the_ancient_law_and_custom_of_the_calradians_s45_should_be_s47", "According to the ancient law and custom of the French, {s45} should be {s47}"),
  ...
  ("you_plan_to_marry_s4_as_you_have_no_family_in_calradia_he_will_organize_the_wedding_feast", "You plan to marry {s4}. As you have no family in France, he will organize the wedding feast."),
  ...
  ("you_will_not_be_disappointed_sirmadam_you_will_not_find_better_warriors_in_all_calradia", "You will not be disappointed {sir/madam}. You will not find better soldiers in all France."),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_1", "Sir {s0}"),
  ("faction_title_male_2", "Sir {s0}"),
  ("faction_title_male_3", "Sir {s0}"),
  ("faction_title_male_4", "Jarl {s0}"),
  ("faction_title_male_5", "Sir {s0}"),
  ...
  ("killed_bandit_at_alley_fight", "The holy man takes you to his house. Once inside, he stands by the door for a while checking the street, and then, finally convinced you have not been followed, comes near you to speak..."),
 ...
 ("journey_to_reyvadin", "You have come across the choppy waters of the English Channel to Cean, in Northern France. The land about the English-held town looks well tended and peaceful, with the peasentry going about their daily labor. Yet here and there can be seen the burnt out shell of an old building, or a grassy ditch from seige-works of years ago. Grizzled men look up from hoe or scyth, bearing scars of a conflict old enough for tales but fresh enough for sorrows. As you enter Cean, a band of soldiers in gleaming harness laugh and jest as they ride out through the gate. There is war still, upon the air."),

 ("journey_to_praven", "You joined with a band of pilgrims, although your intent may not have been as pure as theirs. Lands of scorching sun; green, sweet-scented vinyards; high castles on their hills or thick walls of towns. You have come by many ways to the city of Dijon, in the East of France. There may be a shrine here, but it is not what you have come to see. No, there is rumor of war on the sea-breezes. France has been sorely aflicted with peace since a certain treaty with the English throne, and you are here to have a say in the matter, one way or another."),
