...
##### Dungeon Water Drops  END #####
    ...
    ("pine_leafs", psf_billboard_2d | psf_always_emit, "prt_mesh_pine_leaf_a",
     1, 9, 0, 0.025, 4, 4,      #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1), (1, 1),            #alpha keys
     (0, 0.5), (1, 0.5),        #red keys
     (0, 0.5), (1, 0.5),        #green keys
...
#goeland
    ...
    ("goutes", 0 | psf_always_emit, "prtcl_rain",
     1, 9, 0, 0.225, 0, 0,      #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1), (1, 1),  ######          #alpha keys
     (0, 0.5), (1, 0.5), ######       #red keys
     (0, 0.5), (1, 0.5),######        #green keys
     ...
     (0, 0.25),   (1, 0.25),######    #scale keys
     (1, 1, 1),                 #emit box size
     (0, 0.006, -0.9),           #emit velocity
      0.01,                     #emit dir randomness
      2,                       #rotation speed
      0,                        #rotation damping
    ),

    ("mousse", psf_turn_to_velocity | psf_always_emit|psf_randomize_size, "prt_mesh_snow_dust_1",
     1, 3.0, 1, 0.0, 0.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.7, 0.1), (1, 0.0),        #alpha keys
     (1.0, 1.0), (1, 1.0),      #red keys
     (1.0, 1.0), (1, 1.0),      #green keys
    ...
    ("brume",  psf_billboard_3d|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_smoke_1",
     5, 9.0, 10, 0.0, 3.0, 3.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.7, 0.1), (1, 0.0),        #alpha keys
     (1.0, 1.0), (1, 1.0),      #red keys
     (1.0, 1.0), (1, 1.0),      #green keys
     (1.0, 1.0), (1, 1.0),      #blue keys
     (0.0, 4),   (1.0, 4.5),   #scale keys
     (3.0, 3.0, 0),           #emit box size 
     (0.2, 0.5, 0.2),                 #emit velocity
     0.3,                       #emit dir randomness
     0.4,                       #rotation speed
     0.2                        #rotation damping
    ),
...
#cascade
    ("watter_fa", 0 | psf_always_emit, "watter_fall",
     5, 5, 0, 0.425, 0, 0,      #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1), (1, 1),  ######          #alpha keys
     (0, 0.5), (1, 0.5), ######       #red keys
     (0, 0.5), (1, 0.5),######        #green keys
     (0, 0.5), (1, 0.5),######        #blue keys
     (0, 0.25),   (2, 0.25),######    #scale keys
     (2, 2, 2),                 #emit box size
     (0, 0.01, -0.9),           #emit velocity
      0,                     #emit dir randomness
      0,                       #rotation speed
    ...
    ("watter_fa2", 0 | psf_always_emit, "watter_fall_2",
     5, 5, 0, 0.625, 0, 0,      #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1), (1, 1),  ######          #alpha keys
     (0, 0.5), (1, 0.5), ######       #red keys
     (0, 0.5), (1, 0.5),######        #green keys
     (0, 0.5), (1, 0.5),######        #blue keys
