      ...
      (ti_on_presentation_event_state_change,
        [(store_trigger_param_1, ":object"),
          ...
          (else_try),
            ...
            (faction_set_color, "fac_player_supporters_faction", 0x00308F),
...
#  ("helmet_view_joute", prsntf_read_only|prsntf_manual_end_only, 0, [
#    (ti_on_presentation_load,
#     [(set_fixed_point_multiplier, 1000),

#
#	  (try_begin),
#	(troop_has_item_equipped, "trp_player", "itm_black_helmet"), #
# (create_mesh_overlay, reg0, "mesh_helmet_T_inside"),         #
#  (else_try),
#        (create_mesh_overlay, reg0, "mesh_helmet_T_inside"),
#      (play_sound, "snd_helm_down"),
...
(ti_on_presentation_load, [
  ...
  #Freelancer Missions
  (create_text_overlay, reg1, "@Freelancer Missions: ", tf_right_align),
  (position_set_y, pos0, ":y_pos"),
  (overlay_set_position, reg1, pos0),
  ...
  (overlay_set_val, "$form_options_overlay_9", "$freelancer_missions"),
...
(ti_on_presentation_event_state_change, [
  ...
  (else_try),
    (eq, ":object", "$form_options_overlay_9"),
    (assign, "$freelancer_missions", ":value"),
  (else_try),
...
[
  ...
  (try_begin),
    (eq, ":cmdr_faction","fac_kingdom_1"), #France
    (create_mesh_overlay, reg0, "mesh_pic_arms_swadian"),
  (else_try),
    (eq, ":cmdr_faction","fac_kingdom_2"), #England
    (create_mesh_overlay, reg0, "mesh_pic_arms_vaegir"),
  (else_try),
    (eq, ":cmdr_faction","fac_kingdom_3"), #Burgandy
    (create_mesh_overlay, reg0, "mesh_pic_arms_khergit"),
  (else_try),
    (eq, ":cmdr_faction","fac_kingdom_4"), #Duchy of Britain
...
(ti_on_presentation_load, [
  ...
  (else_try),
    ...
    (str_store_troop_name, s1, "trp_rebel_peasant"),
    (overlay_add_item, "$g_presentation_obj_sliders_2", s1),	 

    (str_store_troop_name, s1, "trp_crane_de_fer_mercenaire"),
    (overlay_add_item, "$g_presentation_obj_sliders_2", s1),	 	 
  (try_end),
  ...
  (else_try),
    ...
    (else_try),
      ...
      (assign, ":troop", "trp_rebel_peasant"),
      (call_script, "script_troop_tree_precurse", ":troop", 1, 1),
      (store_div, "$troop_tree_pic_width", Troop_Tree_Area_Width, reg0),
      (store_div, "$troop_tree_pic_height", Troop_Tree_Area_Height, reg1),		
    (else_try),
      (eq, "$g_presentation_obj_sliders_2_val", 6),
      (assign, ":troop", "trp_crane_de_fer_mercenaire"),
      (call_script, "script_troop_tree_precurse", ":troop", 1, 1),
      (store_div, "$troop_tree_pic_width", Troop_Tree_Area_Width, reg0),
      (store_div, "$troop_tree_pic_height", Troop_Tree_Area_Height, reg1),				
    (try_end),
