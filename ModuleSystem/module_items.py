...
def custom_reskin(item):
  return (ti_on_init_item, [
    ...
    (item_get_slot, ":ironskulls_start", item, slot_item_ironskulls_materials_begin),
    (item_get_slot, ":ironskulls_end", item, slot_item_ironskulls_materials_end),		 
    ...
    (else_try),
    	(eq, ":faction", "fac_ironskulls"),
    	(store_random_in_range, ":value", ":ironskulls_start", ":ironskulls_end"),				
    (else_try),
...
1350 , weight(3)|abundance(100)|head_armor(54)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
["h_zitta_bascinet", "Houndskull Bascinet", [("h_zitta_bascinet",0)], itp_merchandise|itp_type_head_armor| itp_attach_armature   ,0, 
...
["rpg_anterroche_armor", "Cotte de mailles aux armoiries Anterroche", [("a_surcoat_over_mail_base",0)], itp_type_body_armor  |itp_covers_legs ,0, 1720 , weight(22)|abundance(100)|head_armor(0)|body_armor(43)|leg_armor(14)|difficulty(7) ,imodbits_armor ,[(ti_on_init_item,[(cur_item_set_material, "@a_surcoat_over_mail_havrincourt", 0, 0),])]],
["rpg_armor_arloing", "Cotte de mailles aux Arloing", [("a_surcoat_over_mail_base",0)], itp_type_body_armor  |itp_covers_legs ,0, 1720 , weight(22)|abundance(100)|head_armor(0)|body_armor(43)|leg_armor(14)|difficulty(7) ,imodbits_armor ,[(ti_on_init_item,[(cur_item_set_material, "@a_surcoat_over_mail_havrincourt", 0, 0),])]],
