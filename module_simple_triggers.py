...
#############HYW###############
                       ...
                       (neq, ":troop_no", "trp_knight_1_2"),
                       (neq, ":troop_no", "trp_knight_1_3"),
                       (neq, ":troop_no", "trp_knight_1_4"),
                       (neq, ":troop_no", "trp_knight_1_5"),
                       (neq, ":troop_no", "trp_knight_1_8"),
                       (neq, ":troop_no", "trp_knight_1_9"),
                      # (neq, ":troop_no", "trp_knight_1_10"),
                       #(neq, ":troop_no", "trp_knight_1_11"),
                       (neq, ":troop_no", "trp_knight_1_12"),
                      # (neq, ":troop_no", "trp_knight_1_15"),
                       (neq, ":troop_no", "trp_knight_1_18"),
                       (neq, ":troop_no", "trp_knight_1_19"),
                       (neq, ":troop_no", "trp_knight_1_20"),
                       (neq, ":troop_no", "trp_knight_2_1"),
                       (neq, ":troop_no", "trp_knight_2_2"),
                       (neq, ":troop_no", "trp_knight_2_3"),
                       (neq, ":troop_no", "trp_knight_2_4"),
                       (neq, ":troop_no", "trp_knight_2_6"),
                       (neq, ":troop_no", "trp_knight_2_8"),
                       (neq, ":troop_no", "trp_knight_2_10"),
                       (neq, ":troop_no", "trp_knight_2_12"),
                       (neq, ":troop_no", "trp_knight_2_15"),
                       (neq, ":troop_no", "trp_knight_2_17"),
                       (neq, ":troop_no", "trp_knight_2_18"),
                       (neq, ":troop_no", "trp_knight_2_19"),
                       (neq, ":troop_no", "trp_knight_2_20"),
                       #(neq, ":troop_no", "trp_knight_3_2"),
                       #(neq, ":troop_no", "trp_knight_3_5"),
                       #(neq, ":troop_no", "trp_knight_3_6"),
                       #(neq, ":troop_no", "trp_knight_3_8"),
                       (neq, ":troop_no", "trp_knight_3_9"),
                       #(neq, ":troop_no", "trp_knight_3_10"),
                       #(neq, ":troop_no", "trp_knight_3_14"),
                       #(neq, ":troop_no", "trp_knight_3_16"),
                       #(neq, ":troop_no", "trp_knight_3_17"),
                       (neq, ":troop_no", "trp_knight_3_18"),
                       (neq, ":troop_no", "trp_knight_3_20"),
                       (neq, ":troop_no", "trp_knight_4_1"),
                       (neq, ":troop_no", "trp_knight_4_2"),
                       (neq, ":troop_no", "trp_knight_4_3"),
                       (neq, ":troop_no", "trp_knight_4_4"),
                       (neq, ":troop_no", "trp_knight_4_5"),
                       (neq, ":troop_no", "trp_knight_4_6"),
                       (neq, ":troop_no", "trp_knight_4_7"),
                       (neq, ":troop_no", "trp_knight_4_11"),
                       (neq, ":troop_no", "trp_knight_4_12"),
                       (neq, ":troop_no", "trp_knight_4_13"),
                       (neq, ":troop_no", "trp_knight_4_14"),
                       (neq, ":troop_no", "trp_knight_4_15"),
                       (neq, ":troop_no", "trp_knight_4_19"),
                       (neq, ":troop_no", "trp_knight_4_20"),
                       (neq, ":troop_no", "trp_knight_5_1"),
                       (neq, ":troop_no", "trp_knight_5_2"),
                       (neq, ":troop_no", "trp_knight_5_3"),
                       (neq, ":troop_no", "trp_knight_5_4"),
                       (neq, ":troop_no", "trp_knight_5_5"),
                      # (neq, ":troop_no", "trp_knight_5_6"),
                       (neq, ":troop_no", "trp_knight_5_7"),
                       (neq, ":troop_no", "trp_knight_5_8"),
                       (neq, ":troop_no", "trp_knight_5_9"),
                       #(neq, ":troop_no", "trp_knight_5_11"),
                       #(neq, ":troop_no", "trp_knight_5_12"),
                       (neq, ":troop_no", "trp_knight_5_13"),
                       (neq, ":troop_no", "trp_knight_5_14"),
                       (neq, ":troop_no", "trp_knight_5_15"),
                       (neq, ":troop_no", "trp_knight_5_16"),
                       (neq, ":troop_no", "trp_knight_5_17"),
                       #(neq, ":troop_no", "trp_knight_5_18"),
                       (neq, ":troop_no", "trp_knight_5_19"),
                       #(neq, ":troop_no", "trp_knight_6_1"),
                       #(neq, ":troop_no", "trp_knight_6_2"),
                       #(neq, ":troop_no", "trp_knight_6_3"),
                      # (neq, ":troop_no", "trp_knight_6_4"),
                       (neq, ":troop_no", "trp_knight_6_5"),
                       (neq, ":troop_no", "trp_knight_6_7"),
                       (neq, ":troop_no", "trp_knight_6_8"),
                       (neq, ":troop_no", "trp_knight_6_9"),
                       (neq, ":troop_no", "trp_knight_6_10"),
                       (neq, ":troop_no", "trp_knight_6_11"),
                       (neq, ":troop_no", "trp_knight_6_12"),
                       (neq, ":troop_no", "trp_knight_6_13"),
                       (neq, ":troop_no", "trp_knight_6_14"),
                       (neq, ":troop_no", "trp_knight_6_17"),
                       (neq, ":troop_no", "trp_knight_6_19"),
                       (neq, ":troop_no", "trp_knight_6_20"),
                       (neq, ":troop_no", "trp_knight_3_11"),
                       (neq, ":troop_no", "trp_knight_6_15"),
                       (neq, ":troop_no", "trp_knight_6_16"),
                       (neq, ":troop_no", "trp_knight_6_16"),
                       (neq, ":troop_no", "trp_knight_6_23"),
                       (neq, ":troop_no", "trp_knight_6_29"),
                       (neq, ":troop_no", "trp_knight_6_34"),
                       (neq, ":troop_no", "trp_knight_6_35"),
                       (neq, ":troop_no", "trp_knight_6_36"),        
...
#test
    ...
    # (gt, ":available_food", 1),    
    # (eq, "$malus_de_faim", 1),    
    # (call_script, "script_hugry-restore_1429"),
    # (try_end),
#test end    
      (try_begin),
        (gt, ":available_food", 0),
...
#    
#    
#malus stats qu'une fois zqzq
     (try_begin),
        (eq, ":no_food_displayed", 0),
        (eq, "$malus_de_faim", 0),    
        (call_script, "script_hugry-damages_1429"),
     (try_end),
#    
...
# Train peasants against bandits
  ...
  (24,
   [
    (call_script,"script_set_max_warriors"),
	(call_script,"script_set_max_troops"),
    (call_script,"script_set_available_warriors"),
 ...
 # reserved for future use. For backward compatibility, we need to use these triggers instead of creating new ones.
  ...
  (1,
   [
     ...
     (store_add, ":fac_kingdom_2_plus_one", "fac_kingdom_1", 1),

     (try_for_range, ":faction_1", "fac_kingdom_1", ":fac_kingdom_2_plus_one"),
       (try_for_range, ":faction_2", "fac_kingdom_1", ":fac_kingdom_2_plus_one"),
    ...
    (try_for_range, ":training_camp_no", training_grounds_begin, training_grounds_end),
     (party_get_num_companions, ":num_troops", ":training_camp_no"), ## +de troupe = +d'xp
      (store_troop_gold, ":player_wealth", "trp_player"),
       (store_mul, ":troop_cost", ":num_troops", 3),#essayer 3 ou plus

     (try_begin),
                 (gt, ":num_troops", 0),    
 (display_message, "@Paiement des frais des camps d'entrainement."), 
    
        (try_end),
         
     (try_begin),
              
                 (ge, ":player_wealth", ":troop_cost"),   
                  (troop_remove_gold, "trp_player", ":troop_cost"),
                   (store_mul, ":xp_gain", ":num_troops", 200),
                     (party_upgrade_with_xp, ":training_camp_no", ":xp_gain", 0),
    
         (else_try),
       (gt,":troop_cost",":player_wealth"),
 (display_message, "@Plus d'argent pour l'entrainement de vos troupes.", 0xEE7744),
        (try_end),
    (try_end),
 ...
 #   (try_end),
  ...
  (24,
   [
    (try_for_range, ":cur_center", castles_begin, castles_end),
     (party_get_num_companions, ":num_troops", ":cur_center"), ## +de troupe = +d'xp
     (store_mul, ":xp_gain", ":num_troops", 200),
     (party_upgrade_with_xp, ":cur_center", ":xp_gain", 0),
    (try_end),
       ]),
  ...
  (24,
   [
     ...
     (party_get_num_companions, ":num_troops", ":cur_town"), ## +de troupe = +d'xp
     (store_mul, ":xp_gain", ":num_troops", 200),
     (party_upgrade_with_xp, ":cur_town", ":xp_gain", 0),
    (try_end),
       ]),
  
#  (24,
#   [
#(call_script, "script_relation_mercenaires"),
#       ]),
...
#
           ...
           (this_or_next|eq, "$g_encountered_party", "p_auberge_1"), 
           (this_or_next|eq, "$g_encountered_party", "p_auberge_2"), 
           (this_or_next|eq, "$g_encountered_party", "p_auberge_3"), 
           (eq, "$g_encountered_party", "p_auberge_4"), 
    ...
    (try_begin),
      (ge, ":gold", ":total_cost"),
      (display_message, "@Payement de l'Auberge."),
      (troop_remove_gold, "trp_player", ":total_cost"),
    (else_try),
      (gt, ":gold", 0),
      (troop_remove_gold, "trp_player", ":gold"),
